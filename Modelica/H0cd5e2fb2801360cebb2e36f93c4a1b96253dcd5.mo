within ;
model H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5
  "Stub for eFMU-based co-simulation of
       [PSSDesign.Components.PSSTypeIImod4efmi]
     ...
     as configured by eFMU generation configuration
       [PSSDesign.Components.PSS.PSSeFMUConfiguration]
     Generated by Dymola on 2025-10-25T12:11:11Z."
extends fmuIcon;

// Model automatically generated by Dymola from FMI model description
public
encapsulated package importedFMUTypes
  type 'ePSS_eFMU_SiL_Support\'___TuningConnectors_Kw' = Real;
  type 'ePSS_eFMU_SiL_Support\'___TuningConnectors_T1' = Real (unit = "s", quantity = "Time");
  type 'ePSS_eFMU_SiL_Support\'___TuningConnectors_T2' = Real (unit = "s", quantity = "Time");
  type 'ePSS_eFMU_SiL_Support\'___TuningConnectors_T3' = Real (unit = "s", quantity = "Time");
  type 'ePSS_eFMU_SiL_Support\'___TuningConnectors_T4' = Real (unit = "s", quantity = "Time");
  type 'ePSS_eFMU_SiL_Support\'___TuningConnectors_Tw' = Real (unit = "s", quantity = "Time");
  type 'ePSS_eFMU_SiL_Support\'___TuningConnectors_vSI_start' = Real;
  type 'ePSS_eFMU_SiL_Support\'___TuningConnectors_vsmax' = Real;
  type 'ePSS_eFMU_SiL_Support\'___TuningConnectors_vsmin' = Real;
  ...
  type 'ePSS_eFMU_SiL_Support\'_ProductionCodes' = enumeration(Mockup "non-functional mockup",
        PCode_SPE_cb4a8a449b4ada864625ee5a4355578a3aaf08ed,
        PCode_SPE_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c);
...
public
  parameter String fmi_instanceName="H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5"
  ...
  parameter String fmi_resourceLocation="file:///"+ModelicaServices.ExternalReferences.loadResource("modelica://H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5/Resources/Library/FMU/H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5/resources")
...
package fmi_Functions
    ...
    class fmiModel
      ...
      function constructor "Initialize FMI model"
        ...
        output fmiModel fmi;
        external"C" fmi = H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiInstantiateModel2(instanceName, loggingOn, resourceLocation)
        annotation(Include="
#ifndef H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_Instantiate_C
#define H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_Instantiate_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492Logger(fmi2ComponentEnvironment componentEnvironment, fmi2String instanceName, fmi2Status status,
...
void * H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiInstantiateModel2(const char*instanceName, fmi2Boolean loggingOn, fmi2String resourceLocation) {
  static fmi2CallbackFunctions funcs = {&H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492Logger, &calloc, &free, NULL, NULL};
  struct dy_fmi2Extended* res;
  res = calloc(1, sizeof(struct dy_fmi2Extended));
  if (res!=0) {
#ifdef _WIN32
    if (!(res->hInst=LoadLibraryW(L\"H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5.dll\"))) {
      ModelicaError(\"Loading of FMU dynamic link library (H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5.dll) failed!\");
#else
    if (!(res->hInst=LoadLibrary(\"H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5.so\"))) {
      ModelicaError(\"Loading of FMU dynamic link library (H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5.so) failed!\");
#endif
      return 0;
    }
    ...
    res->m=res->dyFmiInstantiate(instanceName, fmi2CoSimulation, \"{ed562c46-bfa5-4a88-81ba-0950150d492d}\",resourceLocation, &funcs, fmi2False, loggingOn);
  ...
  return res;
...
#endif", Library="H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5", LibraryDirectory="modelica://H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5/Resources/Library/FMU/H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5/binaries");
        annotation (__Dymola_doNotLinkSharedObject=true,
            __Dymola_CriticalRegion="H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5");
      end constructor;
      ...
      function destructor "Release storage of FMI model"
          ...
          input fmiModel fmi;
          external"C"
                     H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiFreeModelInstance2(fmi)
          annotation (Include="
#ifndef H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_Free_C
#define H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_Free_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiFreeModelInstance2(void*m) {
  ...
  if (a) {
...
#endif",       Library="H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5", LibraryDirectory="modelica://H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5/Resources/Library/FMU/H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5/binaries");
        annotation(__Dymola_doNotLinkSharedObject=true,__Dymola_CriticalRegion = "H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5");
      end destructor;
    ...
    external"C" stepOK =H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiDoStep2(fmi, currentTime, stepSize)
      annotation (Include="
#ifndef H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_DoStep_C
#define H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_DoStep_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
double H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiDoStep2(void*m, double currentTime, double stepSize) {
  struct dy_fmi2Extended*a=m;
  ...
  if (status!=fmi2OK && status!=fmi2Warning){    ModelicaFormatError(\"The call of fmi2DoStep(%f, %f) failed in FMU\\r\\nNote: setting fmi_loggingOn in the FMU component may produce more information from the FMU.\",currentTime, stepSize);  }  return 1.0;
    ...
    function fmiReset
      ...
      external"C" resetOK = H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiReset2(fmi)
      annotation (Include="
#ifndef H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_Reset_C
#define H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_Reset_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
double H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiReset2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiReset failed\");
    ...
    function fmiGetReal
      ...
      external"C" H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiGetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_GetReal_C
#define H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_GetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiGetReal2(void*m, const int*refs, size_t nrefs, double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
void H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiGetReal2(void*m, const int*refs, size_t nrefs, double*vals) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetReal failed\");
    ...
    function fmiSetReal
      ...
      external"C"
                 H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiSetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals)
        annotation (Include="
#ifndef H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_SetReal_C
#define H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_SetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiSetReal2(void*m, const int*refs, size_t nrefs, const double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if(!nrefs){return;}
  if (a) {
...
function fmiSetRealDiscrete
    ...
    protected
      ...
      external"C" H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiSetRealDiscrete(
        fmi,
        refs,
        size(refs, 1),
        vals,
        oldVals)
      annotation (Include="
#ifndef H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_SetRealDiscrete_C
#define H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_SetRealDiscrete_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiSetRealDiscrete(void*m, const int*refs, size_t nrefs, double*vals, double*oldVals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
...
#endif", Library="H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5", LibraryDirectory="modelica://H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5/Resources/Library/FMU/H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5/binaries");
  annotation(__Dymola_doNotLinkSharedObject=true,__Dymola_CriticalRegion = "H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5", __Dymola_LockExternalObject=true,__Dymola_IdemPotent=true, __Dymola_VectorizedExceptFirst=true);
    ...
    function fmiGetInteger
      ...
      external"C" H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiGetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_GetInteger_C
#define H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_GetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiGetInteger2(void*m, const int*refs, size_t nrefs, int*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
void H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiGetInteger2(void*m, const int*refs, size_t nrefs, int*vals) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetInteger failed\");
    ...
    protected
      ...
      external"C" H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiSetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        oldVals)
      annotation (Include="
#ifndef H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_SetInteger_C
#define H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_SetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiSetInteger2(void*m, const int*refs, size_t nrefs, int*vals, int*oldVals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetInteger failed\");
    ...
    function fmiSetIntegerwf
      ...
      external"C" H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiSetInteger2wf(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_SetIntegerwf_C
#define H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_SetIntegerwf_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiSetInteger2wf(void*m, const int*refs, size_t nrefs, int*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetInteger failed\");
    ...
    function fmiGetBoolean
      ...
      external"C" H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiGetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals)
        annotation (Include="
#ifndef H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_GetBoolean_C
#define H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_GetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiGetBoolean2(void*m, const int* refs, size_t nr, int* vals) {
  int i;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
void H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiGetBoolean2(void*m, const int* refs, size_t nr, int* vals) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetBoolean failed\");
    ...
    protected
      ...
      external"C" H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiSetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        ...
        oldVals)
        annotation (Include="
#ifndef H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_SetBoolean_C
#define H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_SetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiSetBoolean2(void*m, const int* refs, size_t nr, const int* vals, int* dummy, int* oldVals) {
  size_t i;
  int j;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetBoolean failed\");
    ...
    function fmiSetString
      ...
      external"C" H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiSetString2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_SetString_C
#define H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_SetString_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiSetString2(void*m, const int*refs, size_t nrefs,const fmi2String vals[]) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetString failed\");
    ...
    protected
      Boolean dummy[size(refs, 1)];
      external"C" H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiSetBoolean2wf(
        fmi,
        refs,
        size(refs, 1),
        vals,
        dummy)
        annotation (Include="
#ifndef H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_SetBooleanwf_C
#define H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_SetBooleanwf_C 1
#include \"FMI/fmi2Import.h\"
void H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiSetBoolean2wf(void*m, const int* refs, size_t nr, const int* vals, int* dummy) {
  size_t i;
  int j;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetBoolean failed\");
    ...
    function fmiGetDirectionalDerivative
      ...
      external"C" H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_GetDirectionalDerivative2(
        fmi,
        z_refs,
        size(z_refs, 1),
        v_refs,
        ...
        dz)
      annotation (Include="
#ifndef H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_GetDirectionalDerivative2_C
#define H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_GetDirectionalDerivative2_C 1
#include \"FMI/fmi2Import.h\"
void H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_GetDirectionalDerivative2(void*m, const int* zref, size_t nzr, const int* vrefs, size_t nvr, const double *dv, double *dz) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetDirectionalDerivative failed\");
    ...
    function fmiSaveFMUState
      input fmiModel fmi;
      external"C" H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiSaveFMUState2(fmi)
        annotation (Include="
#ifndef H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiSaveFMUState_C
#define H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiSaveFMUState_C 1
#include \"FMI/fmi2Import.h\"
void H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiSaveFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetFMUstate failed\");
    ...
    function fmiRestoreFMUState
      input fmiModel fmi;
      external"C" H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiRestoreFMUState2(fmi)
        annotation (Include="
#ifndef H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiRestoreFMUState_C
#define H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiRestoreFMUState_C 1
#include \"FMI/fmi2Import.h\"
void H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiRestoreFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiSetFMUstate failed\");
    ...
    function fmiSerializeFMUstate
      input fmiModel fmi;
      external"C" H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiSerializeFMUstate2(fmi)
        annotation (Include="
#ifndef H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiSerializeFMUstate_C
#define H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiSerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiSerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
    status = a->dyFmiGetFMUstate(a->m, &a->dyFMUstate);
    ...
    function fmiDeSerializeFMUstate
      input fmiModel fmi;
      external"C" H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiDeSerializeFMUstate2(fmi)
        annotation (Include="
#ifndef H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiDeSerializeFMUstate_C
#define H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiDeSerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiDeSerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
    ...
    function fmiEnterSlaveInitializationMode
      ...
      input Real preAvailable;
      output Real postAvailable = preAvailable;
      external"C" H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiEnterSlaveInitializationMode2(fmi, setTolerance, relativeTolerance, tStart, forceShutDownAtTStop, tStop)
      annotation (Include="
#ifndef H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiEnterSlaveInitializationMode_C
#define H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiEnterSlaveInitializationMode_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiEnterSlaveInitializationMode2(void*m, int setTolerance, double relativeTolerance, double tStart, int forceShutDownAtTStop, double tStop) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"InitializeSlave failed\");
    ...
    function fmiExitSlaveInitializationMode
      ...
      input Real preAvailable;
      output Real postAvailable = preAvailable;
      external"C" H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiExitSlaveInitializationMode2(fmi)
      annotation (Include="
#ifndef H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiExitSlaveInitializationMode_C
#define H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiExitSlaveInitializationMode_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5562465488810950150492_fmiExitSlaveInitializationMode2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
equation
  ...
  annotation (__Dymola_FMUImportVersion="Dymola 2025x Refresh 1", __Dymola_FMUImportPath="C:/Users/vanfr/Documents/Dymola/ePSS/SiL-integration/FMU/H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5.fmu", __Dymola_FMUImportIncludeAllVariables="false", __Dymola_FMUImportIntegrate="false", __Dymola_FMUResourcePath="Resources/Library/FMU/H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5",__Dymola_FMUImportDateTime="Sat Oct 25 12:11:24 2025 GMT", experiment(StartTime=0.0, StopTime=10.0, Tolerance=0.0001),
    Icon(graphics={
...
<li>modelName = H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5</li>
...
<li>generationDateAndTime = 2025-10-25T12:11:13Z</li>
</ul>
...
end H0cd5e2fb2801360cebb2e36f93c4a1b96253dcd5;
