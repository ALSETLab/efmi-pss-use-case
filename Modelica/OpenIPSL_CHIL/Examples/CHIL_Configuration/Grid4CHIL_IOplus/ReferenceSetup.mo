...
model ReferenceSetup "Clocked variant of ReferenceSetup."
...
equation
  ...
  connect(G4CHIL_IOplus.w, pss.vSI) annotation (Line(points={{142,16},{160,16},
          {160,40},{-160,40},{-160,0},{-102,0}}, color={0,0,127}));
  connect(pss.vs, G4CHIL_IOplus.vf) annotation (Line(points={{-79,0},{40,0},{40,
          12},{92,12}}, color={0,0,127}));
  connect(stepPload.y, G4CHIL_IOplus.uPLoad)
    annotation (Line(points={{30,-79},{30,-12},{92,-12}}, color={0,0,127}));
