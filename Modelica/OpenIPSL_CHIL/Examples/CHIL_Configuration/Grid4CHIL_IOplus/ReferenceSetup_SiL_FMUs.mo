within OpenIPSL_CHIL.Examples.CHIL_Configuration.Grid4CHIL_IOplus;
model ReferenceSetup_SiL_FMUs
  ...
  Modelica.Clocked.ClockSignals.Clocks.PeriodicRealClock periodicClock_pss(
    ...
    solverMethod="ExplicitEuler") annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-120,-30})));
  H225c1baf6cf5a31bc9b0c38998c32298f6f0531c_cb4a8a449b4ada864625ee5a4355578a3aaf08ed pss(
                          wscale=10.00)
  ...
  Modelica.Clocked.RealSignals.Sampler.Hold hold_wscaled(y_start=
        G4CHIL_IOplus.woffset)
...
equation
  connect(periodicClock_G4CHIL.y, samplerVavr.clock) annotation (Line(
      ...
      thickness=0.5));
  connect(samplerVavr.y, G4CHIL_IOplus.vf) annotation (Line(points={{74.6,12},
          {86,12},{86,-13.2},{99.2,-13.2}}, color={0,0,127}));
  ...
  connect(samplerPload.y, G4CHIL_IOplus.uPLoad) annotation (Line(points={{74.6,
          -20},{80,-20},{80,-6.6},{99.2,-6.6}}, color={0,0,127}));
  ...
  connect(faultTimerLogic.y, G4CHIL_IOplus.fault) annotation (Line(points={{90,
          -79},{90,-34},{99.2,-34},{99.2,13.4}}, color={255,0,255}));
  connect(faultL1.y, G4CHIL_IOplus.faultL1) annotation (Line(points={{120,-79},
          {120,-36},{120,6.8},{99.2,6.8}}, color={255,0,255}));
  connect(faultL2.y, G4CHIL_IOplus.faultL2) annotation (Line(points={{150,-79},
          {150,-34},{99.2,-34},{99.2,0}}, color={255,0,255}));
  ...
  connect(G4CHIL_IOplus.w, hold_wscaled.u) annotation (Line(points={{140,-13.2},
          {144,-13.2},{144,16},{148.8,16}}, color={0,0,127}));
