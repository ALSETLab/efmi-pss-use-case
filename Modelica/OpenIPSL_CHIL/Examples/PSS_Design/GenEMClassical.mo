within OpenIPSL_CHIL.Examples.PSS_Design;
model GenEMClassical
  "Power system with synchronous machine only, uses Order II model (i.e., \"classical electromechanical\") model (GenEMClassical)."
  ...
  OpenIPSL.Electrical.Buses.Bus B3 annotation(
    Placement(visible = true, transformation(origin = {60, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Generator.Design.GenEMClassical G1(
