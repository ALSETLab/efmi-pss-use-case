...
model CHILExperimentUsingFMUClocked
  ...
  H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c G4CHIL(
                          wscale=10.00)
  ...
  Modelica.Clocked.ClockSignals.Clocks.PeriodicRealClock periodicClock_pss(
    ...
    solverMethod="ExplicitEuler") annotation (Placement(transformation(
        ...
        rotation=90,
        origin={-120,-30})));
  H225c1baf6cf5a31bc9b0c38998c32298f6f0531c_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c pss(
                          wscale=10.00)
...
equation
  ...
  connect(samplerVavr.y,G4CHIL. vf)
    annotation (Line(points={{74.6,12},{86,12},{86,-13.2},{99.2,-13.2}},
                                                   color={0,0,127}));
  ...
  connect(samplerPload.y,G4CHIL. uPLoad) annotation (Line(points={{74.6,-20},{80,
          -20},{80,-6.6},{99.2,-6.6}},    color={0,0,127}));
  ...
  connect(G4CHIL.w, hold_wscaled.u)
    annotation (Line(points={{140,-13.2},{144,-13.2},{144,16},{148.8,16}},
                                                   color={0,0,127}));
...
end CHILExperimentUsingFMUClocked;
