...
model GenPSSeFMUeBlockHPFvar
  ...
  'PSSTypeII4eFMIwHPF.eFMU_SiL_Support'.BinaryStub pss(Kw = 10.8, T1 = 0.278203917593164, T2 = 0.0551479681529786, T3 = 0.278203917593164, T4 = 0.0551479681529786, vsmax = 0.2, vsmin = -0.2) annotation(
