within OpenIPSL_CHIL.UnderDevelopment.PhysicalExperiments.Grid4CHIL_FaultTrigger;
model Fault_eFMU "Model to replicate fault triggering test with binary stub"
  ...
  'Grid4CHIL.eFMU_SiL_Support'.BinaryStub G4CHIL(__defining_code=
