within PSSDesign.Components.Machines.Base;
partial model baseMachine
  ...
  import Complex;
  parameter OpenIPSL.Types.ApparentPower Sn "Power rating"
    annotation (Dialog(group="Machine parameters"));
  parameter OpenIPSL.Types.Voltage Vn "Voltage rating"
    annotation (Dialog(group="Machine parameters"));
  parameter OpenIPSL.Types.PerUnit ra "Armature resistance"
    annotation (Dialog(group="Machine parameters"));
  parameter OpenIPSL.Types.PerUnit x1d "d-axis transient reactance"
    annotation (Dialog(group="Machine parameters"));
  parameter OpenIPSL.Types.Time M "Mechanical starting time, 2H [Ws/VA]"
    annotation (Dialog(group="Machine parameters"));
  ...
  OpenIPSL.Types.PerUnit vd(start=vd0) "d-axis voltage";
  OpenIPSL.Types.PerUnit vq(start=vq0) "q-axis voltage";
  OpenIPSL.Types.PerUnit id(start=id0) "d-axis current";
  OpenIPSL.Types.PerUnit iq(start=iq0) "q-axis current";
protected
  OpenIPSL.Types.PerUnit pe(start=pm00)
    "electrical power transmitted through the air-gap";
  OpenIPSL.Types.PerUnit vf_MB=vf*V_b/Vn "field voltage on machine base";
  parameter OpenIPSL.Types.AngularVelocity w_b=2*Modelica.Constants.pi*fn
  ...
  parameter OpenIPSL.Types.PerUnit p0=P_0/S_b
    "Initial active power generation in pu (system base)";
  parameter OpenIPSL.Types.PerUnit q0=Q_0/S_b
  ...
  parameter OpenIPSL.Types.PerUnit vr0=CM.real(Vt0) "Init. val.";
  parameter OpenIPSL.Types.PerUnit vi0=CM.imag(Vt0) "Init. val.";
  parameter OpenIPSL.Types.PerUnit ir0=-CM.real(I0) "Init. val.";
  parameter OpenIPSL.Types.PerUnit ii0=-CM.imag(I0) "Init. val.";
  ...
  */
  ...
  parameter OpenIPSL.Types.Angle delta0 = atan2(auxCMval.im,auxCMval.re) "Init. val. of mach. angle";
  parameter Complex Vdq0=Vt0*CM.fromPolar(1/V_MBtoSB, (-delta0 + (Modelica.Constants.pi
                                                                      /2)))
    "Init. val (machine base)";
  parameter Complex Idq0=I0*CM.fromPolar(1/I_MBtoSB, (-delta0 + (Modelica.Constants.pi
                                                                     /2)))
    "(pu, machine base)";
  parameter OpenIPSL.Types.PerUnit vd0=CM.real(Vdq0) "Init. val.";
  parameter OpenIPSL.Types.PerUnit vq0=CM.imag(Vdq0) "Init. val.";
  parameter OpenIPSL.Types.PerUnit id0=CM.real(Idq0) "Init. val.";
  parameter OpenIPSL.Types.PerUnit iq0=CM.imag(Idq0) "Init. val.";

  parameter OpenIPSL.Types.PerUnit pm00=((vq0 + ra*iq0)*iq0 + (vd0 + ra*id0)*
      id0)/S_SBtoMB "Initial value (system base)";
