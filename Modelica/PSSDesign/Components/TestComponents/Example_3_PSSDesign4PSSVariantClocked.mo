...
model Example_3_PSSDesign4PSSVariantClocked
  "Duplicate that uses PSS variant for efmi export"
  ...
  OpenIPSL.Electrical.Buses.Bus B3 annotation(
    Placement(visible = true, transformation(origin = {60, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  PSSDesign.Generator.GeneratorPSSefmuVariantClocked G1(
  ...
  OpenIPSL.Electrical.Events.PwFault pwFault(
    ...
    t1=0.5,
    t2=0.57)                                                                                annotation(
    Placement(visible = true, transformation(                 extent={{20,-60},{
            40,-40}},                                                                          rotation = 0)));
equation
...
end Example_3_PSSDesign4PSSVariantClocked;
