...
package TestAuxiliary "Sub-package with test auxiliary models"
  extends Modelica.Icons.ExamplesPackage;
  model TestLineTripInput "Model line model variant with trip signal as input"
    extends Modelica.Icons.Example;
    Auxiliary.PwLine4efmi pwLine4efmi(
      R=1e-3,
      X=0.1,
  ...
  model TestFaultTripInput
    "Model fault model variant with trip signal as input"
    extends Modelica.Icons.Example;
    Auxiliary.PwLine4efmi pwLine4efmi(
      R=1e-3,
      X=0.1,
    ...
    OpenIPSL.Electrical.Buses.Bus B2
      annotation (Placement(transformation(extent={{50,-10},{70,10}})));
    Auxiliary.PwFault4efmi pwFault4efmi(R=0.1, X=0.5) annotation (Placement(
          transformation(
          extent={{-10,-10},{10,10}},
          rotation=270,
          origin={50,-50})));
  ...
  model TestLoad "Test the current source load"
    extends Modelica.Icons.Example;
    ...
    inner OpenIPSL.Electrical.SystemBase SysData
      annotation (Placement(transformation(extent={{-100,-100},{-60,-80}})));
    Auxiliary.iSrcLoad iSrcLoad annotation (Placement(transformation(
          extent={{-10,-10},{10,10}},
          rotation=90,
          origin={80,-30})));
