...
package TestG4CHILTestMoreIO
  "Test models for different uses of the Grid4CHILTestMoreIO model."
  extends Modelica.Icons.ExamplesPackage;
  model TestG4CHIL "Tests the model for CHIL testing"
  ...
  model TestG4CHILClocked
    "Tests the model for CHIL testing with clocked partition"
    extends Modelica.Icons.Example;
    G4CHILTestMoreIO G4CHIL(G1(avr(K0=30)))
      annotation (Placement(transformation(extent={{-20,-20},{20,20}})));
    Modelica.Blocks.Interfaces.RealOutput w "Speed [pu]"
  ...
  equation
    ...
    connect(samplerVavr.y, G4CHIL.vf)
      annotation (Line(points={{-45.4,12},{-24,12}}, color={0,0,127}));
    ...
    connect(faultTimerLogic.y, G4CHIL.fault) annotation (Line(points={{-39,-50},
            {-12,-50},{-12,-24}}, color={255,0,255}));
    connect(faultL1.y, G4CHIL.faultL1)
      annotation (Line(points={{0,-39.6},{0,-24}}, color={255,0,255}));
    connect(faultL2.y, G4CHIL.faultL2)
      annotation (Line(points={{12,-39.6},{12,-24}}, color={255,0,255}));
