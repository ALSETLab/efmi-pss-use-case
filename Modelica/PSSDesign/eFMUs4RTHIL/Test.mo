...
package Test "Test models for different uses of the GridForHILTesting model."
  extends Modelica.Icons.ExamplesPackage;
  model TestGridForHIL "Tests the model for HIL testing"
  ...
  model TestGridForHILClocked
    "Tests the model for HIL testing with clocked partitions"
    extends Modelica.Icons.Example;
    Modelica.Blocks.Sources.Step step(
      height=0.05,
      offset=0,
  ...
  model TestGridForHILBinStub
    "Tests the model for HIL testing with Binary Stub"
    extends Modelica.Icons.Example;
    Modelica.Blocks.Sources.Step step(
      height=0.05,
      offset=0,
