...
model TestGridForHILwFMUofeFMU
  "Tests the model for HIL testing with eFMU in FMU container"
...
equation
  connect(faultTimerLogic.y, G4HIL.fault)
    annotation (Line(points={{-79,-70},{-60,-70},{-60,8},{-20.8,8},{-20.8,6.8}},
                                                         color={255,0,255}));
  connect(G4HIL.w, w)
