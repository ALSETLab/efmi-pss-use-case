...
block fmuV2ExpEulerGridForHILTesting
...
initial algorithm
  ...
  FMI.Internal.loadFMU(
    instance=instance,
    unzipdir=Modelica.Utilities.Files.loadResource("modelica://ExportedFMUs/Resources/FMUs/042a579"),
    fmiVersion=2,
...
equation
  ...
  annotation (
   Icon(coordinateSystem(
      ...
      graphics={Bitmap(extent={{-90,-90},{90,90}}, fileName="modelica://ExportedFMUs/Resources/FMUs/042a579/model.png")}),
    Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}})),
    experiment(StopTime=10.0),
    uses(FMI(version="0.0.8")),
    Documentation(info="<html>
<p>For more information open the FMU's <a href=\"modelica://ExportedFMUs/Resources/FMUs/042a579/documentation/index.html\">original documentation</a>.</p>
</html>"));
end fmuV2ExpEulerGridForHILTesting;
