within ExportedFMUs.FMUs.DymolaFMUs.Grid4HIL;
block fmuV2IdaGridForHILTesting
...
initial algorithm
  ...
  FMI.Internal.loadFMU(
    instance=instance,
    unzipdir=Modelica.Utilities.Files.loadResource("modelica://ExportedFMUs/Resources/FMUs/1fb951a"),
    fmiVersion=2,
    modelIdentifier="fmuV2IdaGridForHILTesting",
    instanceName=getInstanceName(),
    interfaceType=1,
    instantiationToken="{f2f347ee-c87b-4bbc-95eb-c0804734fa45}",
    visible=visible,
    loggingOn=loggingOn,
...
equation
  ...
  annotation (
   Icon(coordinateSystem(
      ...
      graphics={Bitmap(extent={{-90,-90},{90,90}}, fileName="modelica://ExportedFMUs/Resources/FMUs/1fb951a/model.png")}),
    Diagram(coordinateSystem(preserveAspectRatio=false, extent={{-100,-100},{100,100}})),
    experiment(StopTime=10.0),
    uses(FMI(version="0.0.8")),
    Documentation(info="<html>
<p>For more information open the FMU's <a href=\"modelica://ExportedFMUs/Resources/FMUs/1fb951a/documentation/index.html\">original documentation</a>.</p>
</html>"));
end fmuV2IdaGridForHILTesting;
