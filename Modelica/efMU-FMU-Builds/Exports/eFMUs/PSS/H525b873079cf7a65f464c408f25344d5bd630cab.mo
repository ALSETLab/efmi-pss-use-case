...
model H525b873079cf7a65f464c408f25344d5bd630cab
  "Stub for eFMU-based co-simulation of
     ...
     Generated by Dymola on 2026-01-14T20:54:24Z."
extends fmuIcon;
...
encapsulated package importedFMUTypes
  ...
  type 'efmuPSS_eFMU_SiL_Support\'_ProductionCodes' = enumeration(Mockup "non-functional mockup",
        PCode_SPE_cb4a8a449b4ada864625ee5a4355578a3aaf08ed,
        PCode_SPE_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c);
constant Integer[3] 'efmuPSS_eFMU_SiL_Support\'_ProductionCodes_values' = {1, 2, 3};
...
package fmi_Functions
    ...
    class fmiModel
      ...
      function constructor "Initialize FMI model"
        ...
        output fmiModel fmi;
        external"C" fmi = H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiInstantiateModel2(instanceName, loggingOn, resourceLocation)
        annotation(Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_Instantiate_C
#define H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_Instantiate_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227Logger(fmi2ComponentEnvironment componentEnvironment, fmi2String instanceName, fmi2Status status,
...
void * H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiInstantiateModel2(const char*instanceName, fmi2Boolean loggingOn, fmi2String resourceLocation) {
  static fmi2CallbackFunctions funcs = {&H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227Logger, &calloc, &free, NULL, NULL};
  ...
  if (res!=0) {
    ...
    res->m=res->dyFmiInstantiate(instanceName, fmi2CoSimulation, \"{5ed40939-808a-4487-b44e-9b64149422a7}\",resourceLocation, &funcs, fmi2False, loggingOn);
  ...
  return res;
      ...
      function destructor "Release storage of FMI model"
          ...
          input fmiModel fmi;
          external"C"
                     H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiFreeModelInstance2(fmi)
          annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_Free_C
#define H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_Free_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiFreeModelInstance2(void*m) {
  ...
  if (a) {
    ...
    input Real stepSize;
    external"C" H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiDoStep2(fmi, currentTime, stepSize)
      annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_DoStep_C
#define H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_DoStep_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
double H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiDoStep2(void*m, double currentTime, double stepSize) {
  struct dy_fmi2Extended*a=m;
  ...
  if (status!=fmi2OK && status!=fmi2Warning){    ModelicaFormatError(\"The call of fmi2DoStep(%f, %f) failed in FMU\\r\\nNote: setting fmi_loggingOn in the FMU component may produce more information from the FMU.\",currentTime, stepSize);  }  return 1.0;
    ...
    external"C" H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiExitModelInitializationMode2(fmi)
    annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiExitModelInitializationMode_C
#define H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiExitModelInitializationMode_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiExitModelInitializationMode2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  return;
    ...
    function fmi2Reset
      input fmiModel fmi;
      external"C"
                 H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiReset2(fmi)
      annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_Reset_C
#define H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_Reset_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiReset2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiReset failed\");
    ...
    function fmi2GetReal
      ...
      external"C" H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiGetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_GetReal_C
#define H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_GetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiGetReal2(void*m, const int*refs, size_t nrefs, double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetReal failed\");
    ...
    function fmi2SetReal
      ...
      external"C"
                 H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiSetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals)
        annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_SetReal_C
#define H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_SetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiSetReal2(void*m, const int*refs, size_t nrefs, const double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if(!nrefs){return;}
  if (a) {
...
function fmi2SetRealDiscrete
    ...
    protected
      ...
      external"C" H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiSetRealDiscrete(
        fmi,
        refs,
        size(refs, 1),
        vals,
        oldVals)
      annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_SetRealDiscrete_C
#define H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_SetRealDiscrete_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiSetRealDiscrete(void*m, const int*refs, size_t nrefs, double*vals, double*oldVals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  annotation(__Dymola_doNotLinkSharedObject=true,__Dymola_CriticalRegion = "H525b873079cf7a65f464c408f25344d5bd630cab", __Dymola_LockExternalObject=true,__Dymola_IdemPotent=true, __Dymola_VectorizedExceptFirst=true);
    ...
    function fmi2GetInteger
      ...
      external"C" H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiGetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_GetInteger_C
#define H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_GetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiGetInteger2(void*m, const int*refs, size_t nrefs, int*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetInteger failed\");
    ...
    protected
      ...
      external"C" H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiSetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        oldVals)
      annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_SetInteger_C
#define H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_SetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiSetInteger2(void*m, const int*refs, size_t nrefs, int*vals, int*oldVals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetInteger failed\");
    ...
    function fmi2GetBoolean
      ...
      external"C" H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiGetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals)
        annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_GetBoolean_C
#define H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_GetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiGetBoolean2(void*m, const int* refs, size_t nr, int* vals) {
  int i;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetBoolean failed\");
    ...
    protected
      ...
      external"C" H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiSetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        ...
        oldVals)
        annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_SetBoolean_C
#define H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_SetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiSetBoolean2(void*m, const int* refs, size_t nr, const int* vals, int* dummy, int* oldVals) {
  size_t i;
  int j;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetBoolean failed\");
    ...
    function fmi2SetString
      ...
      external"C" H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiSetString2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_SetString_C
#define H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_SetString_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiSetString2(void*m, const int*refs, size_t nrefs,const fmi2String vals[]) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetString failed\");
    ...
    function fmi2GetDirectionalDerivative
      ...
      external"C" H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_GetDirectionalDerivative2(
        fmi,
        z_refs,
        size(z_refs, 1),
        v_refs,
        ...
        dz)
      annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_GetDirectionalDerivative2_C
#define H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_GetDirectionalDerivative2_C 1
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_GetDirectionalDerivative2(void*m, const int* zref, size_t nzr, const int* vrefs, size_t nvr, const double *dv, double *dz) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetDirectionalDerivative failed\");
    ...
    function fmi2SaveFMUState
      input fmiModel fmi;
      external"C" H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiSaveFMUState2(fmi)
        annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiSaveFMUState_C
#define H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiSaveFMUState_C 1
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiSaveFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetFMUstate failed\");
    ...
    function fmi2RestoreFMUState
      input fmiModel fmi;
      external"C" H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiRestoreFMUState2(fmi)
        annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiRestoreFMUState_C
#define H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiRestoreFMUState_C 1
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiRestoreFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiSetFMUstate failed\");
    ...
    function fmi2SerializeFMUstate
      input fmiModel fmi;
      external"C" H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmi2SerializeFMUstate2(fmi)
        annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmi2SerializeFMUstate_C
#define H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmi2SerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmi2SerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
    status = a->dyFmiGetFMUstate(a->m, &a->dyFMUstate);
    ...
    function fmi2DeSerializeFMUstate
      input fmiModel fmi;
      external"C" H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmi2DeSerializeFMUstate2(fmi)
        annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmi2DeSerializeFMUstate_C
#define H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmi2DeSerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmi2DeSerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
    ...
    function fmi2EnterCSInitializationMode
      ...
      external"C" H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiEnterSlaveInitializationMode2(fmi, setTolerance, relativeTolerance, tStart, forceShutDownAtTStop, tStop)
      annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiEnterSlaveInitializationMode_C
#define H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiEnterSlaveInitializationMode_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab5409398084487449641494227_fmiEnterSlaveInitializationMode2(void*m, int setTolerance, double relativeTolerance, double tStart, int forceShutDownAtTStop, double tStop) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
equation
  ...
  annotation (__Dymola_FMUImportVersion="Dymola 2026x Refresh 1 Dev 3", __Dymola_FMUImportPath="C:/Users/CBR5.DSONE/Documents/Dymola/efmuPSS/SiL-integration/FMU/H525b873079cf7a65f464c408f25344d5bd630cab.fmu", __Dymola_FMUImportIncludeAllVariables="false", __Dymola_FMUImportIntegrate="false", __Dymola_FMUResourcePath="Resources/Library/FMU/H525b873079cf7a65f464c408f25344d5bd630cab",__Dymola_FMUImportDateTime="Wed Jan 14 20:54:36 2026 GMT", experiment(StartTime=0.0, StopTime=1.0, Tolerance=0.0001),
    Icon(graphics={
...
<li>generationDateAndTime = 2026-01-14T20:54:28Z</li>
</ul>
