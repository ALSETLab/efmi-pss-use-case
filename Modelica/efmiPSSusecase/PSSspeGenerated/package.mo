...
package PSSspeGenerated
  "eFMU Configuration to test new SPE code Generation - by extending from DymolaEmbedded.EmbeddedConfiguration"
  extends DymolaEmbedded.EmbeddedConfiguration(
    ...
    efmu_configuration(name="PSSspe"),
