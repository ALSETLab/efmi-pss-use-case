...
model hidden_Test_SiL_Scenario_1 "Test scenario defined by component [G4HIL]."
...
protected
  final parameter
    ...
    code_configuration='GridForHILTesting.eFMU_SiL_Support'.resolve_code_configuration(
...
public
  ...
  'GridForHILTesting.eFMU_SiL_Support'.BinaryStub eBlock(final __embedd_clock=false)
