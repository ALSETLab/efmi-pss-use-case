...
package
  ...
  "Test scenarios of original experiment
     [efmiPSSusecase.Experiments.Example_3_PSSDesign4PSSVariantClocked]
   for eBlock model
  ...
  constant ToleranceConfigurations tolerances_default(
    ...
    relative_x64(vs=1.0e-8)) "Configuration of default tolerances." annotation
  ...
  */
  constant String bmodel_container_directory=
      "C:/Users/vanfr/Documents/Github/efmi-pss-use-case/Modelica/work/efmuPSS/eFMU/BModel_Dymola_a3e95f8bfc8f7111ce0a5afbe91c98b3a0600eff"
    annotation (Protection(hideFromBrowser=true));

  annotation (
    preferredView="diagram",
    uses(DymolaEmbedded(version="1.0.5"), Testing(version="1.10.0")),
    ...
    Documentation(info="
        ...
        configuration
        <a href=\"modelica://efmiPSSusecase.efmuPSS\">efmiPSSusecase.efmuPSS</a>.
        </p>
        <p>
        ...
        <p>
        Generated by Dymola on 2025-11-03T21:58:26Z.
        </p>
...
end 'eFMU experiment package (efmuPSS, efmiPSSusecase.Experiments.Example_3_PSSDesign4PSSVariantClocked)';
