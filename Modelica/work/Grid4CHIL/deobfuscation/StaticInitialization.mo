encapsulated package 'OpenIPSL_CHIL.RTS.CHIL.Grid4CHIL: static initialization'
	...
	algorithm
		...
		succeeded := succeeded
		 and .DymolaCommands.SimulatorAPI.simulateModel(
		  problem = "'OpenIPSL_CHIL.RTS.CHIL.Grid4CHIL: static initialization'.StartupModel",
		...
		assert(succeeded, "Simulation of 'OpenIPSL_CHIL.RTS.CHIL.Grid4CHIL: static initialization'.StartupModel failed.");
...
end 'OpenIPSL_CHIL.RTS.CHIL.Grid4CHIL: static initialization';
