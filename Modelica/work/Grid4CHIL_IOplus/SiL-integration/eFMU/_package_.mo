package 'Grid4CHIL_IOplus.eFMU_SiL_Support'
  "Package supporting software in the loop (SiL) simulation of the production
   ...
   Generated by Dymola on 2026-03-26T03:53:23Z."
  ...
  block BinaryStub
    ...
    import __TuningConfiguration = 'Grid4CHIL_IOplus.eFMU_SiL_Support'.TuningConfiguration;
    import __TuningBus = 'Grid4CHIL_IOplus.eFMU_SiL_Support'.TuningBus;
    import __TuningBusSampler = 'Grid4CHIL_IOplus.eFMU_SiL_Support'.TuningBusSampler;
    import __ProductionCodes = 'Grid4CHIL_IOplus.eFMU_SiL_Support'.ProductionCodes;
    ...
    */
    ...
    input .Modelica.Blocks.Interfaces.BooleanInput faultL1
      "Fault input sigal, default false = fault inactive"
      annotation (Placement(transformation(extent={{-20,-20},{20,20}}, rotation=90, origin={0,-120})));
    input .Modelica.Blocks.Interfaces.BooleanInput faultL2
      "Fault input sigal, default false = fault inactive"
      annotation (Placement(transformation(extent={{-20,-20},{20,20}}, rotation=90, origin={60,-120})));
    input .Modelica.Blocks.Interfaces.RealInput uPLoad
      "Input to modulate the active power of the load"
      annotation (Placement(transformation(extent={{-160,-80},{-120,-40}}), iconTransformation(extent={{-160,-80},{-120,-40}})));
    input .Modelica.Blocks.Interfaces.RealInput vf
      "Field voltage"
      annotation (Placement(transformation(extent={{-160,40},{-120,80}}), iconTransformation(extent={{-160,40},{-120,80}})));
    ...
    // Tuneable parameters:
    parameter .OpenIPSL.Types.PerUnit K0 = 30
      "regulator gain";
    parameter Real woffset = 1.00
      "Speed output offset";
    ...
    */
    ...
    class __BlockState_PCode_SPE_cb4a8a449b4ada864625ee5a4355578a3aaf08ed
      ...
      function constructor
        ...
        external "C" block_state = mei_Startup_H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5_cb4a8a449b4ada864625ee5a4355578a3aaf08ed()
          annotation(
            LibraryDirectory = "modelica://'Grid4CHIL_IOplus.eFMU_SiL_Support'/",
            Library = "H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5_cb4a8a449b4ada864625ee5a4355578a3aaf08ed");
      end constructor;
  
      function destructor
        input __BlockState_PCode_SPE_cb4a8a449b4ada864625ee5a4355578a3aaf08ed block_state;
        external "C" mei_Terminate_H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5_cb4a8a449b4ada864625ee5a4355578a3aaf08ed(block_state)
          annotation(
            LibraryDirectory = "modelica://'Grid4CHIL_IOplus.eFMU_SiL_Support'/",
            Library = "H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5_cb4a8a449b4ada864625ee5a4355578a3aaf08ed");
      end destructor;
    ...
    function __Recalibrate_PCode_SPE_cb4a8a449b4ada864625ee5a4355578a3aaf08ed
      input __BlockState_PCode_SPE_cb4a8a449b4ada864625ee5a4355578a3aaf08ed block_state;
      input .OpenIPSL.Types.PerUnit K0
        "regulator gain";
      input Real woffset
        "Speed output offset";
      input Real wscale
      ...
      external "C" error_signals =
        mei_Recalibrate_H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5_cb4a8a449b4ada864625ee5a4355578a3aaf08ed(
          block_state,
          K0,
          woffset,
          wscale);
    ...
    function __Reinitialize_PCode_SPE_cb4a8a449b4ada864625ee5a4355578a3aaf08ed
      ...
      input Boolean fault
        "Fault input sigal, default false = fault inactive";
      input Boolean faultL1
        "Fault input sigal, default false = fault inactive";
      input Boolean faultL2
        "Fault input sigal, default false = fault inactive";
      input Real uPLoad
        "Input to modulate the active power of the load";
      input Real vf
      ...
      output Real w
        "Speed [pu]";
      external "C" error_signals =
        mei_Reinitialize_H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5_cb4a8a449b4ada864625ee5a4355578a3aaf08ed(
          block_state,
          fault,
          faultL1,
          faultL2,
    ...
    function __DoStep_PCode_SPE_cb4a8a449b4ada864625ee5a4355578a3aaf08ed
      ...
      output Real w
        "Speed [pu]";
      external "C" error_signals =
        mei_DoStep_H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5_cb4a8a449b4ada864625ee5a4355578a3aaf08ed(
          block_state,
          fault,
          faultL1,
          faultL2,
    ...
    */
    ...
    class __BlockState_PCode_SPE_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c
      ...
      function constructor
        ...
        external "C" block_state = mei_Startup_H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c()
          annotation(
            LibraryDirectory = "modelica://'Grid4CHIL_IOplus.eFMU_SiL_Support'/",
            Library = "H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c");
      end constructor;
  
      function destructor
        input __BlockState_PCode_SPE_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c block_state;
        external "C" mei_Terminate_H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c(block_state)
          annotation(
            LibraryDirectory = "modelica://'Grid4CHIL_IOplus.eFMU_SiL_Support'/",
            Library = "H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c");
      end destructor;
    ...
    function __Recalibrate_PCode_SPE_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c
      ...
      output Integer error_signals;
      external "C" error_signals =
        mei_Recalibrate_H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c(
          block_state,
          K0,
          woffset,
          wscale);
    ...
    function __Reinitialize_PCode_SPE_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c
      ...
      output Real w
        "Speed [pu]";
      external "C" error_signals =
        mei_Reinitialize_H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c(
          block_state,
          fault,
          faultL1,
          faultL2,
    ...
    function __DoStep_PCode_SPE_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c
      ...
      output Real w
        "Speed [pu]";
      external "C" error_signals =
        mei_DoStep_H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c(
          block_state,
          fault,
          faultL1,
          faultL2,
  ...
  equation
    ...
    */
    ...
    if __embedd_clock then
      ...
      __sampled.faultL1 = sample(faultL1, __clock);
      __sampled.faultL2 = sample(faultL2, __clock);
      __sampled.uPLoad = sample(uPLoad, __clock);
      ...
      __sampled.faultL1 = faultL1;
      __sampled.faultL2 = faultL2;
      __sampled.uPLoad = uPLoad;
      __sampled.vf = vf;
      Pgen = __sampled.Pgen;
      Qgen = __sampled.Qgen;
      v = __sampled.v;
    ...
    */
    ...
    __sampled.__tuning.K0 =
      (if __tuning_configuration.K0
       then __tuning_decoder.K0
       else K0);
    __sampled.__tuning.woffset =
      (if __tuning_configuration.woffset
       then __tuning_decoder.woffset
       else woffset);
    ...
    when Clock() then
      ...
      */
      ...
      if not(__is_initialized) then
        ...
        __active_tuning.K0 := 30;
        __active_tuning.woffset := 1.00;
        __active_tuning.wscale := 50.00;
      end if;
      
      __sampled.__recalibrate := false
        or max(abs(
            __sampled.__tuning.K0
          - __active_tuning.K0)) > 0.0
        or max(abs(
            __sampled.__tuning.woffset
          - __active_tuning.woffset)) > 0.0
        or max(abs(
            __sampled.__tuning.wscale
  ...
  encapsulated record TuningConfiguration
    ...
    parameter Boolean K0 = false;
    parameter Boolean woffset = false;
  ...
  equation 
    ...
    encoder.K0 = sample(decoder.K0);
    encoder.woffset = sample(decoder.woffset);
  ...
  algorithm
    interface := {
      .DymolaEmbedded.BuildUtilities.BinaryCode.BinaryStubGeneration.InterfaceComponent(
        ...
        placement = "Placement(transformation(extent={{-20,-20},{20,20}}, rotation=90, origin={-60,-120}))"),
      .DymolaEmbedded.BuildUtilities.BinaryCode.BinaryStubGeneration.InterfaceComponent(
        io_type = .DymolaEmbedded.BuildUtilities.BinaryCode.BinaryStubGeneration.InterfaceComponent.IOType.Input,
        primitive_type = .DymolaEmbedded.BuildUtilities.BinaryCode.BinaryStubGeneration.InterfaceComponent.PrimitiveType.Boolean,
        type_name = "Modelica.Blocks.Interfaces.BooleanInput",
      ...
      .DymolaEmbedded.BuildUtilities.BinaryCode.BinaryStubGeneration.InterfaceComponent(
        ...
        value = "",
        description = "Input to modulate the active power of the load",
        placement = "Placement(transformation(extent={{-160,-80},{-120,-40}}), iconTransformation(extent={{-160,-80},{-120,-40}}))"),
      .DymolaEmbedded.BuildUtilities.BinaryCode.BinaryStubGeneration.InterfaceComponent(
        io_type = .DymolaEmbedded.BuildUtilities.BinaryCode.BinaryStubGeneration.InterfaceComponent.IOType.Input,
        primitive_type = .DymolaEmbedded.BuildUtilities.BinaryCode.BinaryStubGeneration.InterfaceComponent.PrimitiveType.Real,
        type_name = "Modelica.Blocks.Interfaces.RealInput",
        ...
        placement = "Placement(transformation(extent={{-160,40},{-120,80}}), iconTransformation(extent={{-160,40},{-120,80}}))"),
      .DymolaEmbedded.BuildUtilities.BinaryCode.BinaryStubGeneration.InterfaceComponent(
      ...
      .DymolaEmbedded.BuildUtilities.BinaryCode.BinaryStubGeneration.InterfaceComponent(
        ...
        value = "50.00",
        description = "Speed output scaling",
        placement = "")};
...
protected
  ...
  protected 
    ...
    block Source
      ...
      output __TuningConnectors.K0 K0;
      output __TuningConnectors.woffset woffset;
      output __TuningConnectors.wscale wscale;
    equation
      K0 = __tuning.K0;
      woffset = __tuning.woffset;
      wscale = __tuning.wscale;
    end Source;
    
  equation
    connect(source.K0, encoder.K0);
    connect(source.woffset, encoder.woffset);
  ...
  model __TuningBusEncoder
    ...
    input __TuningConnectors.K0 K0;
    input __TuningConnectors.woffset woffset;
...
end 'Grid4CHIL_IOplus.eFMU_SiL_Support';
