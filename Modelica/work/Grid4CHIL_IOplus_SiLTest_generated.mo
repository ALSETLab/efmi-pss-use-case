within ;
package Grid4CHIL_IOplus_SiLTest_generated
  "Test scenarios of original experiment
     [OpenIPSL_CHIL.RTS.Tests.CHIL.Grid4CHIL_IOplus_Clocked]
   for eBlock model
  ...
  */
  constant String bmodel_container_directory=
      "E:/modelica-libraries/efmi-pss-use-case/Modelica/work/Grid4CHIL_IOplus/eFMU/BModel_Dymola_4a73ad9f0950d19cf03cbedb79e4156cf8f7245d"
  ...
  model hidden_Test_ReferenceExperiment "Reference experiment with test scenarios for
    ...
    .OpenIPSL_CHIL.RTS.Tests.CHIL.Grid4CHIL_IOplus_Clocked experiment
    ...
    */
    ...
    final
      ...
      'faultL1|Scenario_1|query'(each final sample_source=clkSet1.clockType == "external",
        final source(final y=experiment.G4CHIL.faultL1))
      "Measured: Fault input sigal, default false = fault inactive"
    ...
    final
      ...
      'faultL2|Scenario_1|query'(each final sample_source=clkSet1.clockType == "external",
        final source(final y=experiment.G4CHIL.faultL2))
      "Measured: Fault input sigal, default false = fault inactive"
    ...
    final
      ...
      'uPLoad|Scenario_1|query'(each final sample_source=clkSet1.clockType == "external",
        final source(final y=experiment.G4CHIL.uPLoad))
    ...
    */
    ...
    annotation (
      ...
      Documentation(info="
          ...
          <a href=\"modelica://OpenIPSL_CHIL.RTS.Tests.CHIL.Grid4CHIL_IOplus_Clocked\">OpenIPSL_CHIL.RTS.Tests.CHIL.Grid4CHIL_IOplus_Clocked</a>.
          </p>
          </html>"),
  ...
  annotation (
    ...
    Documentation(info="
        ...
        <p>
        Generated by Dymola on 2026-04-09T09:45:35Z.
        </p>
...
end Grid4CHIL_IOplus_SiLTest_generated;
