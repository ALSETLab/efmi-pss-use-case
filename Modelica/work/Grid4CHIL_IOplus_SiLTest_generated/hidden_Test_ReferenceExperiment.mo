within Grid4CHIL_IOplus_SiLTest_generated;
model hidden_Test_ReferenceExperiment "Reference experiment with test scenarios for
  ...
  final
    .DymolaEmbedded.BuildUtilities.BehavioralModel.ExperimentSensors.BooleanSensor
    'faultL1|Scenario_1|query'(each final sample_source=clkSet1.clockType ==
        "external", final source(final y=experiment.G4CHIL.faultL1))
    "Measured: Fault input sigal, default false = fault inactive"
  ...
  final
    .DymolaEmbedded.BuildUtilities.BehavioralModel.ExperimentSensors.BooleanSensor
    'faultL2|Scenario_1|query'(each final sample_source=clkSet1.clockType ==
        "external", final source(final y=experiment.G4CHIL.faultL2))
    "Measured: Fault input sigal, default false = fault inactive"
  ...
  final
    ...
    'uPLoad|Scenario_1|query'(each final sample_source=clkSet1.clockType ==
        "external", final source(final y=experiment.G4CHIL.uPLoad))
