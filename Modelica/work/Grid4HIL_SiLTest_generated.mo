within ;
package Grid4HIL_SiLTest_generated "Test scenarios of original experiment
     [OpenIPSL_CHIL.RTS.Tests.HIL.Grid4HIL_Clocked]
   for eBlock model
     [OpenIPSL_CHIL.RTS.HIL.Grid4HIL]."

  extends .DymolaEmbedded.Icons.eFMI_ExperimentPackage;

  final package configuration = .OpenIPSL_CHIL.RTS.HIL.eFMUs.Grid4HIL;
  ...
  */
  constant String bmodel_container_directory=
      "E:/modelica-libraries/efmi-pss-use-case/Modelica/work/Grid4HIL/eFMU/BModel_Dymola_492086af0b5faf25011a088a7fc4132ad3639c02"
  ...
  model hidden_Test_ReferenceExperiment "Reference experiment with test scenarios for
    ...
    .OpenIPSL_CHIL.RTS.Tests.HIL.Grid4HIL_Clocked experiment
      annotation (Placement(transformation(extent={{-20,60},{20,100}})));

    /*
      Test setup for [G4HIL]:
    */
    ...
    final
      ...
      'fault|Scenario_1|query'(each final sample_source=clkSet1.clockType ==
          "external", final source(final y=experiment.G4HIL.fault))
    ...
    final
      ...
      'vf|Scenario_1|query'(each final sample_source=clkSet1.clockType ==
          "external", final source(final y=experiment.G4HIL.vf))
    ...
    final
      ...
      'Pgen|Scenario_1|query'(each final sample_source=clkSet1.clockType ==
          "external", final source(final y=experiment.G4HIL.Pgen))
    ...
    final
      ...
      'Qgen|Scenario_1|query'(each final sample_source=clkSet1.clockType ==
          "external", final source(final y=experiment.G4HIL.Qgen))
    ...
    final
      ...
      'v|Scenario_1|query'(each final sample_source=clkSet1.clockType ==
          "external", final source(final y=experiment.G4HIL.v))
    ...
    final
      ...
      'vf0OUT|Scenario_1|query'(each final sample_source=clkSet1.clockType ==
          "external", final source(final y=experiment.G4HIL.vf0OUT))
    ...
    final
      ...
      'w|Scenario_1|query'(each final sample_source=clkSet1.clockType ==
          "external", final source(final y=experiment.G4HIL.w))
      "Measured: Speed [pu]"
  ...
  model hidden_Test_SiL_Scenario_1
    "Test scenario defined by component [G4HIL]."
  ...
  protected
    final parameter
      ...
      code_configuration='Grid4HIL.eFMU_SiL_Support'.resolve_code_configuration(
  ...
  public
    ...
    'Grid4HIL.eFMU_SiL_Support'.BinaryStub eBlock(final __embedd_clock=false)
  ...
  equation
    ...
    connect('Qgen|table'.y, 'Qgen|match'.ref) annotation (Line(points={{69,0},{
            66,0},{66,-20},{32,-20},{32,-6},{36,-6}}, color={0,0,127}));
    ...
    connect('vf0OUT|table'.y, 'vf0OUT|match'.ref) annotation (Line(points={{69,
            -80},{66,-80},{66,-100},{32,-100},{32,-86},{36,-86}}, color={0,0,
            127}));

    connect('vf0OUT|match'.act, eBlock.vf0OUT)
      annotation (Line(points={{36,-74},{15,0}}, color={0,0,127}));

    connect('w|table'.y, 'w|match'.ref) annotation (Line(points={{69,-120},{66,
            -120},{66,-140},{32,-140},{32,-126},{36,-126}}, color={0,0,127}));
  ...
  model
    ...
    extends hidden_Test_SiL_Scenario_1(eBlock(
        final __defining_code='Grid4HIL.eFMU_SiL_Support'.ProductionCodes.PCode_SPE_cb4a8a449b4ada864625ee5a4355578a3aaf08ed,
        final __active_codes={'Grid4HIL.eFMU_SiL_Support'.ProductionCodes.PCode_SPE_cb4a8a449b4ada864625ee5a4355578a3aaf08ed},
  ...
  annotation (
    preferredView="diagram",
    uses(
      DymolaEmbedded(version="1.0.9"),
      Testing(version="2.0.0"),
      Modelica(version="4.1.0"),
      DymolaCommands(version="1.21")),
    ...
    Documentation(info="
        ...
        <a href=\"modelica://OpenIPSL_CHIL.RTS.HIL.Grid4HIL\">OpenIPSL_CHIL.RTS.HIL.Grid4HIL</a>
        (eBlock) defining one test scenario according to eFMU generation
        configuration
        <a href=\"modelica://OpenIPSL_CHIL.RTS.HIL.eFMUs.Grid4HIL\">OpenIPSL_CHIL.RTS.HIL.eFMUs.Grid4HIL</a>.
        </p>
        <p>
        ...
        <p>
        Generated by Dymola on 2026-04-01T12:40:21Z.
        </p>
...
end Grid4HIL_SiLTest_generated;
