within ;
model H225c1baf6cf5a31bc9b0c38998c32298f6f0531c
  "Stub for eFMU-based co-simulation of
     ...
     Generated by Dymola on 2026-03-26T02:10:28Z."
extends fmuIcon;

// Model automatically generated by Dymola from FMI model description
public
encapsulated package importedFMUTypes
  type 'PSSTypeIISimpleHPF_eFMU_SiL_Support\'___TuningConnectors_Kw' = Real;
  type 'PSSTypeIISimpleHPF_eFMU_SiL_Support\'___TuningConnectors_T1' = Real (unit = "s", quantity = "Time");
  type 'PSSTypeIISimpleHPF_eFMU_SiL_Support\'___TuningConnectors_T2' = Real (unit = "s", quantity = "Time");
  type 'PSSTypeIISimpleHPF_eFMU_SiL_Support\'___TuningConnectors_T3' = Real (unit = "s", quantity = "Time");
  type 'PSSTypeIISimpleHPF_eFMU_SiL_Support\'___TuningConnectors_T4' = Real (unit = "s", quantity = "Time");
  type 'PSSTypeIISimpleHPF_eFMU_SiL_Support\'___TuningConnectors_Tw' = Real (unit = "s", quantity = "Time");
  type 'PSSTypeIISimpleHPF_eFMU_SiL_Support\'___TuningConnectors_freqLow' = Real (unit = "Hz", quantity = "Frequency");
  type 'PSSTypeIISimpleHPF_eFMU_SiL_Support\'___TuningConnectors_kLPF' = Real;
  type 'PSSTypeIISimpleHPF_eFMU_SiL_Support\'___TuningConnectors_vSI_start' = Real;
  type 'PSSTypeIISimpleHPF_eFMU_SiL_Support\'___TuningConnectors_vsmax' = Real;
  type 'PSSTypeIISimpleHPF_eFMU_SiL_Support\'___TuningConnectors_vsmin' = Real;
  type 'PSSTypeIISimpleHPF_eFMU_SiL_Support\'___TuningConnectors_wscale' = Real;
  ...
  type 'PSSTypeIISimpleHPF_eFMU_SiL_Support\'_ProductionCodes' = enumeration(Mockup "non-functional mockup",
        PCode_SPE_cb4a8a449b4ada864625ee5a4355578a3aaf08ed,
        PCode_SPE_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c);
constant Integer[3] 'PSSTypeIISimpleHPF_eFMU_SiL_Support\'_ProductionCodes_values' = {1, 2, 3};
end importedFMUTypes;
  parameter Real Kw = 2.7 "Stabilizer gain [pu/pu]";
  parameter importedFMUTypes.OpenIPSL_Types_Time T1 = 0.32417874258802 "First stabilizer time constant";
  parameter importedFMUTypes.OpenIPSL_Types_Time T2 = 0.0556202789619914 "Second stabilizer time constant";
  parameter importedFMUTypes.OpenIPSL_Types_Time T3 = 0.32417874258802 "Third stabilizer time constant";
  parameter importedFMUTypes.OpenIPSL_Types_Time T4 = 0.0556202789619914 "Fourth stabilizer time constant";
  parameter importedFMUTypes.OpenIPSL_Types_Time Tw = 0.25 "Wash-out time constant";
  parameter Modelica.Units.SI.Frequency freqLow = 5.0 "Frequency in Hz for noise supression (low-pass filter cutoff frequency) – attenuates noise at frequencies above this value.";
  parameter Real kLPF = 1.0 "Gain for noise supression (low-pass filter gain) – attenuates noise at frequencies above this value.";
  parameter Real vSI_start = 1.0 "Default start value for vSI, the PSS input signal.";
  parameter importedFMUTypes.OpenIPSL_Types_PerUnit vsmax = 1.5 "Max stabilizer output signal";
  parameter importedFMUTypes.OpenIPSL_Types_PerUnit vsmin = -1.5 "Min stabilizer output signal";
  parameter Real wscale = 50.0 "Speed input scaling";
  protected
  record _Clocks_rec
    protected
...
public
  parameter String fmi_instanceName="H225c1baf6cf5a31bc9b0c38998c32298f6f0531c"
  ...
  parameter String fmi_resourceLocation="file:///"+ModelicaServices.ExternalReferences.loadResource("modelica://H225c1baf6cf5a31bc9b0c38998c32298f6f0531c/Resources/Library/FMU/H225c1baf6cf5a31bc9b0c38998c32298f6f0531c/resources")
...
package fmi_Functions
    ...
    class fmiModel
      ...
      function constructor "Initialize FMI model"
        ...
        output fmiModel fmi;
        external"C" fmi = H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiInstantiateModel2(instanceName, loggingOn, resourceLocation)
        annotation(Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_Instantiate_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_Instantiate_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176Logger(fmi2ComponentEnvironment componentEnvironment, fmi2String instanceName, fmi2Status status,
...
void * H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiInstantiateModel2(const char*instanceName, fmi2Boolean loggingOn, fmi2String resourceLocation) {
  static fmi2CallbackFunctions funcs = {&H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176Logger, &calloc, &free, NULL, NULL};
  struct dy_fmi2Extended* res;
  res = calloc(1, sizeof(struct dy_fmi2Extended));
  if (res!=0) {
#ifdef _WIN32
    if (!(res->hInst=LoadLibraryW(L\"H225c1baf6cf5a31bc9b0c38998c32298f6f0531c.dll\"))) {
      ModelicaError(\"Loading of FMU dynamic link library (H225c1baf6cf5a31bc9b0c38998c32298f6f0531c.dll) failed!\");
#else
    if (!(res->hInst=LoadLibrary(\"H225c1baf6cf5a31bc9b0c38998c32298f6f0531c.so\"))) {
      ModelicaError(\"Loading of FMU dynamic link library (H225c1baf6cf5a31bc9b0c38998c32298f6f0531c.so) failed!\");
#endif
      return 0;
    }
    ...
    res->m=res->dyFmiInstantiate(instanceName, fmi2CoSimulation, \"{e4421f1c-d33c-4383-94c4-2239269cc176}\",resourceLocation, &funcs, fmi2False, loggingOn);
  ...
  return res;
...
#endif", Library="H225c1baf6cf5a31bc9b0c38998c32298f6f0531c", LibraryDirectory="modelica://H225c1baf6cf5a31bc9b0c38998c32298f6f0531c/Resources/Library/FMU/H225c1baf6cf5a31bc9b0c38998c32298f6f0531c/binaries");
        annotation (__Dymola_doNotLinkSharedObject=true,
            __Dymola_CriticalRegion="H225c1baf6cf5a31bc9b0c38998c32298f6f0531c");
      end constructor;
      ...
      function destructor "Release storage of FMI model"
          ...
          input fmiModel fmi;
          external"C"
                     H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiFreeModelInstance2(fmi)
          annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_Free_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_Free_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiFreeModelInstance2(void*m) {
  ...
  if (a) {
...
#endif",       Library="H225c1baf6cf5a31bc9b0c38998c32298f6f0531c", LibraryDirectory="modelica://H225c1baf6cf5a31bc9b0c38998c32298f6f0531c/Resources/Library/FMU/H225c1baf6cf5a31bc9b0c38998c32298f6f0531c/binaries");
        annotation(__Dymola_doNotLinkSharedObject=true,__Dymola_CriticalRegion = "H225c1baf6cf5a31bc9b0c38998c32298f6f0531c");
      end destructor;
    ...
    input Real stepSize;
    external"C" H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiDoStep2(fmi, currentTime, stepSize)
      annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_DoStep_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_DoStep_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
double H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiDoStep2(void*m, double currentTime, double stepSize) {
  struct dy_fmi2Extended*a=m;
  ...
  if (status!=fmi2OK && status!=fmi2Warning){    ModelicaFormatError(\"The call of fmi2DoStep(%f, %f) failed in FMU\\r\\nNote: setting fmi_loggingOn in the FMU component may produce more information from the FMU.\",currentTime, stepSize);  }  return 1.0;
    ...
    external"C" H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiExitModelInitializationMode2(fmi)
    annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiExitModelInitializationMode_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiExitModelInitializationMode_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiExitModelInitializationMode2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  return;
    ...
    function fmi2Reset
      input fmiModel fmi;
      external"C"
                 H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiReset2(fmi)
      annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_Reset_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_Reset_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiReset2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiReset failed\");
    ...
    function fmi2GetReal
      ...
      external"C" H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiGetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_GetReal_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_GetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiGetReal2(void*m, const int*refs, size_t nrefs, double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetReal failed\");
    ...
    function fmi2SetReal
      ...
      external"C"
                 H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiSetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals)
        annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_SetReal_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_SetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiSetReal2(void*m, const int*refs, size_t nrefs, const double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if(!nrefs){return;}
  if (a) {
...
function fmi2SetRealDiscrete
    ...
    protected
      ...
      external"C" H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiSetRealDiscrete(
        fmi,
        refs,
        size(refs, 1),
        vals,
        oldVals)
      annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_SetRealDiscrete_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_SetRealDiscrete_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiSetRealDiscrete(void*m, const int*refs, size_t nrefs, double*vals, double*oldVals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
...
#endif", Library="H225c1baf6cf5a31bc9b0c38998c32298f6f0531c", LibraryDirectory="modelica://H225c1baf6cf5a31bc9b0c38998c32298f6f0531c/Resources/Library/FMU/H225c1baf6cf5a31bc9b0c38998c32298f6f0531c/binaries");
  annotation(__Dymola_doNotLinkSharedObject=true,__Dymola_CriticalRegion = "H225c1baf6cf5a31bc9b0c38998c32298f6f0531c", __Dymola_LockExternalObject=true,__Dymola_IdemPotent=true, __Dymola_VectorizedExceptFirst=true);
    ...
    function fmi2GetInteger
      ...
      external"C" H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiGetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_GetInteger_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_GetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiGetInteger2(void*m, const int*refs, size_t nrefs, int*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetInteger failed\");
    ...
    protected
      ...
      external"C" H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiSetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        oldVals)
      annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_SetInteger_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_SetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiSetInteger2(void*m, const int*refs, size_t nrefs, int*vals, int*oldVals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetInteger failed\");
    ...
    function fmi2GetBoolean
      ...
      external"C" H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiGetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals)
        annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_GetBoolean_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_GetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiGetBoolean2(void*m, const int* refs, size_t nr, int* vals) {
  int i;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetBoolean failed\");
    ...
    protected
      ...
      external"C" H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiSetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        ...
        oldVals)
        annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_SetBoolean_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_SetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiSetBoolean2(void*m, const int* refs, size_t nr, const int* vals, int* dummy, int* oldVals) {
  size_t i;
  int j;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetBoolean failed\");
    ...
    function fmi2SetString
      ...
      external"C" H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiSetString2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_SetString_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_SetString_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiSetString2(void*m, const int*refs, size_t nrefs,const fmi2String vals[]) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetString failed\");
    ...
    function fmi2GetDirectionalDerivative
      ...
      external"C" H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_GetDirectionalDerivative2(
        fmi,
        z_refs,
        size(z_refs, 1),
        v_refs,
        ...
        dz)
      annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_GetDirectionalDerivative2_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_GetDirectionalDerivative2_C 1
#include \"FMI/fmi2Import.h\"
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_GetDirectionalDerivative2(void*m, const int* zref, size_t nzr, const int* vrefs, size_t nvr, const double *dv, double *dz) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetDirectionalDerivative failed\");
    ...
    function fmi2SaveFMUState
      input fmiModel fmi;
      external"C" H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiSaveFMUState2(fmi)
        annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiSaveFMUState_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiSaveFMUState_C 1
#include \"FMI/fmi2Import.h\"
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiSaveFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetFMUstate failed\");
    ...
    function fmi2RestoreFMUState
      input fmiModel fmi;
      external"C" H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiRestoreFMUState2(fmi)
        annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiRestoreFMUState_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiRestoreFMUState_C 1
#include \"FMI/fmi2Import.h\"
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiRestoreFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiSetFMUstate failed\");
    ...
    function fmi2SerializeFMUstate
      input fmiModel fmi;
      external"C" H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmi2SerializeFMUstate2(fmi)
        annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmi2SerializeFMUstate_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmi2SerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmi2SerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
    status = a->dyFmiGetFMUstate(a->m, &a->dyFMUstate);
    ...
    function fmi2DeSerializeFMUstate
      input fmiModel fmi;
      external"C" H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmi2DeSerializeFMUstate2(fmi)
        annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmi2DeSerializeFMUstate_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmi2DeSerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmi2DeSerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
    ...
    function fmi2EnterCSInitializationMode
      ...
      external"C" H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiEnterSlaveInitializationMode2(fmi, setTolerance, relativeTolerance, tStart, forceShutDownAtTStop, tStop)
      annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiEnterSlaveInitializationMode_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiEnterSlaveInitializationMode_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c442113343839442239269176_fmiEnterSlaveInitializationMode2(void*m, int setTolerance, double relativeTolerance, double tStart, int forceShutDownAtTStop, double tStop) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
initial algorithm
  fmi_Functions.fmi2SetReal(fmi, {16777217, 16777218, 16777219, 16777220, 16777221, 16777222, 16777223, 16777224, 16777225, 16777226, 16777227, 16777228}, {Kw, T1, T2, T3, T4, Tw, freqLow, kLPF, vSI_start, vsmax, vsmin, wscale});
  ...
  fmi_idum := 1;
  myTimeStart :=time;
    fmi_Functions.fmi2SetReal(fmi, {620756992}, {_vSI_start});
algorithm
assert(fmi_CommunicationStepSize > 0.0,"The parameter fmi_CommunicationStepSize has an invalid value, please set a positive value larger than 0.0");
  when {initial(), sample(fmi_StartTime, fmi_CommunicationStepSize)} then
    if fmi_InputTime then
      fmi_Functions.fmi2SetReal(fmi,{620756992}, {_vSI_old});
    else
      if fmi_UsePreOnInputSignals then
        fmi_Functions.fmi2SetReal(fmi, {620756992}, {pre(vSI)});
      else
        fmi_Functions.fmi2SetReal(fmi, {620756992}, {vSI});
      end if;
    end if;
  ...
  internal.__error_signals_DoStep :=fmi_Functions.fmi2GetIntegerScalar(fmi,
        603979779);
  internal.vs :=fmi_Functions.fmi2GetRealScalar(fmi, 603979780);
    end if;
  end when;
...
equation
  ...
  annotation (__Dymola_FMUImportVersion="Dymola 2026x Refresh 1 Beta 1", __Dymola_FMUImportPath="C:/dev/efmi-pss-use-case/Modelica/work/PSSTypeIISimpleHPF/SiL-integration/FMU/H225c1baf6cf5a31bc9b0c38998c32298f6f0531c.fmu", __Dymola_FMUImportIncludeAllVariables="false", __Dymola_FMUImportIntegrate="false", __Dymola_FMUResourcePath="Resources/Library/FMU/H225c1baf6cf5a31bc9b0c38998c32298f6f0531c",__Dymola_FMUImportDateTime="Thu Mar 26 02:10:40 2026 GMT", experiment(StartTime=0.0, StopTime=10.0, Tolerance=0.0001),
    Icon(graphics={
...
<li>modelName = H225c1baf6cf5a31bc9b0c38998c32298f6f0531c</li>
...
<li>generationDateAndTime = 2026-03-26T02:10:30Z</li>
</ul>
...
end H225c1baf6cf5a31bc9b0c38998c32298f6f0531c;
