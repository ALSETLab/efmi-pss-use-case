...
model H225c1baf6cf5a31bc9b0c38998c32298f6f0531c
  "Stub for eFMU-based co-simulation of
     ...
     Generated by Dymola on 2026-03-15T04:43:35Z."
extends fmuIcon;
...
package fmi_Functions
    ...
    class fmiModel
      ...
      function constructor "Initialize FMI model"
        ...
        output fmiModel fmi;
        external"C" fmi = H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiInstantiateModel2(instanceName, loggingOn, resourceLocation)
        annotation(Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_Instantiate_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_Instantiate_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549Logger(fmi2ComponentEnvironment componentEnvironment, fmi2String instanceName, fmi2Status status,
...
void * H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiInstantiateModel2(const char*instanceName, fmi2Boolean loggingOn, fmi2String resourceLocation) {
  static fmi2CallbackFunctions funcs = {&H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549Logger, &calloc, &free, NULL, NULL};
  ...
  if (res!=0) {
    ...
    res->m=res->dyFmiInstantiate(instanceName, fmi2CoSimulation, \"{9440df14-491f-4a53-85bb-887fbf49b549}\",resourceLocation, &funcs, fmi2False, loggingOn);
  ...
  return res;
      ...
      function destructor "Release storage of FMI model"
          ...
          input fmiModel fmi;
          external"C"
                     H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiFreeModelInstance2(fmi)
          annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_Free_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_Free_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiFreeModelInstance2(void*m) {
  ...
  if (a) {
    ...
    input Real stepSize;
    external"C" H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiDoStep2(fmi, currentTime, stepSize)
      annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_DoStep_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_DoStep_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
double H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiDoStep2(void*m, double currentTime, double stepSize) {
  struct dy_fmi2Extended*a=m;
  ...
  if (status!=fmi2OK && status!=fmi2Warning){    ModelicaFormatError(\"The call of fmi2DoStep(%f, %f) failed in FMU\\r\\nNote: setting fmi_loggingOn in the FMU component may produce more information from the FMU.\",currentTime, stepSize);  }  return 1.0;
    ...
    external"C" H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiExitModelInitializationMode2(fmi)
    annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiExitModelInitializationMode_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiExitModelInitializationMode_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiExitModelInitializationMode2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  return;
    ...
    function fmi2Reset
      input fmiModel fmi;
      external"C"
                 H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiReset2(fmi)
      annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_Reset_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_Reset_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiReset2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiReset failed\");
    ...
    function fmi2GetReal
      ...
      external"C" H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiGetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_GetReal_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_GetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiGetReal2(void*m, const int*refs, size_t nrefs, double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetReal failed\");
    ...
    function fmi2SetReal
      ...
      external"C"
                 H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiSetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals)
        annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_SetReal_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_SetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiSetReal2(void*m, const int*refs, size_t nrefs, const double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if(!nrefs){return;}
  if (a) {
...
function fmi2SetRealDiscrete
    ...
    protected
      ...
      external"C" H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiSetRealDiscrete(
        fmi,
        refs,
        size(refs, 1),
        vals,
        oldVals)
      annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_SetRealDiscrete_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_SetRealDiscrete_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiSetRealDiscrete(void*m, const int*refs, size_t nrefs, double*vals, double*oldVals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  annotation(__Dymola_doNotLinkSharedObject=true,__Dymola_CriticalRegion = "H225c1baf6cf5a31bc9b0c38998c32298f6f0531c", __Dymola_LockExternalObject=true,__Dymola_IdemPotent=true, __Dymola_VectorizedExceptFirst=true);
    ...
    function fmi2GetInteger
      ...
      external"C" H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiGetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_GetInteger_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_GetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiGetInteger2(void*m, const int*refs, size_t nrefs, int*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetInteger failed\");
    ...
    protected
      ...
      external"C" H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiSetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        oldVals)
      annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_SetInteger_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_SetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiSetInteger2(void*m, const int*refs, size_t nrefs, int*vals, int*oldVals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetInteger failed\");
    ...
    function fmi2GetBoolean
      ...
      external"C" H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiGetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals)
        annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_GetBoolean_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_GetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiGetBoolean2(void*m, const int* refs, size_t nr, int* vals) {
  int i;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetBoolean failed\");
    ...
    protected
      ...
      external"C" H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiSetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        ...
        oldVals)
        annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_SetBoolean_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_SetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiSetBoolean2(void*m, const int* refs, size_t nr, const int* vals, int* dummy, int* oldVals) {
  size_t i;
  int j;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetBoolean failed\");
    ...
    function fmi2SetString
      ...
      external"C" H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiSetString2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_SetString_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_SetString_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiSetString2(void*m, const int*refs, size_t nrefs,const fmi2String vals[]) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetString failed\");
    ...
    function fmi2GetDirectionalDerivative
      ...
      external"C" H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_GetDirectionalDerivative2(
        fmi,
        z_refs,
        size(z_refs, 1),
        v_refs,
        ...
        dz)
      annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_GetDirectionalDerivative2_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_GetDirectionalDerivative2_C 1
#include \"FMI/fmi2Import.h\"
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_GetDirectionalDerivative2(void*m, const int* zref, size_t nzr, const int* vrefs, size_t nvr, const double *dv, double *dz) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetDirectionalDerivative failed\");
    ...
    function fmi2SaveFMUState
      input fmiModel fmi;
      external"C" H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiSaveFMUState2(fmi)
        annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiSaveFMUState_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiSaveFMUState_C 1
#include \"FMI/fmi2Import.h\"
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiSaveFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetFMUstate failed\");
    ...
    function fmi2RestoreFMUState
      input fmiModel fmi;
      external"C" H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiRestoreFMUState2(fmi)
        annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiRestoreFMUState_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiRestoreFMUState_C 1
#include \"FMI/fmi2Import.h\"
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiRestoreFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiSetFMUstate failed\");
    ...
    function fmi2SerializeFMUstate
      input fmiModel fmi;
      external"C" H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmi2SerializeFMUstate2(fmi)
        annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmi2SerializeFMUstate_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmi2SerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmi2SerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
    status = a->dyFmiGetFMUstate(a->m, &a->dyFMUstate);
    ...
    function fmi2DeSerializeFMUstate
      input fmiModel fmi;
      external"C" H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmi2DeSerializeFMUstate2(fmi)
        annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmi2DeSerializeFMUstate_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmi2DeSerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmi2DeSerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
    ...
    function fmi2EnterCSInitializationMode
      ...
      external"C" H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiEnterSlaveInitializationMode2(fmi, setTolerance, relativeTolerance, tStart, forceShutDownAtTStop, tStop)
      annotation (Include="
#ifndef H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiEnterSlaveInitializationMode_C
#define H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiEnterSlaveInitializationMode_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H225c1baf6cf5a31bc9b0c38998c32298f6f0531c9440144914538588749549_fmiEnterSlaveInitializationMode2(void*m, int setTolerance, double relativeTolerance, double tStart, int forceShutDownAtTStop, double tStop) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
<li>generationDateAndTime = 2026-03-15T04:43:38Z</li>
</ul>
