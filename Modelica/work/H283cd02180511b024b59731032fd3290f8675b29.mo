...
public
  ...
  parameter Real fmi_StopTime = 20.0
  annotation (Dialog(tab="FMI", group="Step time"));
  parameter Real fmi_CommunicationStepSize = 0.0002
  annotation (Dialog(tab="FMI", group="Step time"));
...
package fmi_Functions
    ...
    class fmiModel
      ...
      function constructor "Initialize FMI model"
        ...
        output fmiModel fmi;
        external"C" fmi = H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiInstantiateModel2(instanceName, loggingOn, resourceLocation)
        annotation(Include="
#ifndef H283cd02180511b024b59731032fd3290f8675b29458015644380140623_Instantiate_C
#define H283cd02180511b024b59731032fd3290f8675b29458015644380140623_Instantiate_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void H283cd02180511b024b59731032fd3290f8675b29458015644380140623Logger(fmi2ComponentEnvironment componentEnvironment, fmi2String instanceName, fmi2Status status,
...
void * H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiInstantiateModel2(const char*instanceName, fmi2Boolean loggingOn, fmi2String resourceLocation) {
  static fmi2CallbackFunctions funcs = {&H283cd02180511b024b59731032fd3290f8675b29458015644380140623Logger, &calloc, &free, NULL, NULL};
  ...
  if (res!=0) {
    ...
    res->m=res->dyFmiInstantiate(instanceName, fmi2CoSimulation, \"{c45cc80f-1e56-44d3-8cc0-1bf4b06eb2e3}\",resourceLocation, &funcs, fmi2False, loggingOn);
  ...
  return res;
      ...
      function destructor "Release storage of FMI model"
          ...
          input fmiModel fmi;
          external"C"
                     H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiFreeModelInstance2(fmi)
          annotation (Include="
#ifndef H283cd02180511b024b59731032fd3290f8675b29458015644380140623_Free_C
#define H283cd02180511b024b59731032fd3290f8675b29458015644380140623_Free_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiFreeModelInstance2(void*m) {
  ...
  if (a) {
    ...
    external"C" stepOK =H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiDoStep2(fmi, currentTime, stepSize)
      annotation (Include="
#ifndef H283cd02180511b024b59731032fd3290f8675b29458015644380140623_DoStep_C
#define H283cd02180511b024b59731032fd3290f8675b29458015644380140623_DoStep_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
double H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiDoStep2(void*m, double currentTime, double stepSize) {
  struct dy_fmi2Extended*a=m;
  ...
  if (status!=fmi2OK && status!=fmi2Warning){    ModelicaFormatError(\"The call of fmi2DoStep(%f, %f) failed in FMU\\r\\nNote: setting fmi_loggingOn in the FMU component may produce more information from the FMU.\",currentTime, stepSize);  }  return 1.0;
    ...
    function fmiReset
      ...
      external"C" resetOK = H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiReset2(fmi)
      annotation (Include="
#ifndef H283cd02180511b024b59731032fd3290f8675b29458015644380140623_Reset_C
#define H283cd02180511b024b59731032fd3290f8675b29458015644380140623_Reset_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
double H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiReset2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiReset failed\");
    ...
    function fmiGetReal
      ...
      external"C" H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiGetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef H283cd02180511b024b59731032fd3290f8675b29458015644380140623_GetReal_C
#define H283cd02180511b024b59731032fd3290f8675b29458015644380140623_GetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiGetReal2(void*m, const int*refs, size_t nrefs, double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
void H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiGetReal2(void*m, const int*refs, size_t nrefs, double*vals) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetReal failed\");
    ...
    function fmiSetReal
      ...
      external"C"
                 H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiSetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals)
        annotation (Include="
#ifndef H283cd02180511b024b59731032fd3290f8675b29458015644380140623_SetReal_C
#define H283cd02180511b024b59731032fd3290f8675b29458015644380140623_SetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiSetReal2(void*m, const int*refs, size_t nrefs, const double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if(!nrefs){return;}
  if (a) {
...
function fmiSetRealDiscrete
    ...
    protected
      ...
      external"C" H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiSetRealDiscrete(
        fmi,
        refs,
        size(refs, 1),
        vals,
        oldVals)
      annotation (Include="
#ifndef H283cd02180511b024b59731032fd3290f8675b29458015644380140623_SetRealDiscrete_C
#define H283cd02180511b024b59731032fd3290f8675b29458015644380140623_SetRealDiscrete_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiSetRealDiscrete(void*m, const int*refs, size_t nrefs, double*vals, double*oldVals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  annotation(__Dymola_doNotLinkSharedObject=true,__Dymola_CriticalRegion = "H283cd02180511b024b59731032fd3290f8675b29", __Dymola_LockExternalObject=true,__Dymola_IdemPotent=true, __Dymola_VectorizedExceptFirst=true);
    ...
    function fmiGetInteger
      ...
      external"C" H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiGetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef H283cd02180511b024b59731032fd3290f8675b29458015644380140623_GetInteger_C
#define H283cd02180511b024b59731032fd3290f8675b29458015644380140623_GetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiGetInteger2(void*m, const int*refs, size_t nrefs, int*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
void H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiGetInteger2(void*m, const int*refs, size_t nrefs, int*vals) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetInteger failed\");
    ...
    protected
      ...
      external"C" H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiSetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        oldVals)
      annotation (Include="
#ifndef H283cd02180511b024b59731032fd3290f8675b29458015644380140623_SetInteger_C
#define H283cd02180511b024b59731032fd3290f8675b29458015644380140623_SetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiSetInteger2(void*m, const int*refs, size_t nrefs, int*vals, int*oldVals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetInteger failed\");
    ...
    function fmiSetIntegerwf
      ...
      external"C" H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiSetInteger2wf(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef H283cd02180511b024b59731032fd3290f8675b29458015644380140623_SetIntegerwf_C
#define H283cd02180511b024b59731032fd3290f8675b29458015644380140623_SetIntegerwf_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiSetInteger2wf(void*m, const int*refs, size_t nrefs, int*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetInteger failed\");
    ...
    function fmiGetBoolean
      ...
      external"C" H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiGetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals)
        annotation (Include="
#ifndef H283cd02180511b024b59731032fd3290f8675b29458015644380140623_GetBoolean_C
#define H283cd02180511b024b59731032fd3290f8675b29458015644380140623_GetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiGetBoolean2(void*m, const int* refs, size_t nr, int* vals) {
  int i;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
void H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiGetBoolean2(void*m, const int* refs, size_t nr, int* vals) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetBoolean failed\");
    ...
    protected
      ...
      external"C" H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiSetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        ...
        oldVals)
        annotation (Include="
#ifndef H283cd02180511b024b59731032fd3290f8675b29458015644380140623_SetBoolean_C
#define H283cd02180511b024b59731032fd3290f8675b29458015644380140623_SetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiSetBoolean2(void*m, const int* refs, size_t nr, const int* vals, int* dummy, int* oldVals) {
  size_t i;
  int j;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetBoolean failed\");
    ...
    function fmiSetString
      ...
      external"C" H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiSetString2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef H283cd02180511b024b59731032fd3290f8675b29458015644380140623_SetString_C
#define H283cd02180511b024b59731032fd3290f8675b29458015644380140623_SetString_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiSetString2(void*m, const int*refs, size_t nrefs,const fmi2String vals[]) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetString failed\");
    ...
    protected
      Boolean dummy[size(refs, 1)];
      external"C" H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiSetBoolean2wf(
        fmi,
        refs,
        size(refs, 1),
        vals,
        dummy)
        annotation (Include="
#ifndef H283cd02180511b024b59731032fd3290f8675b29458015644380140623_SetBooleanwf_C
#define H283cd02180511b024b59731032fd3290f8675b29458015644380140623_SetBooleanwf_C 1
#include \"FMI/fmi2Import.h\"
void H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiSetBoolean2wf(void*m, const int* refs, size_t nr, const int* vals, int* dummy) {
  size_t i;
  int j;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetBoolean failed\");
    ...
    function fmiGetDirectionalDerivative
      ...
      external"C" H283cd02180511b024b59731032fd3290f8675b29458015644380140623_GetDirectionalDerivative2(
        fmi,
        z_refs,
        size(z_refs, 1),
        v_refs,
        ...
        dz)
      annotation (Include="
#ifndef H283cd02180511b024b59731032fd3290f8675b29458015644380140623_GetDirectionalDerivative2_C
#define H283cd02180511b024b59731032fd3290f8675b29458015644380140623_GetDirectionalDerivative2_C 1
#include \"FMI/fmi2Import.h\"
void H283cd02180511b024b59731032fd3290f8675b29458015644380140623_GetDirectionalDerivative2(void*m, const int* zref, size_t nzr, const int* vrefs, size_t nvr, const double *dv, double *dz) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetDirectionalDerivative failed\");
    ...
    function fmiSaveFMUState
      input fmiModel fmi;
      external"C" H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiSaveFMUState2(fmi)
        annotation (Include="
#ifndef H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiSaveFMUState_C
#define H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiSaveFMUState_C 1
#include \"FMI/fmi2Import.h\"
void H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiSaveFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetFMUstate failed\");
    ...
    function fmiRestoreFMUState
      input fmiModel fmi;
      external"C" H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiRestoreFMUState2(fmi)
        annotation (Include="
#ifndef H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiRestoreFMUState_C
#define H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiRestoreFMUState_C 1
#include \"FMI/fmi2Import.h\"
void H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiRestoreFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiSetFMUstate failed\");
    ...
    function fmiSerializeFMUstate
      input fmiModel fmi;
      external"C" H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiSerializeFMUstate2(fmi)
        annotation (Include="
#ifndef H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiSerializeFMUstate_C
#define H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiSerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiSerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
    status = a->dyFmiGetFMUstate(a->m, &a->dyFMUstate);
    ...
    function fmiDeSerializeFMUstate
      input fmiModel fmi;
      external"C" H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiDeSerializeFMUstate2(fmi)
        annotation (Include="
#ifndef H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiDeSerializeFMUstate_C
#define H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiDeSerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiDeSerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
    ...
    function fmiEnterSlaveInitializationMode
      ...
      input Real preAvailable;
      output Real postAvailable = preAvailable;
      external"C" H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiEnterSlaveInitializationMode2(fmi, setTolerance, relativeTolerance, tStart, forceShutDownAtTStop, tStop)
      annotation (Include="
#ifndef H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiEnterSlaveInitializationMode_C
#define H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiEnterSlaveInitializationMode_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiEnterSlaveInitializationMode2(void*m, int setTolerance, double relativeTolerance, double tStart, int forceShutDownAtTStop, double tStop) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"InitializeSlave failed\");
    ...
    function fmiExitSlaveInitializationMode
      ...
      input Real preAvailable;
      output Real postAvailable = preAvailable;
      external"C" H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiExitSlaveInitializationMode2(fmi)
      annotation (Include="
#ifndef H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiExitSlaveInitializationMode_C
#define H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiExitSlaveInitializationMode_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H283cd02180511b024b59731032fd3290f8675b29458015644380140623_fmiExitSlaveInitializationMode2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
initial algorithm
  fmi_Functions.fmiSetReal(fmi, {16777217}, {K0});
  ...
  fmi_idum := 1;
  myTimeStart :=time;
    fmi_Functions.fmiSetReal(fmi, {620756993}, {_vf_start});
    fmi_Functions.fmiSetBoolean(fmi, {620756992}, {_fault_start});
algorithm
assert(fmi_CommunicationStepSize > 0.0,"The parameter fmi_CommunicationStepSize has an invalid value, please set a positive value larger than 0.0");
  when {initial(), sample(fmi_StartTime, fmi_CommunicationStepSize)} then
    if fmi_InputTime then
      fmi_Functions.fmiSetReal(fmi,{620756993}, {_vf_old});
    else
      if fmi_UsePreOnInputSignals then
        fmi_Functions.fmiSetReal(fmi, {620756993}, {pre(vf)});
      else
        fmi_Functions.fmiSetReal(fmi, {620756993}, {vf});
      end if;
    end if;
    if fmi_InputTime then
      fmi_Functions.fmiSetBoolean(fmi,{620756992}, {_fault_old});
    else
      if fmi_UsePreOnInputSignals then
        fmi_Functions.fmiSetBoolean(fmi, {620756992}, {pre(fault)});
      else
        fmi_Functions.fmiSetBoolean(fmi, {620756992}, {fault});
      end if;
    end if;
  ...
  internal.__error_signals_DoStep :=fmi_Functions.fmiGetIntegerScalar(fmi,
        603979779);
  internal.Pgen :=fmi_Functions.fmiGetRealScalar(fmi, 603979780);
  internal.Qgen :=fmi_Functions.fmiGetRealScalar(fmi, 603979781);
  internal.v :=fmi_Functions.fmiGetRealScalar(fmi, 603979782);
  internal.vf0OUT :=fmi_Functions.fmiGetRealScalar(fmi, 603979783);
  internal.w :=fmi_Functions.fmiGetRealScalar(fmi, 603979784);
    end if;
  end when;
...
equation
  ...
  annotation (__Dymola_FMUImportVersion="Dymola 2025x Refresh 1", __Dymola_FMUImportPath="C:/Users/vanfr/Documents/Github/efmi-pss-use-case/Modelica/work/CHILTest/SiL-integration/FMU/H283cd02180511b024b59731032fd3290f8675b29.fmu", __Dymola_FMUImportIncludeAllVariables="false", __Dymola_FMUImportIntegrate="false", __Dymola_FMUResourcePath="Resources/Library/FMU/H283cd02180511b024b59731032fd3290f8675b29",__Dymola_FMUImportDateTime="Thu Nov 13 01:11:45 2025 GMT", experiment(StartTime=0.0, StopTime=20.0, Tolerance=0.0001),
    Icon(graphics={
...
<li>generationTool = Dymola Version 2025x Refresh 1, 2025-04-11 (using Inline integration method Explicit Euler and internal fixed step size 0.0002)</li>
<li>generationDateAndTime = 2025-11-13T01:11:36Z</li>
</ul>
