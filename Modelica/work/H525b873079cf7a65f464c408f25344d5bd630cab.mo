...
package fmi_Functions
    ...
    class fmiModel
      ...
      function constructor "Initialize FMI model"
        ...
        output fmiModel fmi;
        external"C" fmi = H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiInstantiateModel2(instanceName, loggingOn, resourceLocation)
        annotation(Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_Instantiate_C
#define H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_Instantiate_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309Logger(fmi2ComponentEnvironment componentEnvironment, fmi2String instanceName, fmi2Status status,
...
void * H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiInstantiateModel2(const char*instanceName, fmi2Boolean loggingOn, fmi2String resourceLocation) {
  static fmi2CallbackFunctions funcs = {&H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309Logger, &calloc, &free, NULL, NULL};
  ...
  if (res!=0) {
    ...
    res->m=res->dyFmiInstantiate(instanceName, fmi2CoSimulation, \"{d28ab160-a2d7-4938-8e94-319ab830ff9c}\",resourceLocation, &funcs, fmi2False, loggingOn);
  ...
  return res;
      ...
      function destructor "Release storage of FMI model"
          ...
          input fmiModel fmi;
          external"C"
                     H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiFreeModelInstance2(fmi)
          annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_Free_C
#define H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_Free_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiFreeModelInstance2(void*m) {
  ...
  if (a) {
    ...
    external"C" stepOK =H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiDoStep2(fmi, currentTime, stepSize)
      annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_DoStep_C
#define H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_DoStep_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
double H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiDoStep2(void*m, double currentTime, double stepSize) {
  struct dy_fmi2Extended*a=m;
  ...
  if (status!=fmi2OK && status!=fmi2Warning){    ModelicaFormatError(\"The call of fmi2DoStep(%f, %f) failed in FMU\\r\\nNote: setting fmi_loggingOn in the FMU component may produce more information from the FMU.\",currentTime, stepSize);  }  return 1.0;
    ...
    function fmiReset
      ...
      external"C" resetOK = H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiReset2(fmi)
      annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_Reset_C
#define H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_Reset_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
double H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiReset2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiReset failed\");
    ...
    function fmiGetReal
      ...
      external"C" H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiGetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_GetReal_C
#define H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_GetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiGetReal2(void*m, const int*refs, size_t nrefs, double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
void H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiGetReal2(void*m, const int*refs, size_t nrefs, double*vals) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetReal failed\");
    ...
    function fmiSetReal
      ...
      external"C"
                 H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiSetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals)
        annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_SetReal_C
#define H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_SetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiSetReal2(void*m, const int*refs, size_t nrefs, const double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if(!nrefs){return;}
  if (a) {
...
function fmiSetRealDiscrete
    ...
    protected
      ...
      external"C" H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiSetRealDiscrete(
        fmi,
        refs,
        size(refs, 1),
        vals,
        oldVals)
      annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_SetRealDiscrete_C
#define H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_SetRealDiscrete_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiSetRealDiscrete(void*m, const int*refs, size_t nrefs, double*vals, double*oldVals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  annotation(__Dymola_doNotLinkSharedObject=true,__Dymola_CriticalRegion = "H525b873079cf7a65f464c408f25344d5bd630cab", __Dymola_LockExternalObject=true,__Dymola_IdemPotent=true, __Dymola_VectorizedExceptFirst=true);
    ...
    function fmiGetInteger
      ...
      external"C" H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiGetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_GetInteger_C
#define H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_GetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiGetInteger2(void*m, const int*refs, size_t nrefs, int*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
void H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiGetInteger2(void*m, const int*refs, size_t nrefs, int*vals) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetInteger failed\");
    ...
    protected
      ...
      external"C" H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiSetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        oldVals)
      annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_SetInteger_C
#define H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_SetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiSetInteger2(void*m, const int*refs, size_t nrefs, int*vals, int*oldVals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetInteger failed\");
    ...
    function fmiSetIntegerwf
      ...
      external"C" H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiSetInteger2wf(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_SetIntegerwf_C
#define H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_SetIntegerwf_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiSetInteger2wf(void*m, const int*refs, size_t nrefs, int*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetInteger failed\");
    ...
    function fmiGetBoolean
      ...
      external"C" H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiGetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals)
        annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_GetBoolean_C
#define H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_GetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiGetBoolean2(void*m, const int* refs, size_t nr, int* vals) {
  int i;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
void H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiGetBoolean2(void*m, const int* refs, size_t nr, int* vals) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetBoolean failed\");
    ...
    protected
      ...
      external"C" H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiSetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        ...
        oldVals)
        annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_SetBoolean_C
#define H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_SetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiSetBoolean2(void*m, const int* refs, size_t nr, const int* vals, int* dummy, int* oldVals) {
  size_t i;
  int j;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetBoolean failed\");
    ...
    function fmiSetString
      ...
      external"C" H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiSetString2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_SetString_C
#define H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_SetString_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiSetString2(void*m, const int*refs, size_t nrefs,const fmi2String vals[]) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetString failed\");
    ...
    protected
      Boolean dummy[size(refs, 1)];
      external"C" H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiSetBoolean2wf(
        fmi,
        refs,
        size(refs, 1),
        vals,
        dummy)
        annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_SetBooleanwf_C
#define H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_SetBooleanwf_C 1
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiSetBoolean2wf(void*m, const int* refs, size_t nr, const int* vals, int* dummy) {
  size_t i;
  int j;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetBoolean failed\");
    ...
    function fmiGetDirectionalDerivative
      ...
      external"C" H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_GetDirectionalDerivative2(
        fmi,
        z_refs,
        size(z_refs, 1),
        v_refs,
        ...
        dz)
      annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_GetDirectionalDerivative2_C
#define H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_GetDirectionalDerivative2_C 1
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_GetDirectionalDerivative2(void*m, const int* zref, size_t nzr, const int* vrefs, size_t nvr, const double *dv, double *dz) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetDirectionalDerivative failed\");
    ...
    function fmiSaveFMUState
      input fmiModel fmi;
      external"C" H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiSaveFMUState2(fmi)
        annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiSaveFMUState_C
#define H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiSaveFMUState_C 1
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiSaveFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetFMUstate failed\");
    ...
    function fmiRestoreFMUState
      input fmiModel fmi;
      external"C" H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiRestoreFMUState2(fmi)
        annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiRestoreFMUState_C
#define H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiRestoreFMUState_C 1
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiRestoreFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiSetFMUstate failed\");
    ...
    function fmiSerializeFMUstate
      input fmiModel fmi;
      external"C" H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiSerializeFMUstate2(fmi)
        annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiSerializeFMUstate_C
#define H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiSerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiSerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
    status = a->dyFmiGetFMUstate(a->m, &a->dyFMUstate);
    ...
    function fmiDeSerializeFMUstate
      input fmiModel fmi;
      external"C" H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiDeSerializeFMUstate2(fmi)
        annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiDeSerializeFMUstate_C
#define H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiDeSerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiDeSerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
    ...
    function fmiEnterSlaveInitializationMode
      ...
      input Real preAvailable;
      output Real postAvailable = preAvailable;
      external"C" H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiEnterSlaveInitializationMode2(fmi, setTolerance, relativeTolerance, tStart, forceShutDownAtTStop, tStop)
      annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiEnterSlaveInitializationMode_C
#define H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiEnterSlaveInitializationMode_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiEnterSlaveInitializationMode2(void*m, int setTolerance, double relativeTolerance, double tStart, int forceShutDownAtTStop, double tStop) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"InitializeSlave failed\");
    ...
    function fmiExitSlaveInitializationMode
      ...
      input Real preAvailable;
      output Real postAvailable = preAvailable;
      external"C" H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiExitSlaveInitializationMode2(fmi)
      annotation (Include="
#ifndef H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiExitSlaveInitializationMode_C
#define H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiExitSlaveInitializationMode_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H525b873079cf7a65f464c408f25344d5bd630cab281602749388943198309_fmiExitSlaveInitializationMode2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
equation
  ...
  annotation (__Dymola_FMUImportVersion="Dymola 2025x Refresh 1", __Dymola_FMUImportPath="C:/Users/vanfr/Documents/Github/efmi-pss-use-case/Modelica/work/efmuPSS/SiL-integration/FMU/H525b873079cf7a65f464c408f25344d5bd630cab.fmu", __Dymola_FMUImportIncludeAllVariables="false", __Dymola_FMUImportIntegrate="false", __Dymola_FMUResourcePath="Resources/Library/FMU/H525b873079cf7a65f464c408f25344d5bd630cab",__Dymola_FMUImportDateTime="Mon Nov 3 21:57:52 2025 GMT", experiment(StartTime=0.0, StopTime=1.0, Tolerance=0.0001),
    Icon(graphics={
...
<li>generationDateAndTime = 2025-11-03T21:57:43Z</li>
</ul>
