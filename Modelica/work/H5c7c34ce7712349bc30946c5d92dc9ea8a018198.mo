within ;
model H5c7c34ce7712349bc30946c5d92dc9ea8a018198
  "Stub for eFMU-based co-simulation of
     ...
     as configured by eFMU generation configuration
       [PSSDesign.Components.PSSTypeII4eFMIwHPFilter_eFMU]
     Generated by Dymola on 2026-03-03T10:26:15Z."
extends fmuIcon;
...
encapsulated package importedFMUTypes
  ...
  type 'PSSTypeII4eFMIwHPF_eFMU_SiL_Support\'_ProductionCodes' = enumeration(Mockup "non-functional mockup",
        PCode_SPE_cb4a8a449b4ada864625ee5a4355578a3aaf08ed,
        PCode_SPE_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c);
constant Integer[3] 'PSSTypeII4eFMIwHPF_eFMU_SiL_Support\'_ProductionCodes_values' = {1, 2, 3};
...
public
  parameter String fmi_instanceName="H5c7c34ce7712349bc30946c5d92dc9ea8a018198"
  ...
  parameter String fmi_resourceLocation="file:///"+ModelicaServices.ExternalReferences.loadResource("modelica://H5c7c34ce7712349bc30946c5d92dc9ea8a018198/Resources/Library/FMU/H5c7c34ce7712349bc30946c5d92dc9ea8a018198/resources")
...
package fmi_Functions
    ...
    class fmiModel
      ...
      function constructor "Initialize FMI model"
        ...
        output fmiModel fmi;
        external"C" fmi = H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiInstantiateModel2(instanceName, loggingOn, resourceLocation)
        annotation(Include="
#ifndef H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_Instantiate_C
#define H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_Instantiate_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076Logger(fmi2ComponentEnvironment componentEnvironment, fmi2String instanceName, fmi2Status status,
...
void * H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiInstantiateModel2(const char*instanceName, fmi2Boolean loggingOn, fmi2String resourceLocation) {
  static fmi2CallbackFunctions funcs = {&H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076Logger, &calloc, &free, NULL, NULL};
  struct dy_fmi2Extended* res;
  res = calloc(1, sizeof(struct dy_fmi2Extended));
  if (res!=0) {
#ifdef _WIN32
    if (!(res->hInst=LoadLibraryW(L\"H5c7c34ce7712349bc30946c5d92dc9ea8a018198.dll\"))) {
      ModelicaError(\"Loading of FMU dynamic link library (H5c7c34ce7712349bc30946c5d92dc9ea8a018198.dll) failed!\");
#else
    if (!(res->hInst=LoadLibrary(\"H5c7c34ce7712349bc30946c5d92dc9ea8a018198.so\"))) {
      ModelicaError(\"Loading of FMU dynamic link library (H5c7c34ce7712349bc30946c5d92dc9ea8a018198.so) failed!\");
#endif
      return 0;
    }
    ...
    res->m=res->dyFmiInstantiate(instanceName, fmi2CoSimulation, \"{e5d28785-3f9c-4832-bfe6-25dcbdce0b76}\",resourceLocation, &funcs, fmi2False, loggingOn);
  ...
  return res;
...
#endif", Library="H5c7c34ce7712349bc30946c5d92dc9ea8a018198", LibraryDirectory="modelica://H5c7c34ce7712349bc30946c5d92dc9ea8a018198/Resources/Library/FMU/H5c7c34ce7712349bc30946c5d92dc9ea8a018198/binaries");
        annotation (__Dymola_doNotLinkSharedObject=true,
            __Dymola_CriticalRegion="H5c7c34ce7712349bc30946c5d92dc9ea8a018198");
      end constructor;
      ...
      function destructor "Release storage of FMI model"
          ...
          input fmiModel fmi;
          external"C"
                     H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiFreeModelInstance2(fmi)
          annotation (Include="
#ifndef H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_Free_C
#define H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_Free_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiFreeModelInstance2(void*m) {
  ...
  if (a) {
...
#endif",       Library="H5c7c34ce7712349bc30946c5d92dc9ea8a018198", LibraryDirectory="modelica://H5c7c34ce7712349bc30946c5d92dc9ea8a018198/Resources/Library/FMU/H5c7c34ce7712349bc30946c5d92dc9ea8a018198/binaries");
        annotation(__Dymola_doNotLinkSharedObject=true,__Dymola_CriticalRegion = "H5c7c34ce7712349bc30946c5d92dc9ea8a018198");
      end destructor;
    ...
    input Real stepSize;
    external"C" H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiDoStep2(fmi, currentTime, stepSize)
      annotation (Include="
#ifndef H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_DoStep_C
#define H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_DoStep_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
double H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiDoStep2(void*m, double currentTime, double stepSize) {
  struct dy_fmi2Extended*a=m;
  ...
  if (status!=fmi2OK && status!=fmi2Warning){    ModelicaFormatError(\"The call of fmi2DoStep(%f, %f) failed in FMU\\r\\nNote: setting fmi_loggingOn in the FMU component may produce more information from the FMU.\",currentTime, stepSize);  }  return 1.0;
    ...
    external"C" H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiExitModelInitializationMode2(fmi)
    annotation (Include="
#ifndef H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiExitModelInitializationMode_C
#define H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiExitModelInitializationMode_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiExitModelInitializationMode2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  return;
    ...
    function fmi2Reset
      input fmiModel fmi;
      external"C"
                 H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiReset2(fmi)
      annotation (Include="
#ifndef H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_Reset_C
#define H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_Reset_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiReset2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiReset failed\");
    ...
    function fmi2GetReal
      ...
      external"C" H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiGetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_GetReal_C
#define H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_GetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiGetReal2(void*m, const int*refs, size_t nrefs, double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetReal failed\");
    ...
    function fmi2SetReal
      ...
      external"C"
                 H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiSetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals)
        annotation (Include="
#ifndef H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_SetReal_C
#define H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_SetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiSetReal2(void*m, const int*refs, size_t nrefs, const double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if(!nrefs){return;}
  if (a) {
...
function fmi2SetRealDiscrete
    ...
    protected
      ...
      external"C" H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiSetRealDiscrete(
        fmi,
        refs,
        size(refs, 1),
        vals,
        oldVals)
      annotation (Include="
#ifndef H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_SetRealDiscrete_C
#define H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_SetRealDiscrete_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiSetRealDiscrete(void*m, const int*refs, size_t nrefs, double*vals, double*oldVals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
...
#endif", Library="H5c7c34ce7712349bc30946c5d92dc9ea8a018198", LibraryDirectory="modelica://H5c7c34ce7712349bc30946c5d92dc9ea8a018198/Resources/Library/FMU/H5c7c34ce7712349bc30946c5d92dc9ea8a018198/binaries");
  annotation(__Dymola_doNotLinkSharedObject=true,__Dymola_CriticalRegion = "H5c7c34ce7712349bc30946c5d92dc9ea8a018198", __Dymola_LockExternalObject=true,__Dymola_IdemPotent=true, __Dymola_VectorizedExceptFirst=true);
    ...
    function fmi2GetInteger
      ...
      external"C" H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiGetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_GetInteger_C
#define H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_GetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiGetInteger2(void*m, const int*refs, size_t nrefs, int*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetInteger failed\");
    ...
    protected
      ...
      external"C" H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiSetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        oldVals)
      annotation (Include="
#ifndef H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_SetInteger_C
#define H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_SetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiSetInteger2(void*m, const int*refs, size_t nrefs, int*vals, int*oldVals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetInteger failed\");
    ...
    function fmi2GetBoolean
      ...
      external"C" H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiGetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals)
        annotation (Include="
#ifndef H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_GetBoolean_C
#define H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_GetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiGetBoolean2(void*m, const int* refs, size_t nr, int* vals) {
  int i;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetBoolean failed\");
    ...
    protected
      ...
      external"C" H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiSetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        ...
        oldVals)
        annotation (Include="
#ifndef H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_SetBoolean_C
#define H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_SetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiSetBoolean2(void*m, const int* refs, size_t nr, const int* vals, int* dummy, int* oldVals) {
  size_t i;
  int j;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetBoolean failed\");
    ...
    function fmi2SetString
      ...
      external"C" H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiSetString2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_SetString_C
#define H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_SetString_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiSetString2(void*m, const int*refs, size_t nrefs,const fmi2String vals[]) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetString failed\");
    ...
    function fmi2GetDirectionalDerivative
      ...
      external"C" H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_GetDirectionalDerivative2(
        fmi,
        z_refs,
        size(z_refs, 1),
        v_refs,
        ...
        dz)
      annotation (Include="
#ifndef H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_GetDirectionalDerivative2_C
#define H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_GetDirectionalDerivative2_C 1
#include \"FMI/fmi2Import.h\"
void H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_GetDirectionalDerivative2(void*m, const int* zref, size_t nzr, const int* vrefs, size_t nvr, const double *dv, double *dz) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetDirectionalDerivative failed\");
    ...
    function fmi2SaveFMUState
      input fmiModel fmi;
      external"C" H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiSaveFMUState2(fmi)
        annotation (Include="
#ifndef H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiSaveFMUState_C
#define H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiSaveFMUState_C 1
#include \"FMI/fmi2Import.h\"
void H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiSaveFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetFMUstate failed\");
    ...
    function fmi2RestoreFMUState
      input fmiModel fmi;
      external"C" H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiRestoreFMUState2(fmi)
        annotation (Include="
#ifndef H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiRestoreFMUState_C
#define H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiRestoreFMUState_C 1
#include \"FMI/fmi2Import.h\"
void H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiRestoreFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiSetFMUstate failed\");
    ...
    function fmi2SerializeFMUstate
      input fmiModel fmi;
      external"C" H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmi2SerializeFMUstate2(fmi)
        annotation (Include="
#ifndef H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmi2SerializeFMUstate_C
#define H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmi2SerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmi2SerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
    status = a->dyFmiGetFMUstate(a->m, &a->dyFMUstate);
    ...
    function fmi2DeSerializeFMUstate
      input fmiModel fmi;
      external"C" H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmi2DeSerializeFMUstate2(fmi)
        annotation (Include="
#ifndef H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmi2DeSerializeFMUstate_C
#define H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmi2DeSerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmi2DeSerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
    ...
    function fmi2EnterCSInitializationMode
      ...
      external"C" H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiEnterSlaveInitializationMode2(fmi, setTolerance, relativeTolerance, tStart, forceShutDownAtTStop, tStop)
      annotation (Include="
#ifndef H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiEnterSlaveInitializationMode_C
#define H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiEnterSlaveInitializationMode_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H5c7c34ce7712349bc30946c5d92dc9ea8a018198528785394832625076_fmiEnterSlaveInitializationMode2(void*m, int setTolerance, double relativeTolerance, double tStart, int forceShutDownAtTStop, double tStop) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
equation
  ...
  annotation (__Dymola_FMUImportVersion="Dymola 2026x Refresh 1 Beta 1", __Dymola_FMUImportPath="E:/modelica-libraries/efmi-pss-use-case/Modelica/work/PSSTypeII4eFMIwHPF/SiL-integration/FMU/H5c7c34ce7712349bc30946c5d92dc9ea8a018198.fmu", __Dymola_FMUImportIncludeAllVariables="false", __Dymola_FMUImportIntegrate="false", __Dymola_FMUResourcePath="Resources/Library/FMU/H5c7c34ce7712349bc30946c5d92dc9ea8a018198",__Dymola_FMUImportDateTime="Tue Mar 3 10:26:27 2026 GMT", experiment(StartTime=0.0, StopTime=1.0, Tolerance=0.0001),
    Icon(graphics={
...
<li>modelName = H5c7c34ce7712349bc30946c5d92dc9ea8a018198</li>
...
<li>generationDateAndTime = 2026-03-03T10:26:19Z</li>
</ul>
...
end H5c7c34ce7712349bc30946c5d92dc9ea8a018198;
