within ;
model H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5
  "Stub for eFMU-based co-simulation of
     ...
     as configured by eFMU generation configuration
       [OpenIPSL_CHIL.RTS.CHIL.eFMUs.Grid4CHIL_IOplus]
     Generated by Dymola on 2026-03-26T03:11:39Z."
extends fmuIcon;

// Model automatically generated by Dymola from FMI model description
public
encapsulated package importedFMUTypes
  type 'Grid4CHIL_IOplus_eFMU_SiL_Support\'___TuningConnectors_K0' = Real;
  type 'Grid4CHIL_IOplus_eFMU_SiL_Support\'___TuningConnectors_woffset' = Real;
  type 'Grid4CHIL_IOplus_eFMU_SiL_Support\'___TuningConnectors_wscale' = Real;
  ...
  type 'Grid4CHIL_IOplus_eFMU_SiL_Support\'_ProductionCodes' = enumeration(Mockup "non-functional mockup",
        PCode_SPE_cb4a8a449b4ada864625ee5a4355578a3aaf08ed,
        PCode_SPE_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c);
constant Integer[3] 'Grid4CHIL_IOplus_eFMU_SiL_Support\'_ProductionCodes_values' = {1, 2, 3};
end importedFMUTypes;
  parameter importedFMUTypes.OpenIPSL_Types_PerUnit K0 = 30 "regulator gain";
  parameter Real woffset = 1.0 "Speed output offset";
  parameter Real wscale = 100.0 "Speed output scaling";
  protected
  record _Clocks_rec
    protected
...
public
  ...
  annotation (Dialog( group="Start values for inputs "));
protected
  Boolean _faultL1_old(start = _faultL1_start);
public
  Modelica.Blocks.Interfaces.BooleanInput faultL1(start = _faultL1_start) "Fault input sigal, default false = fault inactive"
  annotation (Placement(transformation(extent={{-124,14},{-84,54}})));
  parameter Boolean _faultL2_start = false
  annotation (Dialog( group="Start values for inputs "));
protected
  Boolean _faultL2_old(start = _faultL2_start);
public
  Modelica.Blocks.Interfaces.BooleanInput faultL2(start = _faultL2_start) "Fault input sigal, default false = fault inactive"
  annotation (Placement(transformation(extent={{-124,-20},{-84,20}})));
  parameter Real _uPLoad_start = 0.0
  annotation (Dialog( group="Start values for inputs "));
protected
  Real _uPLoad_old(start = _uPLoad_start);
public
  Modelica.Blocks.Interfaces.RealInput uPLoad(start = _uPLoad_start) "Input to modulate the active power of the load"
...
public
  parameter String fmi_instanceName="H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5"
  ...
  annotation (Dialog(tab="FMI", group="Step time"));
  parameter Real fmi_CommunicationStepSize(unit = "s") = 0.0002
  annotation (Dialog(tab="FMI", group="Step time"));
  ...
  parameter String fmi_resourceLocation="file:///"+ModelicaServices.ExternalReferences.loadResource("modelica://H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5/Resources/Library/FMU/H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5/resources")
...
protected
  ...
  parameter String fmi_uNames[2] ={"uPLoad", "vf"};
  parameter Integer fmi_uVrs[2] ={620756995, 620756996};
...
package fmi_Functions
    ...
    class fmiModel
      ...
      function constructor "Initialize FMI model"
        ...
        output fmiModel fmi;
        external"C" fmi = H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiInstantiateModel2(instanceName, loggingOn, resourceLocation)
        annotation(Include="
#ifndef H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_Instantiate_C
#define H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_Instantiate_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735Logger(fmi2ComponentEnvironment componentEnvironment, fmi2String instanceName, fmi2Status status,
...
void * H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiInstantiateModel2(const char*instanceName, fmi2Boolean loggingOn, fmi2String resourceLocation) {
  static fmi2CallbackFunctions funcs = {&H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735Logger, &calloc, &free, NULL, NULL};
  struct dy_fmi2Extended* res;
  res = calloc(1, sizeof(struct dy_fmi2Extended));
  if (res!=0) {
#ifdef _WIN32
    if (!(res->hInst=LoadLibraryW(L\"H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5.dll\"))) {
      ModelicaError(\"Loading of FMU dynamic link library (H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5.dll) failed!\");
#else
    if (!(res->hInst=LoadLibrary(\"H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5.so\"))) {
      ModelicaError(\"Loading of FMU dynamic link library (H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5.so) failed!\");
#endif
      return 0;
    }
    ...
    res->m=res->dyFmiInstantiate(instanceName, fmi2CoSimulation, \"{b10bf1d2-8328-42ba-9060-1c90994773d5}\",resourceLocation, &funcs, fmi2False, loggingOn);
  ...
  return res;
...
#endif", Library="H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5", LibraryDirectory="modelica://H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5/Resources/Library/FMU/H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5/binaries");
        annotation (__Dymola_doNotLinkSharedObject=true,
            __Dymola_CriticalRegion="H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5");
      end constructor;
      ...
      function destructor "Release storage of FMI model"
          ...
          input fmiModel fmi;
          external"C"
                     H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiFreeModelInstance2(fmi)
          annotation (Include="
#ifndef H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_Free_C
#define H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_Free_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiFreeModelInstance2(void*m) {
  ...
  if (a) {
...
#endif",       Library="H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5", LibraryDirectory="modelica://H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5/Resources/Library/FMU/H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5/binaries");
        annotation(__Dymola_doNotLinkSharedObject=true,__Dymola_CriticalRegion = "H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5");
      end destructor;
    ...
    input Real stepSize;
    external"C" H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiDoStep2(fmi, currentTime, stepSize)
      annotation (Include="
#ifndef H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_DoStep_C
#define H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_DoStep_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
double H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiDoStep2(void*m, double currentTime, double stepSize) {
  struct dy_fmi2Extended*a=m;
  ...
  if (status!=fmi2OK && status!=fmi2Warning){    ModelicaFormatError(\"The call of fmi2DoStep(%f, %f) failed in FMU\\r\\nNote: setting fmi_loggingOn in the FMU component may produce more information from the FMU.\",currentTime, stepSize);  }  return 1.0;
    ...
    external"C" H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiExitModelInitializationMode2(fmi)
    annotation (Include="
#ifndef H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiExitModelInitializationMode_C
#define H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiExitModelInitializationMode_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiExitModelInitializationMode2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  return;
    ...
    function fmi2Reset
      input fmiModel fmi;
      external"C"
                 H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiReset2(fmi)
      annotation (Include="
#ifndef H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_Reset_C
#define H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_Reset_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiReset2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiReset failed\");
    ...
    function fmi2GetReal
      ...
      external"C" H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiGetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_GetReal_C
#define H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_GetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiGetReal2(void*m, const int*refs, size_t nrefs, double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetReal failed\");
    ...
    function fmi2SetReal
      ...
      external"C"
                 H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiSetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals)
        annotation (Include="
#ifndef H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_SetReal_C
#define H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_SetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiSetReal2(void*m, const int*refs, size_t nrefs, const double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if(!nrefs){return;}
  if (a) {
...
function fmi2SetRealDiscrete
    ...
    protected
      ...
      external"C" H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiSetRealDiscrete(
        fmi,
        refs,
        size(refs, 1),
        vals,
        oldVals)
      annotation (Include="
#ifndef H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_SetRealDiscrete_C
#define H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_SetRealDiscrete_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiSetRealDiscrete(void*m, const int*refs, size_t nrefs, double*vals, double*oldVals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
...
#endif", Library="H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5", LibraryDirectory="modelica://H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5/Resources/Library/FMU/H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5/binaries");
  annotation(__Dymola_doNotLinkSharedObject=true,__Dymola_CriticalRegion = "H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5", __Dymola_LockExternalObject=true,__Dymola_IdemPotent=true, __Dymola_VectorizedExceptFirst=true);
    ...
    function fmi2GetInteger
      ...
      external"C" H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiGetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_GetInteger_C
#define H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_GetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiGetInteger2(void*m, const int*refs, size_t nrefs, int*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetInteger failed\");
    ...
    protected
      ...
      external"C" H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiSetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        oldVals)
      annotation (Include="
#ifndef H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_SetInteger_C
#define H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_SetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiSetInteger2(void*m, const int*refs, size_t nrefs, int*vals, int*oldVals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetInteger failed\");
    ...
    function fmi2GetBoolean
      ...
      external"C" H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiGetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals)
        annotation (Include="
#ifndef H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_GetBoolean_C
#define H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_GetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiGetBoolean2(void*m, const int* refs, size_t nr, int* vals) {
  int i;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetBoolean failed\");
    ...
    protected
      ...
      external"C" H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiSetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        ...
        oldVals)
        annotation (Include="
#ifndef H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_SetBoolean_C
#define H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_SetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiSetBoolean2(void*m, const int* refs, size_t nr, const int* vals, int* dummy, int* oldVals) {
  size_t i;
  int j;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetBoolean failed\");
    ...
    function fmi2SetString
      ...
      external"C" H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiSetString2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_SetString_C
#define H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_SetString_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiSetString2(void*m, const int*refs, size_t nrefs,const fmi2String vals[]) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetString failed\");
    ...
    function fmi2GetDirectionalDerivative
      ...
      external"C" H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_GetDirectionalDerivative2(
        fmi,
        z_refs,
        size(z_refs, 1),
        v_refs,
        ...
        dz)
      annotation (Include="
#ifndef H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_GetDirectionalDerivative2_C
#define H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_GetDirectionalDerivative2_C 1
#include \"FMI/fmi2Import.h\"
void H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_GetDirectionalDerivative2(void*m, const int* zref, size_t nzr, const int* vrefs, size_t nvr, const double *dv, double *dz) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetDirectionalDerivative failed\");
    ...
    function fmi2SaveFMUState
      input fmiModel fmi;
      external"C" H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiSaveFMUState2(fmi)
        annotation (Include="
#ifndef H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiSaveFMUState_C
#define H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiSaveFMUState_C 1
#include \"FMI/fmi2Import.h\"
void H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiSaveFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetFMUstate failed\");
    ...
    function fmi2RestoreFMUState
      input fmiModel fmi;
      external"C" H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiRestoreFMUState2(fmi)
        annotation (Include="
#ifndef H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiRestoreFMUState_C
#define H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiRestoreFMUState_C 1
#include \"FMI/fmi2Import.h\"
void H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiRestoreFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiSetFMUstate failed\");
    ...
    function fmi2SerializeFMUstate
      input fmiModel fmi;
      external"C" H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmi2SerializeFMUstate2(fmi)
        annotation (Include="
#ifndef H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmi2SerializeFMUstate_C
#define H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmi2SerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmi2SerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
    status = a->dyFmiGetFMUstate(a->m, &a->dyFMUstate);
    ...
    function fmi2DeSerializeFMUstate
      input fmiModel fmi;
      external"C" H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmi2DeSerializeFMUstate2(fmi)
        annotation (Include="
#ifndef H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmi2DeSerializeFMUstate_C
#define H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmi2DeSerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmi2DeSerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
    ...
    function fmi2EnterCSInitializationMode
      ...
      external"C" H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiEnterSlaveInitializationMode2(fmi, setTolerance, relativeTolerance, tStart, forceShutDownAtTStop, tStop)
      annotation (Include="
#ifndef H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiEnterSlaveInitializationMode_C
#define H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiEnterSlaveInitializationMode_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5101283284290601909947735_fmiEnterSlaveInitializationMode2(void*m, int setTolerance, double relativeTolerance, double tStart, int forceShutDownAtTStop, double tStop) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
initial algorithm
  fmi_Functions.fmi2SetReal(fmi, {16777217, 16777218, 16777219}, {K0, woffset, wscale});
  ...
  fmi_idum := 1;
  myTimeStart :=time;
    fmi_Functions.fmi2SetReal(fmi, {620756995, 620756996}, {_uPLoad_start, _vf_start});
    fmi_Functions.fmi2SetBoolean(fmi, {620756992, 620756993, 620756994}, {_fault_start, _faultL1_start, _faultL2_start});
algorithm
assert(fmi_CommunicationStepSize > 0.0,"The parameter fmi_CommunicationStepSize has an invalid value, please set a positive value larger than 0.0");
  when {initial(), sample(fmi_StartTime, fmi_CommunicationStepSize)} then
    if fmi_InputTime then
      fmi_Functions.fmi2SetReal(fmi,{620756995, 620756996}, {_uPLoad_old, _vf_old});
    else
      if fmi_UsePreOnInputSignals then
        fmi_Functions.fmi2SetReal(fmi, {620756995, 620756996}, {pre(uPLoad), pre(vf)});
      else
        fmi_Functions.fmi2SetReal(fmi, {620756995, 620756996}, {uPLoad, vf});
      end if;
    end if;
    if fmi_InputTime then
      fmi_Functions.fmi2SetBoolean(fmi,{620756992, 620756993, 620756994}, {_fault_old, _faultL1_old, _faultL2_old});
    else
      if fmi_UsePreOnInputSignals then
        fmi_Functions.fmi2SetBoolean(fmi, {620756992, 620756993, 620756994}, {pre(fault), pre(faultL1), pre(faultL2)});
      else
        fmi_Functions.fmi2SetBoolean(fmi, {620756992, 620756993, 620756994}, {fault, faultL1, faultL2});
      end if;
    end if;
...
equation
  ...
  annotation (__Dymola_FMUImportVersion="Dymola 2026x Refresh 1 Beta 1", __Dymola_FMUImportPath="C:/dev/efmi-pss-use-case/Modelica/work/Grid4CHIL_IOplus/SiL-integration/FMU/H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5.fmu", __Dymola_FMUImportIncludeAllVariables="false", __Dymola_FMUImportIntegrate="false", __Dymola_FMUResourcePath="Resources/Library/FMU/H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5",__Dymola_FMUImportDateTime="Thu Mar 26 03:11:49 2026 GMT", experiment(StartTime=0.0, StopTime=1.0, Tolerance=0.0001),
    Icon(graphics={
...
<li>modelName = H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5</li>
<li>generationTool = Dymola Version 2026x Refresh 1 Beta 1, 2026-02-27 (using Inline integration method Explicit Euler and internal fixed step size 0.0002)</li>
<li>generationDateAndTime = 2026-03-26T03:11:40Z</li>
</ul>
...
end H96e4298bd9675fbbcb46b0c1f68b039a5627ebc5;
