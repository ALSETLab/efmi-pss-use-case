...
model Ha7cb37a433f18e8802317f9a0017ef7e53a577cd
  "Stub for eFMU-based co-simulation of
     ...
     Generated by Dymola on 2026-03-26T03:06:19Z."
extends fmuIcon;
...
encapsulated package importedFMUTypes
  ...
  type 'PSSTypeIIHPFilter_eFMU_SiL_Support\'___TuningConnectors_wscale' = Real;
...
package fmi_Functions
    ...
    class fmiModel
      ...
      function constructor "Initialize FMI model"
        ...
        output fmiModel fmi;
        external"C" fmi = Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiInstantiateModel2(instanceName, loggingOn, resourceLocation)
        annotation(Include="
#ifndef Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_Instantiate_C
#define Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_Instantiate_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961Logger(fmi2ComponentEnvironment componentEnvironment, fmi2String instanceName, fmi2Status status,
...
void * Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiInstantiateModel2(const char*instanceName, fmi2Boolean loggingOn, fmi2String resourceLocation) {
  static fmi2CallbackFunctions funcs = {&Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961Logger, &calloc, &free, NULL, NULL};
  ...
  if (res!=0) {
    ...
    res->m=res->dyFmiInstantiate(instanceName, fmi2CoSimulation, \"{c45e592d-c2c6-44b5-a39f-68b92b29db61}\",resourceLocation, &funcs, fmi2False, loggingOn);
  ...
  return res;
      ...
      function destructor "Release storage of FMI model"
          ...
          input fmiModel fmi;
          external"C"
                     Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiFreeModelInstance2(fmi)
          annotation (Include="
#ifndef Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_Free_C
#define Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_Free_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiFreeModelInstance2(void*m) {
  ...
  if (a) {
    ...
    input Real stepSize;
    external"C" Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiDoStep2(fmi, currentTime, stepSize)
      annotation (Include="
#ifndef Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_DoStep_C
#define Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_DoStep_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
double Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiDoStep2(void*m, double currentTime, double stepSize) {
  struct dy_fmi2Extended*a=m;
  ...
  if (status!=fmi2OK && status!=fmi2Warning){    ModelicaFormatError(\"The call of fmi2DoStep(%f, %f) failed in FMU\\r\\nNote: setting fmi_loggingOn in the FMU component may produce more information from the FMU.\",currentTime, stepSize);  }  return 1.0;
    ...
    external"C" Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiExitModelInitializationMode2(fmi)
    annotation (Include="
#ifndef Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiExitModelInitializationMode_C
#define Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiExitModelInitializationMode_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiExitModelInitializationMode2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  return;
    ...
    function fmi2Reset
      input fmiModel fmi;
      external"C"
                 Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiReset2(fmi)
      annotation (Include="
#ifndef Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_Reset_C
#define Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_Reset_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiReset2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiReset failed\");
    ...
    function fmi2GetReal
      ...
      external"C" Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiGetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_GetReal_C
#define Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_GetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiGetReal2(void*m, const int*refs, size_t nrefs, double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetReal failed\");
    ...
    function fmi2SetReal
      ...
      external"C"
                 Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiSetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals)
        annotation (Include="
#ifndef Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_SetReal_C
#define Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_SetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiSetReal2(void*m, const int*refs, size_t nrefs, const double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if(!nrefs){return;}
  if (a) {
...
function fmi2SetRealDiscrete
    ...
    protected
      ...
      external"C" Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiSetRealDiscrete(
        fmi,
        refs,
        size(refs, 1),
        vals,
        oldVals)
      annotation (Include="
#ifndef Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_SetRealDiscrete_C
#define Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_SetRealDiscrete_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiSetRealDiscrete(void*m, const int*refs, size_t nrefs, double*vals, double*oldVals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  annotation(__Dymola_doNotLinkSharedObject=true,__Dymola_CriticalRegion = "Ha7cb37a433f18e8802317f9a0017ef7e53a577cd", __Dymola_LockExternalObject=true,__Dymola_IdemPotent=true, __Dymola_VectorizedExceptFirst=true);
    ...
    function fmi2GetInteger
      ...
      external"C" Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiGetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_GetInteger_C
#define Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_GetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiGetInteger2(void*m, const int*refs, size_t nrefs, int*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetInteger failed\");
    ...
    protected
      ...
      external"C" Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiSetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        oldVals)
      annotation (Include="
#ifndef Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_SetInteger_C
#define Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_SetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiSetInteger2(void*m, const int*refs, size_t nrefs, int*vals, int*oldVals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetInteger failed\");
    ...
    function fmi2GetBoolean
      ...
      external"C" Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiGetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals)
        annotation (Include="
#ifndef Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_GetBoolean_C
#define Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_GetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiGetBoolean2(void*m, const int* refs, size_t nr, int* vals) {
  int i;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetBoolean failed\");
    ...
    protected
      ...
      external"C" Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiSetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        ...
        oldVals)
        annotation (Include="
#ifndef Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_SetBoolean_C
#define Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_SetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiSetBoolean2(void*m, const int* refs, size_t nr, const int* vals, int* dummy, int* oldVals) {
  size_t i;
  int j;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetBoolean failed\");
    ...
    function fmi2SetString
      ...
      external"C" Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiSetString2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_SetString_C
#define Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_SetString_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiSetString2(void*m, const int*refs, size_t nrefs,const fmi2String vals[]) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetString failed\");
    ...
    function fmi2GetDirectionalDerivative
      ...
      external"C" Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_GetDirectionalDerivative2(
        fmi,
        z_refs,
        size(z_refs, 1),
        v_refs,
        ...
        dz)
      annotation (Include="
#ifndef Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_GetDirectionalDerivative2_C
#define Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_GetDirectionalDerivative2_C 1
#include \"FMI/fmi2Import.h\"
void Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_GetDirectionalDerivative2(void*m, const int* zref, size_t nzr, const int* vrefs, size_t nvr, const double *dv, double *dz) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetDirectionalDerivative failed\");
    ...
    function fmi2SaveFMUState
      input fmiModel fmi;
      external"C" Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiSaveFMUState2(fmi)
        annotation (Include="
#ifndef Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiSaveFMUState_C
#define Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiSaveFMUState_C 1
#include \"FMI/fmi2Import.h\"
void Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiSaveFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetFMUstate failed\");
    ...
    function fmi2RestoreFMUState
      input fmiModel fmi;
      external"C" Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiRestoreFMUState2(fmi)
        annotation (Include="
#ifndef Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiRestoreFMUState_C
#define Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiRestoreFMUState_C 1
#include \"FMI/fmi2Import.h\"
void Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiRestoreFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiSetFMUstate failed\");
    ...
    function fmi2SerializeFMUstate
      input fmiModel fmi;
      external"C" Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmi2SerializeFMUstate2(fmi)
        annotation (Include="
#ifndef Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmi2SerializeFMUstate_C
#define Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmi2SerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmi2SerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
    status = a->dyFmiGetFMUstate(a->m, &a->dyFMUstate);
    ...
    function fmi2DeSerializeFMUstate
      input fmiModel fmi;
      external"C" Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmi2DeSerializeFMUstate2(fmi)
        annotation (Include="
#ifndef Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmi2DeSerializeFMUstate_C
#define Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmi2DeSerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmi2DeSerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
    ...
    function fmi2EnterCSInitializationMode
      ...
      external"C" Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiEnterSlaveInitializationMode2(fmi, setTolerance, relativeTolerance, tStart, forceShutDownAtTStop, tStop)
      annotation (Include="
#ifndef Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiEnterSlaveInitializationMode_C
#define Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiEnterSlaveInitializationMode_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Ha7cb37a433f18e8802317f9a0017ef7e53a577cd45592264453968922961_fmiEnterSlaveInitializationMode2(void*m, int setTolerance, double relativeTolerance, double tStart, int forceShutDownAtTStop, double tStop) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
initial algorithm
  fmi_Functions.fmi2SetReal(fmi, {16777217, 16777218, 16777219, 16777220, 16777221, 16777222, 16777223, 16777224, 16777225, 16777226, 16777227}, {Kw, T1, T2, T3, T4, freqLow, kLPF, vSI_start, vsmax, vsmin, wscale});
...
<li>generationDateAndTime = 2026-03-26T03:06:20Z</li>
</ul>
