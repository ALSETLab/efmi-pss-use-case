...
model Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3
  "Stub for eFMU-based co-simulation of
     ...
     Generated by Dymola on 2025-11-03T22:18:17Z."
extends fmuIcon;
...
public
  ...
  parameter Real fmi_StopTime = 15.0
  annotation (Dialog(tab="FMI", group="Step time"));
...
package fmi_Functions
    ...
    class fmiModel
      ...
      function constructor "Initialize FMI model"
        ...
        output fmiModel fmi;
        external"C" fmi = Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiInstantiateModel2(instanceName, loggingOn, resourceLocation)
        annotation(Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_Instantiate_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_Instantiate_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507Logger(fmi2ComponentEnvironment componentEnvironment, fmi2String instanceName, fmi2Status status,
...
void * Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiInstantiateModel2(const char*instanceName, fmi2Boolean loggingOn, fmi2String resourceLocation) {
  static fmi2CallbackFunctions funcs = {&Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507Logger, &calloc, &free, NULL, NULL};
  ...
  if (res!=0) {
    ...
    res->m=res->dyFmiInstantiate(instanceName, fmi2CoSimulation, \"{bf313be1-c4bb-46de-b6af-bd62347050a7}\",resourceLocation, &funcs, fmi2False, loggingOn);
  ...
  return res;
      ...
      function destructor "Release storage of FMI model"
          ...
          input fmiModel fmi;
          external"C"
                     Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiFreeModelInstance2(fmi)
          annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_Free_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_Free_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiFreeModelInstance2(void*m) {
  ...
  if (a) {
    ...
    external"C" stepOK =Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiDoStep2(fmi, currentTime, stepSize)
      annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_DoStep_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_DoStep_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
double Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiDoStep2(void*m, double currentTime, double stepSize) {
  struct dy_fmi2Extended*a=m;
  ...
  if (status!=fmi2OK && status!=fmi2Warning){    ModelicaFormatError(\"The call of fmi2DoStep(%f, %f) failed in FMU\\r\\nNote: setting fmi_loggingOn in the FMU component may produce more information from the FMU.\",currentTime, stepSize);  }  return 1.0;
    ...
    function fmiReset
      ...
      external"C" resetOK = Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiReset2(fmi)
      annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_Reset_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_Reset_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
double Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiReset2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiReset failed\");
    ...
    function fmiGetReal
      ...
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiGetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_GetReal_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_GetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiGetReal2(void*m, const int*refs, size_t nrefs, double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiGetReal2(void*m, const int*refs, size_t nrefs, double*vals) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetReal failed\");
    ...
    function fmiSetReal
      ...
      external"C"
                 Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiSetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals)
        annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_SetReal_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_SetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiSetReal2(void*m, const int*refs, size_t nrefs, const double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if(!nrefs){return;}
  if (a) {
...
function fmiSetRealDiscrete
    ...
    protected
      ...
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiSetRealDiscrete(
        fmi,
        refs,
        size(refs, 1),
        vals,
        oldVals)
      annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_SetRealDiscrete_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_SetRealDiscrete_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiSetRealDiscrete(void*m, const int*refs, size_t nrefs, double*vals, double*oldVals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  annotation(__Dymola_doNotLinkSharedObject=true,__Dymola_CriticalRegion = "Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3", __Dymola_LockExternalObject=true,__Dymola_IdemPotent=true, __Dymola_VectorizedExceptFirst=true);
    ...
    function fmiGetInteger
      ...
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiGetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_GetInteger_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_GetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiGetInteger2(void*m, const int*refs, size_t nrefs, int*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiGetInteger2(void*m, const int*refs, size_t nrefs, int*vals) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetInteger failed\");
    ...
    protected
      ...
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiSetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        oldVals)
      annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_SetInteger_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_SetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiSetInteger2(void*m, const int*refs, size_t nrefs, int*vals, int*oldVals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetInteger failed\");
    ...
    function fmiSetIntegerwf
      ...
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiSetInteger2wf(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_SetIntegerwf_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_SetIntegerwf_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiSetInteger2wf(void*m, const int*refs, size_t nrefs, int*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetInteger failed\");
    ...
    function fmiGetBoolean
      ...
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiGetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals)
        annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_GetBoolean_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_GetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiGetBoolean2(void*m, const int* refs, size_t nr, int* vals) {
  int i;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiGetBoolean2(void*m, const int* refs, size_t nr, int* vals) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetBoolean failed\");
    ...
    protected
      ...
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiSetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        ...
        oldVals)
        annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_SetBoolean_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_SetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiSetBoolean2(void*m, const int* refs, size_t nr, const int* vals, int* dummy, int* oldVals) {
  size_t i;
  int j;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetBoolean failed\");
    ...
    function fmiSetString
      ...
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiSetString2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_SetString_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_SetString_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiSetString2(void*m, const int*refs, size_t nrefs,const fmi2String vals[]) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetString failed\");
    ...
    protected
      Boolean dummy[size(refs, 1)];
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiSetBoolean2wf(
        fmi,
        refs,
        size(refs, 1),
        vals,
        dummy)
        annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_SetBooleanwf_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_SetBooleanwf_C 1
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiSetBoolean2wf(void*m, const int* refs, size_t nr, const int* vals, int* dummy) {
  size_t i;
  int j;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetBoolean failed\");
    ...
    function fmiGetDirectionalDerivative
      ...
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_GetDirectionalDerivative2(
        fmi,
        z_refs,
        size(z_refs, 1),
        v_refs,
        ...
        dz)
      annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_GetDirectionalDerivative2_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_GetDirectionalDerivative2_C 1
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_GetDirectionalDerivative2(void*m, const int* zref, size_t nzr, const int* vrefs, size_t nvr, const double *dv, double *dz) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetDirectionalDerivative failed\");
    ...
    function fmiSaveFMUState
      input fmiModel fmi;
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiSaveFMUState2(fmi)
        annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiSaveFMUState_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiSaveFMUState_C 1
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiSaveFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetFMUstate failed\");
    ...
    function fmiRestoreFMUState
      input fmiModel fmi;
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiRestoreFMUState2(fmi)
        annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiRestoreFMUState_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiRestoreFMUState_C 1
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiRestoreFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiSetFMUstate failed\");
    ...
    function fmiSerializeFMUstate
      input fmiModel fmi;
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiSerializeFMUstate2(fmi)
        annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiSerializeFMUstate_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiSerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiSerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
    status = a->dyFmiGetFMUstate(a->m, &a->dyFMUstate);
    ...
    function fmiDeSerializeFMUstate
      input fmiModel fmi;
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiDeSerializeFMUstate2(fmi)
        annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiDeSerializeFMUstate_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiDeSerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiDeSerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
    ...
    function fmiEnterSlaveInitializationMode
      ...
      input Real preAvailable;
      output Real postAvailable = preAvailable;
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiEnterSlaveInitializationMode2(fmi, setTolerance, relativeTolerance, tStart, forceShutDownAtTStop, tStop)
      annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiEnterSlaveInitializationMode_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiEnterSlaveInitializationMode_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiEnterSlaveInitializationMode2(void*m, int setTolerance, double relativeTolerance, double tStart, int forceShutDownAtTStop, double tStop) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"InitializeSlave failed\");
    ...
    function fmiExitSlaveInitializationMode
      ...
      input Real preAvailable;
      output Real postAvailable = preAvailable;
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiExitSlaveInitializationMode2(fmi)
      annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiExitSlaveInitializationMode_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiExitSlaveInitializationMode_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f331314466623470507_fmiExitSlaveInitializationMode2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
<li>generationDateAndTime = 2025-11-03T22:18:19Z</li>
</ul>
