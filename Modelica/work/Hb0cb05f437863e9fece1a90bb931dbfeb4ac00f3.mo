...
model Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3
  "Stub for eFMU-based co-simulation of
     ...
     Generated by Dymola on 2026-03-26T03:09:39Z."
extends fmuIcon;
...
package fmi_Functions
    ...
    class fmiModel
      ...
      function constructor "Initialize FMI model"
        ...
        output fmiModel fmi;
        external"C" fmi = Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiInstantiateModel2(instanceName, loggingOn, resourceLocation)
        annotation(Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_Instantiate_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_Instantiate_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058Logger(fmi2ComponentEnvironment componentEnvironment, fmi2String instanceName, fmi2Status status,
...
void * Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiInstantiateModel2(const char*instanceName, fmi2Boolean loggingOn, fmi2String resourceLocation) {
  static fmi2CallbackFunctions funcs = {&Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058Logger, &calloc, &free, NULL, NULL};
  ...
  if (res!=0) {
    ...
    res->m=res->dyFmiInstantiate(instanceName, fmi2CoSimulation, \"{5bea1550-cb16-47a6-b3f1-dfc950ee0a58}\",resourceLocation, &funcs, fmi2False, loggingOn);
  ...
  return res;
      ...
      function destructor "Release storage of FMI model"
          ...
          input fmiModel fmi;
          external"C"
                     Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiFreeModelInstance2(fmi)
          annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_Free_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_Free_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiFreeModelInstance2(void*m) {
  ...
  if (a) {
    ...
    input Real stepSize;
    external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiDoStep2(fmi, currentTime, stepSize)
      annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_DoStep_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_DoStep_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
double Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiDoStep2(void*m, double currentTime, double stepSize) {
  struct dy_fmi2Extended*a=m;
  ...
  if (status!=fmi2OK && status!=fmi2Warning){    ModelicaFormatError(\"The call of fmi2DoStep(%f, %f) failed in FMU\\r\\nNote: setting fmi_loggingOn in the FMU component may produce more information from the FMU.\",currentTime, stepSize);  }  return 1.0;
    ...
    external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiExitModelInitializationMode2(fmi)
    annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiExitModelInitializationMode_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiExitModelInitializationMode_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiExitModelInitializationMode2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  return;
    ...
    function fmi2Reset
      input fmiModel fmi;
      external"C"
                 Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiReset2(fmi)
      annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_Reset_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_Reset_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiReset2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiReset failed\");
    ...
    function fmi2GetReal
      ...
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiGetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_GetReal_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_GetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiGetReal2(void*m, const int*refs, size_t nrefs, double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetReal failed\");
    ...
    function fmi2SetReal
      ...
      external"C"
                 Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiSetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals)
        annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_SetReal_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_SetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiSetReal2(void*m, const int*refs, size_t nrefs, const double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if(!nrefs){return;}
  if (a) {
...
function fmi2SetRealDiscrete
    ...
    protected
      ...
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiSetRealDiscrete(
        fmi,
        refs,
        size(refs, 1),
        vals,
        oldVals)
      annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_SetRealDiscrete_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_SetRealDiscrete_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiSetRealDiscrete(void*m, const int*refs, size_t nrefs, double*vals, double*oldVals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  annotation(__Dymola_doNotLinkSharedObject=true,__Dymola_CriticalRegion = "Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3", __Dymola_LockExternalObject=true,__Dymola_IdemPotent=true, __Dymola_VectorizedExceptFirst=true);
    ...
    function fmi2GetInteger
      ...
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiGetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_GetInteger_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_GetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiGetInteger2(void*m, const int*refs, size_t nrefs, int*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetInteger failed\");
    ...
    protected
      ...
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiSetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        oldVals)
      annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_SetInteger_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_SetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiSetInteger2(void*m, const int*refs, size_t nrefs, int*vals, int*oldVals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetInteger failed\");
    ...
    function fmi2GetBoolean
      ...
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiGetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals)
        annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_GetBoolean_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_GetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiGetBoolean2(void*m, const int* refs, size_t nr, int* vals) {
  int i;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetBoolean failed\");
    ...
    protected
      ...
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiSetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        ...
        oldVals)
        annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_SetBoolean_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_SetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiSetBoolean2(void*m, const int* refs, size_t nr, const int* vals, int* dummy, int* oldVals) {
  size_t i;
  int j;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetBoolean failed\");
    ...
    function fmi2SetString
      ...
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiSetString2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_SetString_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_SetString_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiSetString2(void*m, const int*refs, size_t nrefs,const fmi2String vals[]) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetString failed\");
    ...
    function fmi2GetDirectionalDerivative
      ...
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_GetDirectionalDerivative2(
        fmi,
        z_refs,
        size(z_refs, 1),
        v_refs,
        ...
        dz)
      annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_GetDirectionalDerivative2_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_GetDirectionalDerivative2_C 1
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_GetDirectionalDerivative2(void*m, const int* zref, size_t nzr, const int* vrefs, size_t nvr, const double *dv, double *dz) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetDirectionalDerivative failed\");
    ...
    function fmi2SaveFMUState
      input fmiModel fmi;
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiSaveFMUState2(fmi)
        annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiSaveFMUState_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiSaveFMUState_C 1
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiSaveFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetFMUstate failed\");
    ...
    function fmi2RestoreFMUState
      input fmiModel fmi;
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiRestoreFMUState2(fmi)
        annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiRestoreFMUState_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiRestoreFMUState_C 1
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiRestoreFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiSetFMUstate failed\");
    ...
    function fmi2SerializeFMUstate
      input fmiModel fmi;
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmi2SerializeFMUstate2(fmi)
        annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmi2SerializeFMUstate_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmi2SerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmi2SerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
    status = a->dyFmiGetFMUstate(a->m, &a->dyFMUstate);
    ...
    function fmi2DeSerializeFMUstate
      input fmiModel fmi;
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmi2DeSerializeFMUstate2(fmi)
        annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmi2DeSerializeFMUstate_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmi2DeSerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmi2DeSerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
    ...
    function fmi2EnterCSInitializationMode
      ...
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiEnterSlaveInitializationMode2(fmi, setTolerance, relativeTolerance, tStart, forceShutDownAtTStop, tStop)
      annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiEnterSlaveInitializationMode_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiEnterSlaveInitializationMode_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3515501647631950058_fmiEnterSlaveInitializationMode2(void*m, int setTolerance, double relativeTolerance, double tStart, int forceShutDownAtTStop, double tStop) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
equation
  ...
  annotation (__Dymola_FMUImportVersion="Dymola 2026x Refresh 1 Beta 1", __Dymola_FMUImportPath="C:/dev/efmi-pss-use-case/Modelica/work/Grid4HIL/SiL-integration/FMU/Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3.fmu", __Dymola_FMUImportIncludeAllVariables="false", __Dymola_FMUImportIntegrate="false", __Dymola_FMUResourcePath="Resources/Library/FMU/Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3",__Dymola_FMUImportDateTime="Thu Mar 26 03:09:49 2026 GMT", experiment(StartTime=0.0, StopTime=1.0, Tolerance=0.0001),
    Icon(graphics={
...
<li>generationDateAndTime = 2026-03-26T03:09:40Z</li>
</ul>
