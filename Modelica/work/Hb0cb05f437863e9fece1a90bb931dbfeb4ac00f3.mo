...
model Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3
  "Stub for eFMU-based co-simulation of
     ...
     Generated by Dymola on 2025-11-13T00:39:54Z."
extends fmuIcon;
...
package fmi_Functions
    ...
    class fmiModel
      ...
      function constructor "Initialize FMI model"
        ...
        output fmiModel fmi;
        external"C" fmi = Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiInstantiateModel2(instanceName, loggingOn, resourceLocation)
        annotation(Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_Instantiate_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_Instantiate_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372Logger(fmi2ComponentEnvironment componentEnvironment, fmi2String instanceName, fmi2Status status,
...
void * Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiInstantiateModel2(const char*instanceName, fmi2Boolean loggingOn, fmi2String resourceLocation) {
  static fmi2CallbackFunctions funcs = {&Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372Logger, &calloc, &free, NULL, NULL};
  ...
  if (res!=0) {
    ...
    res->m=res->dyFmiInstantiate(instanceName, fmi2CoSimulation, \"{dac89f5d-8984-4d1b-8a97-5f6eb428e372}\",resourceLocation, &funcs, fmi2False, loggingOn);
  ...
  return res;
      ...
      function destructor "Release storage of FMI model"
          ...
          input fmiModel fmi;
          external"C"
                     Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiFreeModelInstance2(fmi)
          annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_Free_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_Free_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiFreeModelInstance2(void*m) {
  ...
  if (a) {
    ...
    external"C" stepOK =Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiDoStep2(fmi, currentTime, stepSize)
      annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_DoStep_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_DoStep_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
double Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiDoStep2(void*m, double currentTime, double stepSize) {
  struct dy_fmi2Extended*a=m;
  ...
  if (status!=fmi2OK && status!=fmi2Warning){    ModelicaFormatError(\"The call of fmi2DoStep(%f, %f) failed in FMU\\r\\nNote: setting fmi_loggingOn in the FMU component may produce more information from the FMU.\",currentTime, stepSize);  }  return 1.0;
    ...
    function fmiReset
      ...
      external"C" resetOK = Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiReset2(fmi)
      annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_Reset_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_Reset_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
double Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiReset2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiReset failed\");
    ...
    function fmiGetReal
      ...
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiGetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_GetReal_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_GetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiGetReal2(void*m, const int*refs, size_t nrefs, double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiGetReal2(void*m, const int*refs, size_t nrefs, double*vals) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetReal failed\");
    ...
    function fmiSetReal
      ...
      external"C"
                 Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiSetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals)
        annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_SetReal_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_SetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiSetReal2(void*m, const int*refs, size_t nrefs, const double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if(!nrefs){return;}
  if (a) {
...
function fmiSetRealDiscrete
    ...
    protected
      ...
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiSetRealDiscrete(
        fmi,
        refs,
        size(refs, 1),
        vals,
        oldVals)
      annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_SetRealDiscrete_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_SetRealDiscrete_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiSetRealDiscrete(void*m, const int*refs, size_t nrefs, double*vals, double*oldVals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  annotation(__Dymola_doNotLinkSharedObject=true,__Dymola_CriticalRegion = "Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3", __Dymola_LockExternalObject=true,__Dymola_IdemPotent=true, __Dymola_VectorizedExceptFirst=true);
    ...
    function fmiGetInteger
      ...
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiGetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_GetInteger_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_GetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiGetInteger2(void*m, const int*refs, size_t nrefs, int*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiGetInteger2(void*m, const int*refs, size_t nrefs, int*vals) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetInteger failed\");
    ...
    protected
      ...
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiSetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        oldVals)
      annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_SetInteger_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_SetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiSetInteger2(void*m, const int*refs, size_t nrefs, int*vals, int*oldVals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetInteger failed\");
    ...
    function fmiSetIntegerwf
      ...
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiSetInteger2wf(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_SetIntegerwf_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_SetIntegerwf_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiSetInteger2wf(void*m, const int*refs, size_t nrefs, int*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetInteger failed\");
    ...
    function fmiGetBoolean
      ...
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiGetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals)
        annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_GetBoolean_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_GetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiGetBoolean2(void*m, const int* refs, size_t nr, int* vals) {
  int i;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiGetBoolean2(void*m, const int* refs, size_t nr, int* vals) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetBoolean failed\");
    ...
    protected
      ...
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiSetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        ...
        oldVals)
        annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_SetBoolean_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_SetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiSetBoolean2(void*m, const int* refs, size_t nr, const int* vals, int* dummy, int* oldVals) {
  size_t i;
  int j;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetBoolean failed\");
    ...
    function fmiSetString
      ...
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiSetString2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_SetString_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_SetString_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiSetString2(void*m, const int*refs, size_t nrefs,const fmi2String vals[]) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetString failed\");
    ...
    protected
      Boolean dummy[size(refs, 1)];
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiSetBoolean2wf(
        fmi,
        refs,
        size(refs, 1),
        vals,
        dummy)
        annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_SetBooleanwf_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_SetBooleanwf_C 1
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiSetBoolean2wf(void*m, const int* refs, size_t nr, const int* vals, int* dummy) {
  size_t i;
  int j;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetBoolean failed\");
    ...
    function fmiGetDirectionalDerivative
      ...
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_GetDirectionalDerivative2(
        fmi,
        z_refs,
        size(z_refs, 1),
        v_refs,
        ...
        dz)
      annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_GetDirectionalDerivative2_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_GetDirectionalDerivative2_C 1
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_GetDirectionalDerivative2(void*m, const int* zref, size_t nzr, const int* vrefs, size_t nvr, const double *dv, double *dz) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetDirectionalDerivative failed\");
    ...
    function fmiSaveFMUState
      input fmiModel fmi;
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiSaveFMUState2(fmi)
        annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiSaveFMUState_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiSaveFMUState_C 1
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiSaveFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetFMUstate failed\");
    ...
    function fmiRestoreFMUState
      input fmiModel fmi;
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiRestoreFMUState2(fmi)
        annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiRestoreFMUState_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiRestoreFMUState_C 1
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiRestoreFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiSetFMUstate failed\");
    ...
    function fmiSerializeFMUstate
      input fmiModel fmi;
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiSerializeFMUstate2(fmi)
        annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiSerializeFMUstate_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiSerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiSerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
    status = a->dyFmiGetFMUstate(a->m, &a->dyFMUstate);
    ...
    function fmiDeSerializeFMUstate
      input fmiModel fmi;
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiDeSerializeFMUstate2(fmi)
        annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiDeSerializeFMUstate_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiDeSerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiDeSerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
    ...
    function fmiEnterSlaveInitializationMode
      ...
      input Real preAvailable;
      output Real postAvailable = preAvailable;
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiEnterSlaveInitializationMode2(fmi, setTolerance, relativeTolerance, tStart, forceShutDownAtTStop, tStop)
      annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiEnterSlaveInitializationMode_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiEnterSlaveInitializationMode_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiEnterSlaveInitializationMode2(void*m, int setTolerance, double relativeTolerance, double tStart, int forceShutDownAtTStop, double tStop) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"InitializeSlave failed\");
    ...
    function fmiExitSlaveInitializationMode
      ...
      input Real preAvailable;
      output Real postAvailable = preAvailable;
      external"C" Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiExitSlaveInitializationMode2(fmi)
      annotation (Include="
#ifndef Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiExitSlaveInitializationMode_C
#define Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiExitSlaveInitializationMode_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f389589844189756428372_fmiExitSlaveInitializationMode2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
equation
  ...
  annotation (__Dymola_FMUImportVersion="Dymola 2025x Refresh 1", __Dymola_FMUImportPath="C:/Users/vanfr/Documents/Github/efmi-pss-use-case/Modelica/work/Grid4HIL/SiL-integration/FMU/Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3.fmu", __Dymola_FMUImportIncludeAllVariables="false", __Dymola_FMUImportIntegrate="false", __Dymola_FMUResourcePath="Resources/Library/FMU/Hb0cb05f437863e9fece1a90bb931dbfeb4ac00f3",__Dymola_FMUImportDateTime="Thu Nov 13 00:40:06 2025 GMT", experiment(StartTime=0.0, StopTime=1.0, Tolerance=0.0001),
    Icon(graphics={
...
<li>generationDateAndTime = 2025-11-13T00:39:57Z</li>
</ul>
