within ;
model Hc234cad58156ccbc9047c71532b337747dea4c15
  "Stub for eFMU-based co-simulation of
     ...
     as configured by eFMU generation configuration
       [PSSDesign.eFMU4CHIL.CHILspe]
     Generated by Dymola on 2026-01-14T21:38:44Z."
extends fmuIcon;
...
encapsulated package importedFMUTypes
  ...
  type 'CHILspe_eFMU_SiL_Support\'_ProductionCodes' = enumeration(Mockup "non-functional mockup",
        PCode_SPE_cb4a8a449b4ada864625ee5a4355578a3aaf08ed,
        PCode_SPE_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c);
constant Integer[3] 'CHILspe_eFMU_SiL_Support\'_ProductionCodes_values' = {1, 2, 3};
...
public
  parameter String fmi_instanceName="Hc234cad58156ccbc9047c71532b337747dea4c15"
  ...
  annotation (Dialog(tab="FMI", group="Step time"));
  parameter Real fmi_CommunicationStepSize(unit = "s") = 0.0001
  annotation (Dialog(tab="FMI", group="Step time"));
  ...
  parameter String fmi_resourceLocation="file:///"+ModelicaServices.ExternalReferences.loadResource("modelica://Hc234cad58156ccbc9047c71532b337747dea4c15/Resources/Library/FMU/Hc234cad58156ccbc9047c71532b337747dea4c15/resources")
...
package fmi_Functions
    ...
    class fmiModel
      ...
      function constructor "Initialize FMI model"
        ...
        output fmiModel fmi;
        external"C" fmi = Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiInstantiateModel2(instanceName, loggingOn, resourceLocation)
        annotation(Include="
#ifndef Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_Instantiate_C
#define Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_Instantiate_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678Logger(fmi2ComponentEnvironment componentEnvironment, fmi2String instanceName, fmi2Status status,
...
void * Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiInstantiateModel2(const char*instanceName, fmi2Boolean loggingOn, fmi2String resourceLocation) {
  static fmi2CallbackFunctions funcs = {&Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678Logger, &calloc, &free, NULL, NULL};
  struct dy_fmi2Extended* res;
  res = calloc(1, sizeof(struct dy_fmi2Extended));
  if (res!=0) {
#ifdef _WIN32
    if (!(res->hInst=LoadLibraryW(L\"Hc234cad58156ccbc9047c71532b337747dea4c15.dll\"))) {
      ModelicaError(\"Loading of FMU dynamic link library (Hc234cad58156ccbc9047c71532b337747dea4c15.dll) failed!\");
#else
    if (!(res->hInst=LoadLibrary(\"Hc234cad58156ccbc9047c71532b337747dea4c15.so\"))) {
      ModelicaError(\"Loading of FMU dynamic link library (Hc234cad58156ccbc9047c71532b337747dea4c15.so) failed!\");
#endif
      return 0;
    }
    ...
    res->m=res->dyFmiInstantiate(instanceName, fmi2CoSimulation, \"{360b9639-fc37-4110-981e-99d727e678ff}\",resourceLocation, &funcs, fmi2False, loggingOn);
  ...
  return res;
...
#endif", Library="Hc234cad58156ccbc9047c71532b337747dea4c15", LibraryDirectory="modelica://Hc234cad58156ccbc9047c71532b337747dea4c15/Resources/Library/FMU/Hc234cad58156ccbc9047c71532b337747dea4c15/binaries");
        annotation (__Dymola_doNotLinkSharedObject=true,
            __Dymola_CriticalRegion="Hc234cad58156ccbc9047c71532b337747dea4c15");
      end constructor;
      ...
      function destructor "Release storage of FMI model"
          ...
          input fmiModel fmi;
          external"C"
                     Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiFreeModelInstance2(fmi)
          annotation (Include="
#ifndef Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_Free_C
#define Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_Free_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiFreeModelInstance2(void*m) {
  ...
  if (a) {
...
#endif",       Library="Hc234cad58156ccbc9047c71532b337747dea4c15", LibraryDirectory="modelica://Hc234cad58156ccbc9047c71532b337747dea4c15/Resources/Library/FMU/Hc234cad58156ccbc9047c71532b337747dea4c15/binaries");
        annotation(__Dymola_doNotLinkSharedObject=true,__Dymola_CriticalRegion = "Hc234cad58156ccbc9047c71532b337747dea4c15");
      end destructor;
    ...
    input Real stepSize;
    external"C" Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiDoStep2(fmi, currentTime, stepSize)
      annotation (Include="
#ifndef Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_DoStep_C
#define Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_DoStep_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
double Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiDoStep2(void*m, double currentTime, double stepSize) {
  struct dy_fmi2Extended*a=m;
  ...
  if (status!=fmi2OK && status!=fmi2Warning){    ModelicaFormatError(\"The call of fmi2DoStep(%f, %f) failed in FMU\\r\\nNote: setting fmi_loggingOn in the FMU component may produce more information from the FMU.\",currentTime, stepSize);  }  return 1.0;
    ...
    external"C" Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiExitModelInitializationMode2(fmi)
    annotation (Include="
#ifndef Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiExitModelInitializationMode_C
#define Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiExitModelInitializationMode_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiExitModelInitializationMode2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  return;
    ...
    function fmi2Reset
      input fmiModel fmi;
      external"C"
                 Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiReset2(fmi)
      annotation (Include="
#ifndef Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_Reset_C
#define Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_Reset_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiReset2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiReset failed\");
    ...
    function fmi2GetReal
      ...
      external"C" Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiGetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_GetReal_C
#define Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_GetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiGetReal2(void*m, const int*refs, size_t nrefs, double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetReal failed\");
    ...
    function fmi2SetReal
      ...
      external"C"
                 Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiSetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals)
        annotation (Include="
#ifndef Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_SetReal_C
#define Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_SetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiSetReal2(void*m, const int*refs, size_t nrefs, const double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if(!nrefs){return;}
  if (a) {
...
function fmi2SetRealDiscrete
    ...
    protected
      ...
      external"C" Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiSetRealDiscrete(
        fmi,
        refs,
        size(refs, 1),
        vals,
        oldVals)
      annotation (Include="
#ifndef Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_SetRealDiscrete_C
#define Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_SetRealDiscrete_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiSetRealDiscrete(void*m, const int*refs, size_t nrefs, double*vals, double*oldVals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
...
#endif", Library="Hc234cad58156ccbc9047c71532b337747dea4c15", LibraryDirectory="modelica://Hc234cad58156ccbc9047c71532b337747dea4c15/Resources/Library/FMU/Hc234cad58156ccbc9047c71532b337747dea4c15/binaries");
  annotation(__Dymola_doNotLinkSharedObject=true,__Dymola_CriticalRegion = "Hc234cad58156ccbc9047c71532b337747dea4c15", __Dymola_LockExternalObject=true,__Dymola_IdemPotent=true, __Dymola_VectorizedExceptFirst=true);
    ...
    function fmi2GetInteger
      ...
      external"C" Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiGetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_GetInteger_C
#define Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_GetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiGetInteger2(void*m, const int*refs, size_t nrefs, int*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetInteger failed\");
    ...
    protected
      ...
      external"C" Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiSetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        oldVals)
      annotation (Include="
#ifndef Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_SetInteger_C
#define Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_SetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiSetInteger2(void*m, const int*refs, size_t nrefs, int*vals, int*oldVals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetInteger failed\");
    ...
    function fmi2GetBoolean
      ...
      external"C" Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiGetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals)
        annotation (Include="
#ifndef Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_GetBoolean_C
#define Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_GetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiGetBoolean2(void*m, const int* refs, size_t nr, int* vals) {
  int i;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetBoolean failed\");
    ...
    protected
      ...
      external"C" Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiSetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        ...
        oldVals)
        annotation (Include="
#ifndef Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_SetBoolean_C
#define Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_SetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiSetBoolean2(void*m, const int* refs, size_t nr, const int* vals, int* dummy, int* oldVals) {
  size_t i;
  int j;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetBoolean failed\");
    ...
    function fmi2SetString
      ...
      external"C" Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiSetString2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_SetString_C
#define Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_SetString_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiSetString2(void*m, const int*refs, size_t nrefs,const fmi2String vals[]) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetString failed\");
    ...
    function fmi2GetDirectionalDerivative
      ...
      external"C" Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_GetDirectionalDerivative2(
        fmi,
        z_refs,
        size(z_refs, 1),
        v_refs,
        ...
        dz)
      annotation (Include="
#ifndef Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_GetDirectionalDerivative2_C
#define Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_GetDirectionalDerivative2_C 1
#include \"FMI/fmi2Import.h\"
void Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_GetDirectionalDerivative2(void*m, const int* zref, size_t nzr, const int* vrefs, size_t nvr, const double *dv, double *dz) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetDirectionalDerivative failed\");
    ...
    function fmi2SaveFMUState
      input fmiModel fmi;
      external"C" Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiSaveFMUState2(fmi)
        annotation (Include="
#ifndef Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiSaveFMUState_C
#define Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiSaveFMUState_C 1
#include \"FMI/fmi2Import.h\"
void Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiSaveFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetFMUstate failed\");
    ...
    function fmi2RestoreFMUState
      input fmiModel fmi;
      external"C" Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiRestoreFMUState2(fmi)
        annotation (Include="
#ifndef Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiRestoreFMUState_C
#define Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiRestoreFMUState_C 1
#include \"FMI/fmi2Import.h\"
void Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiRestoreFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiSetFMUstate failed\");
    ...
    function fmi2SerializeFMUstate
      input fmiModel fmi;
      external"C" Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmi2SerializeFMUstate2(fmi)
        annotation (Include="
#ifndef Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmi2SerializeFMUstate_C
#define Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmi2SerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmi2SerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
    status = a->dyFmiGetFMUstate(a->m, &a->dyFMUstate);
    ...
    function fmi2DeSerializeFMUstate
      input fmiModel fmi;
      external"C" Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmi2DeSerializeFMUstate2(fmi)
        annotation (Include="
#ifndef Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmi2DeSerializeFMUstate_C
#define Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmi2DeSerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmi2DeSerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
    ...
    function fmi2EnterCSInitializationMode
      ...
      external"C" Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiEnterSlaveInitializationMode2(fmi, setTolerance, relativeTolerance, tStart, forceShutDownAtTStop, tStop)
      annotation (Include="
#ifndef Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiEnterSlaveInitializationMode_C
#define Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiEnterSlaveInitializationMode_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void Hc234cad58156ccbc9047c71532b337747dea4c15360963937411098199727678_fmiEnterSlaveInitializationMode2(void*m, int setTolerance, double relativeTolerance, double tStart, int forceShutDownAtTStop, double tStop) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
equation
  ...
  annotation (__Dymola_FMUImportVersion="Dymola 2026x Refresh 1 Dev 3", __Dymola_FMUImportPath="C:/Users/CBR5.DSONE/Documents/Dymola/CHILspe/SiL-integration/FMU/Hc234cad58156ccbc9047c71532b337747dea4c15.fmu", __Dymola_FMUImportIncludeAllVariables="false", __Dymola_FMUImportIntegrate="false", __Dymola_FMUResourcePath="Resources/Library/FMU/Hc234cad58156ccbc9047c71532b337747dea4c15",__Dymola_FMUImportDateTime="Wed Jan 14 21:38:55 2026 GMT", experiment(StartTime=0.0, StopTime=1.0, Tolerance=0.0001),
    Icon(graphics={
...
<li>modelName = Hc234cad58156ccbc9047c71532b337747dea4c15</li>
<li>generationTool = Dymola Version 2026x Refresh 1 Dev 3, 2026-01-23 (using Inline integration method Explicit Euler and internal fixed step size 0.0001)</li>
<li>generationDateAndTime = 2026-01-14T21:38:48Z</li>
</ul>
...
end Hc234cad58156ccbc9047c71532b337747dea4c15;
