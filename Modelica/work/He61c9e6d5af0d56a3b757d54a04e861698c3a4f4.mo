...
model He61c9e6d5af0d56a3b757d54a04e861698c3a4f4
  "Stub for eFMU-based co-simulation of
     ...
     Generated by Dymola on 2025-12-22T20:21:21Z."
extends fmuIcon;

// Model automatically generated by Dymola from FMI model description
public
encapsulated package importedFMUTypes
  type 'PSSspe_eFMU_SiL_Support\'___TuningConnectors_Kw' = Real;
  type 'PSSspe_eFMU_SiL_Support\'___TuningConnectors_T1' = Real (unit = "s", quantity = "Time");
  type 'PSSspe_eFMU_SiL_Support\'___TuningConnectors_T2' = Real (unit = "s", quantity = "Time");
  type 'PSSspe_eFMU_SiL_Support\'___TuningConnectors_T3' = Real (unit = "s", quantity = "Time");
  type 'PSSspe_eFMU_SiL_Support\'___TuningConnectors_T4' = Real (unit = "s", quantity = "Time");
  type 'PSSspe_eFMU_SiL_Support\'___TuningConnectors_Tw' = Real (unit = "s", quantity = "Time");
  type 'PSSspe_eFMU_SiL_Support\'___TuningConnectors_vSI_start' = Real;
  type 'PSSspe_eFMU_SiL_Support\'___TuningConnectors_vsmax' = Real;
  type 'PSSspe_eFMU_SiL_Support\'___TuningConnectors_vsmin' = Real;
...
protected
  ...
  parameter String fmi_yNames[3] ={"vs", "CPUtime", "EventCounter"};
  parameter Integer fmi_yVrs[3] ={603979780, 67108869, 67108870};
package fmi_Functions
    ...
    class fmiModel
      ...
      function constructor "Initialize FMI model"
        ...
        output fmiModel fmi;
        external"C" fmi = He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiInstantiateModel2(instanceName, loggingOn, resourceLocation)
        annotation(Include="
#ifndef He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_Instantiate_C
#define He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_Instantiate_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521Logger(fmi2ComponentEnvironment componentEnvironment, fmi2String instanceName, fmi2Status status,
...
void * He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiInstantiateModel2(const char*instanceName, fmi2Boolean loggingOn, fmi2String resourceLocation) {
  static fmi2CallbackFunctions funcs = {&He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521Logger, &calloc, &free, NULL, NULL};
  ...
  if (res!=0) {
    ...
    res->m=res->dyFmiInstantiate(instanceName, fmi2CoSimulation, \"{930d752a-4046-4676-89ec-f3ae13e5f2d1}\",resourceLocation, &funcs, fmi2False, loggingOn);
    res->der = calloc(0,sizeof(double));
    res->out = calloc(3,sizeof(double));
    if (!res->m || !res->der && 0 || !res->out && 3 ) {free(res);res=0;ModelicaError(\"InstantiateModel failed\");}
    else {
  ...
  return res;
      ...
      function destructor "Release storage of FMI model"
          ...
          input fmiModel fmi;
          external"C"
                     He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiFreeModelInstance2(fmi)
          annotation (Include="
#ifndef He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_Free_C
#define He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_Free_C 1
#include \"FMI/fmi2Import.h\"
#include <stdlib.h>
void He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiFreeModelInstance2(void*m) {
  ...
  if (a) {
    ...
    external"C" stepOK =He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiDoStep2(fmi, currentTime, stepSize)
      annotation (Include="
#ifndef He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_DoStep_C
#define He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_DoStep_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
double He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiDoStep2(void*m, double currentTime, double stepSize) {
  struct dy_fmi2Extended*a=m;
  ...
  if (status!=fmi2OK && status!=fmi2Warning){    ModelicaFormatError(\"The call of fmi2DoStep(%f, %f) failed in FMU\\r\\nNote: setting fmi_loggingOn in the FMU component may produce more information from the FMU.\",currentTime, stepSize);  }  return 1.0;
    ...
    function fmiReset
      ...
      external"C" resetOK = He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiReset2(fmi)
      annotation (Include="
#ifndef He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_Reset_C
#define He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_Reset_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
double He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiReset2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiReset failed\");
    ...
    function fmiGetReal
      ...
      external"C" He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiGetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_GetReal_C
#define He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_GetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiGetReal2(void*m, const int*refs, size_t nrefs, double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
void He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiGetReal2(void*m, const int*refs, size_t nrefs, double*vals) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetReal failed\");
    ...
    function fmiSetReal
      ...
      external"C"
                 He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiSetReal2(
        fmi,
        refs,
        size(refs, 1),
        vals)
        annotation (Include="
#ifndef He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_SetReal_C
#define He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_SetReal_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiSetReal2(void*m, const int*refs, size_t nrefs, const double*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if(!nrefs){return;}
  if (a) {
...
function fmiSetRealDiscrete
    ...
    protected
      ...
      external"C" He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiSetRealDiscrete(
        fmi,
        refs,
        size(refs, 1),
        vals,
        oldVals)
      annotation (Include="
#ifndef He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_SetRealDiscrete_C
#define He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_SetRealDiscrete_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiSetRealDiscrete(void*m, const int*refs, size_t nrefs, double*vals, double*oldVals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  annotation(__Dymola_doNotLinkSharedObject=true,__Dymola_CriticalRegion = "He61c9e6d5af0d56a3b757d54a04e861698c3a4f4", __Dymola_LockExternalObject=true,__Dymola_IdemPotent=true, __Dymola_VectorizedExceptFirst=true);
    ...
    function fmiGetInteger
      ...
      external"C" He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiGetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_GetInteger_C
#define He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_GetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiGetInteger2(void*m, const int*refs, size_t nrefs, int*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
void He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiGetInteger2(void*m, const int*refs, size_t nrefs, int*vals) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetInteger failed\");
    ...
    protected
      ...
      external"C" He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiSetInteger2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        oldVals)
      annotation (Include="
#ifndef He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_SetInteger_C
#define He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_SetInteger_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiSetInteger2(void*m, const int*refs, size_t nrefs, int*vals, int*oldVals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetInteger failed\");
    ...
    function fmiSetIntegerwf
      ...
      external"C" He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiSetInteger2wf(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_SetIntegerwf_C
#define He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_SetIntegerwf_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiSetInteger2wf(void*m, const int*refs, size_t nrefs, int*vals) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetInteger failed\");
    ...
    function fmiGetBoolean
      ...
      external"C" He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiGetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals)
        annotation (Include="
#ifndef He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_GetBoolean_C
#define He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_GetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiGetBoolean2(void*m, const int* refs, size_t nr, int* vals) {
  int i;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
void He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiGetBoolean2(void*m, const int* refs, size_t nr, int* vals) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"GetBoolean failed\");
    ...
    protected
      ...
      external"C" He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiSetBoolean2(
        fmi,
        refs,
        size(refs, 1),
        vals,
        ...
        oldVals)
        annotation (Include="
#ifndef He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_SetBoolean_C
#define He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_SetBoolean_C 1
#include \"FMI/fmi2Import.h\"
void He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiSetBoolean2(void*m, const int* refs, size_t nr, const int* vals, int* dummy, int* oldVals) {
  size_t i;
  int j;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetBoolean failed\");
    ...
    function fmiSetString
      ...
      external"C" He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiSetString2(
        fmi,
        refs,
        size(refs, 1),
        vals)
      annotation (Include="
#ifndef He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_SetString_C
#define He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_SetString_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiSetString2(void*m, const int*refs, size_t nrefs,const fmi2String vals[]) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  size_t i = 0;
  if(!nrefs){return;}
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetString failed\");
    ...
    protected
      Boolean dummy[size(refs, 1)];
      external"C" He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiSetBoolean2wf(
        fmi,
        refs,
        size(refs, 1),
        vals,
        dummy)
        annotation (Include="
#ifndef He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_SetBooleanwf_C
#define He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_SetBooleanwf_C 1
#include \"FMI/fmi2Import.h\"
void He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiSetBoolean2wf(void*m, const int* refs, size_t nr, const int* vals, int* dummy) {
  size_t i;
  int j;
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"SetBoolean failed\");
    ...
    function fmiGetDirectionalDerivative
      ...
      external"C" He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_GetDirectionalDerivative2(
        fmi,
        z_refs,
        size(z_refs, 1),
        v_refs,
        ...
        dz)
      annotation (Include="
#ifndef He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_GetDirectionalDerivative2_C
#define He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_GetDirectionalDerivative2_C 1
#include \"FMI/fmi2Import.h\"
void He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_GetDirectionalDerivative2(void*m, const int* zref, size_t nzr, const int* vrefs, size_t nvr, const double *dv, double *dz) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetDirectionalDerivative failed\");
    ...
    function fmiSaveFMUState
      input fmiModel fmi;
      external"C" He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiSaveFMUState2(fmi)
        annotation (Include="
#ifndef He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiSaveFMUState_C
#define He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiSaveFMUState_C 1
#include \"FMI/fmi2Import.h\"
void He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiSaveFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiGetFMUstate failed\");
    ...
    function fmiRestoreFMUState
      input fmiModel fmi;
      external"C" He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiRestoreFMUState2(fmi)
        annotation (Include="
#ifndef He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiRestoreFMUState_C
#define He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiRestoreFMUState_C 1
#include \"FMI/fmi2Import.h\"
void He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiRestoreFMUState2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"fmiSetFMUstate failed\");
    ...
    function fmiSerializeFMUstate
      input fmiModel fmi;
      external"C" He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiSerializeFMUstate2(fmi)
        annotation (Include="
#ifndef He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiSerializeFMUstate_C
#define He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiSerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiSerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
    status = a->dyFmiGetFMUstate(a->m, &a->dyFMUstate);
    ...
    function fmiDeSerializeFMUstate
      input fmiModel fmi;
      external"C" He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiDeSerializeFMUstate2(fmi)
        annotation (Include="
#ifndef He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiDeSerializeFMUstate_C
#define He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiDeSerializeFMUstate_C 1
#include \"FMI/fmi2Import.h\"
void He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiDeSerializeFMUstate2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
    ...
    function fmiEnterSlaveInitializationMode
      ...
      input Real preAvailable;
      output Real postAvailable = preAvailable;
      external"C" He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiEnterSlaveInitializationMode2(fmi, setTolerance, relativeTolerance, tStart, forceShutDownAtTStop, tStop)
      annotation (Include="
#ifndef He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiEnterSlaveInitializationMode_C
#define He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiEnterSlaveInitializationMode_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiEnterSlaveInitializationMode2(void*m, int setTolerance, double relativeTolerance, double tStart, int forceShutDownAtTStop, double tStop) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
  ...
  if (status!=fmi2OK && status!=fmi2Warning) ModelicaError(\"InitializeSlave failed\");
    ...
    function fmiExitSlaveInitializationMode
      ...
      input Real preAvailable;
      output Real postAvailable = preAvailable;
      external"C" He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiExitSlaveInitializationMode2(fmi)
      annotation (Include="
#ifndef He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiExitSlaveInitializationMode_C
#define He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiExitSlaveInitializationMode_C 1
#include <stdlib.h>
#include \"FMI/fmi2Import.h\"
void He61c9e6d5af0d56a3b757d54a04e861698c3a4f49307524046467689313521_fmiExitSlaveInitializationMode2(void*m) {
  struct dy_fmi2Extended*a=m;
  fmi2Status status=fmi2Fatal;
  if (a) {
...
assert(fmi_CommunicationStepSize > 0.0,"The parameter fmi_CommunicationStepSize has an invalid value, please set a positive value larger than 0.0");
  ...
  internal.CPUtime :=fmi_Functions.fmiGetRealScalar(fmi, 67108869);
  internal.EventCounter :=fmi_Functions.fmiGetRealScalar(fmi, 67108870);
    end if;
  end when;
...
equation
  ...
  if initial() then
    CPUtime = fmi_Functions.GetRealVariable(fmi,myTimeStart, fill(0.0,0), fill(0.0,0), fill(0.0,0), fill(0.0,0), zeroOffset, fill(0.0,0), fill(false,0), fill(0,0), fill(0,0), fill(0,0), fill(0,0), fill(0,0), fill(0,0), fill(0,0), {67108869});
  else
    CPUtime = internal.CPUtime;
  end if;
  if initial() then
    EventCounter = fmi_Functions.GetRealVariable(fmi,myTimeStart, fill(0.0,0), fill(0.0,0), fill(0.0,0), fill(0.0,0), zeroOffset, fill(0.0,0), fill(false,0), fill(0,0), fill(0,0), fill(0,0), fill(0,0), fill(0,0), fill(0,0), fill(0,0), {67108870});
  else
    EventCounter = internal.EventCounter;
  end if;
  annotation (__Dymola_FMUImportVersion="Dymola 2025x Refresh 1", __Dymola_FMUImportPath="C:/Users/vanfr/Documents/Github/efmi-pss-use-case/Modelica/work/PSSspe/SiL-integration/FMU/He61c9e6d5af0d56a3b757d54a04e861698c3a4f4.fmu", __Dymola_FMUImportIncludeAllVariables="false", __Dymola_FMUImportIntegrate="false", __Dymola_FMUResourcePath="Resources/Library/FMU/He61c9e6d5af0d56a3b757d54a04e861698c3a4f4",__Dymola_FMUImportDateTime="Mon Dec 22 20:21:34 2025 GMT", experiment(StartTime=0.0, StopTime=1.0, Tolerance=0.0001),
    Icon(graphics={
...
<li>generationDateAndTime = 2025-12-22T20:21:24Z</li>
</ul>
