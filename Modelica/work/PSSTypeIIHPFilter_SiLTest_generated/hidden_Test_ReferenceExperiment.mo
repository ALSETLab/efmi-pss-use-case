...
model hidden_Test_ReferenceExperiment "Reference experiment with test scenarios for
  ...
  .OpenIPSL_CHIL.Components.Tests.PSS.HighPassFilterWOF.PSSTypeIIHPFilter_Clocked
    experiment
...
equation
  ...
  annotation (
    ...
    Documentation(info="
          ...
          <a href=\"modelica://OpenIPSL_CHIL.Components.Tests.PSS.HighPassFilterWOF.PSSTypeIIHPFilter_Clocked\">OpenIPSL_CHIL.Components.Tests.PSS.HighPassFilterWOF.PSSTypeIIHPFilter_Clocked</a>.
          </p>
          </html>"),
