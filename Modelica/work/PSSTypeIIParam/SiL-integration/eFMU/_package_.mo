package 'PSSTypeIIParam.eFMU_SiL_Support'
  "Package supporting software in the loop (SiL) simulation of the production
   ...
   Generated by Dymola on 2026-03-15T03:50:54Z."
  ...
  block BinaryStub
    ...
    */
    ...
    parameter .OpenIPSL.Types.Time Tw = 5.0
    ...
    when Clock() then
      ...
      */
      ...
      if not(__is_initialized) then
        ...
        __active_tuning.Tw := 5.0;
        __active_tuning.freqLow := 20.0;
