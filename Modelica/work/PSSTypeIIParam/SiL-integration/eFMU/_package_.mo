package 'PSSTypeIIParam.eFMU_SiL_Support'
  "Package supporting software in the loop (SiL) simulation of the production
   ...
   Generated by Dymola on 2026-03-11T20:25:22Z."
  ...
  block BinaryStub
    ...
    */
    ...
    // Tuneable parameters:
    parameter Real Kw = 10.8
      "Stabilizer gain [pu/pu]";
    parameter .OpenIPSL.Types.Time T1 = 0.278203917593164
      "First stabilizer time constant";
    parameter .OpenIPSL.Types.Time T2 = 0.0551479681529786
      "Second stabilizer time constant";
    parameter .OpenIPSL.Types.Time T3 = 0.278203917593164
      "Third stabilizer time constant";
    parameter .OpenIPSL.Types.Time T4 = 0.0551479681529786
    ...
    parameter .OpenIPSL.Types.PerUnit vsmax = 3.3
      "Max stabilizer output signal";
    parameter .OpenIPSL.Types.PerUnit vsmin = 0.0
    ...
    when Clock() then
      ...
      */
      ...
      if not(__is_initialized) then
        ...
        __active_tuning.Kw := 10.8;
        __active_tuning.T1 := 0.278203917593164;
        __active_tuning.T2 := 0.0551479681529786;
        __active_tuning.T3 := 0.278203917593164;
        __active_tuning.T4 := 0.0551479681529786;
        __active_tuning.Tw := 5.0;
        __active_tuning.vSI_start := 1.0;
        __active_tuning.vsmax := 3.3;
