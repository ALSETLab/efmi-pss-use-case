package 'PSSTypeIIParam.eFMU_SiL_Support'
  "Package supporting software in the loop (SiL) simulation of the production
   ...
   Generated by Dymola on 2026-03-26T03:04:24Z."
  ...
  block BinaryStub
    ...
    import __TuningConfiguration = 'PSSTypeIIParam.eFMU_SiL_Support'.TuningConfiguration;
    import __TuningBus = 'PSSTypeIIParam.eFMU_SiL_Support'.TuningBus;
    import __TuningBusSampler = 'PSSTypeIIParam.eFMU_SiL_Support'.TuningBusSampler;
    import __ProductionCodes = 'PSSTypeIIParam.eFMU_SiL_Support'.ProductionCodes;
    
    extends .DymolaEmbedded.BuildUtilities.BinaryCode.BinaryStub(
      final __sampling_period = 0.0002,
    ...
    */
    ...
    // Tuneable parameters:
    parameter Real Kw = 2.7
      "Stabilizer gain [pu/pu]";
    parameter .OpenIPSL.Types.Time T1 = 0.32417874258802
      "First stabilizer time constant";
    parameter .OpenIPSL.Types.Time T2 = 0.0556202789619914
      "Second stabilizer time constant";
    parameter .OpenIPSL.Types.Time T3 = 0.32417874258802
      "Third stabilizer time constant";
    parameter .OpenIPSL.Types.Time T4 = 0.0556202789619914
      "Fourth stabilizer time constant";
    parameter .OpenIPSL.Types.Time Tw = 0.25
    ...
    parameter Real kLPF = 1.00
      "Gain for noise supression (low-pass filter gain) – attenuates noise at frequencies above this value.";
    parameter Real vSI_start = 1.0
      "Default start value for vSI, the PSS input signal.";
    parameter .OpenIPSL.Types.PerUnit vsmax = 1.5
      "Max stabilizer output signal";
    parameter .OpenIPSL.Types.PerUnit vsmin = -1.5
      "Min stabilizer output signal";
    parameter Real wscale = 50.0
      "Speed input scaling";
  ...
  protected
    ...
    */
    ...
    function realEQ
      "Is x1 == x2? Comparing Real values for exact equality is a type error in
       equations, but not within functions."
      input Real x1, x2;
      output Boolean y;
    algorithm 
      y := x1 == x2;
    ...
    */
    ...
    class __BlockState_PCode_SPE_cb4a8a449b4ada864625ee5a4355578a3aaf08ed
      ...
      function constructor
        ...
        external "C" block_state = mei_Startup_H67479d7783111b50ee4f84437c325e160da02330_cb4a8a449b4ada864625ee5a4355578a3aaf08ed()
          annotation(
            LibraryDirectory = "modelica://'PSSTypeIIParam.eFMU_SiL_Support'/",
            Library = "H67479d7783111b50ee4f84437c325e160da02330_cb4a8a449b4ada864625ee5a4355578a3aaf08ed");
      end constructor;
  
      function destructor
        input __BlockState_PCode_SPE_cb4a8a449b4ada864625ee5a4355578a3aaf08ed block_state;
        external "C" mei_Terminate_H67479d7783111b50ee4f84437c325e160da02330_cb4a8a449b4ada864625ee5a4355578a3aaf08ed(block_state)
          annotation(
            LibraryDirectory = "modelica://'PSSTypeIIParam.eFMU_SiL_Support'/",
            Library = "H67479d7783111b50ee4f84437c325e160da02330_cb4a8a449b4ada864625ee5a4355578a3aaf08ed");
      end destructor;
    ...
    function __Recalibrate_PCode_SPE_cb4a8a449b4ada864625ee5a4355578a3aaf08ed
      ...
      input .OpenIPSL.Types.Time Tw
        "Wash-out time constant";
      input .Modelica.Units.SI.Frequency freqLow
        "Frequency in Hz for noise supression (low-pass filter cutoff frequency) – attenuates noise at frequencies above this value.";
      input Real kLPF
        "Gain for noise supression (low-pass filter gain) – attenuates noise at frequencies above this value.";
      ...
      external "C" error_signals =
        mei_Recalibrate_H67479d7783111b50ee4f84437c325e160da02330_cb4a8a449b4ada864625ee5a4355578a3aaf08ed(
          block_state,
          Kw,
          T1,
          T2,
    ...
    function __Reinitialize_PCode_SPE_cb4a8a449b4ada864625ee5a4355578a3aaf08ed
      ...
      output Real vs
        "PSS output signal";
      external "C" error_signals =
        mei_Reinitialize_H67479d7783111b50ee4f84437c325e160da02330_cb4a8a449b4ada864625ee5a4355578a3aaf08ed(
          block_state,
          vSI,
          vs);
        annotation(
    ...
    function __DoStep_PCode_SPE_cb4a8a449b4ada864625ee5a4355578a3aaf08ed
      ...
      output Real vs
        "PSS output signal";
      external "C" error_signals =
        mei_DoStep_H67479d7783111b50ee4f84437c325e160da02330_cb4a8a449b4ada864625ee5a4355578a3aaf08ed(
          block_state,
          vSI,
          vs);
        annotation(
    ...
    */
    ...
    class __BlockState_PCode_SPE_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c
      ...
      function constructor
        ...
        external "C" block_state = mei_Startup_H67479d7783111b50ee4f84437c325e160da02330_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c()
          annotation(
            LibraryDirectory = "modelica://'PSSTypeIIParam.eFMU_SiL_Support'/",
            Library = "H67479d7783111b50ee4f84437c325e160da02330_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c");
      end constructor;
  
      function destructor
        input __BlockState_PCode_SPE_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c block_state;
        external "C" mei_Terminate_H67479d7783111b50ee4f84437c325e160da02330_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c(block_state)
          annotation(
            LibraryDirectory = "modelica://'PSSTypeIIParam.eFMU_SiL_Support'/",
            Library = "H67479d7783111b50ee4f84437c325e160da02330_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c");
      end destructor;
    ...
    function __Recalibrate_PCode_SPE_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c
      ...
      output Integer error_signals;
      external "C" error_signals =
        mei_Recalibrate_H67479d7783111b50ee4f84437c325e160da02330_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c(
          block_state,
          Kw,
          T1,
          T2,
    ...
    function __Reinitialize_PCode_SPE_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c
      ...
      output Real vs
        "PSS output signal";
      external "C" error_signals =
        mei_Reinitialize_H67479d7783111b50ee4f84437c325e160da02330_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c(
          block_state,
          vSI,
          vs);
        annotation(
    ...
    function __DoStep_PCode_SPE_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c
      ...
      output Real vs
        "PSS output signal";
      external "C" error_signals =
        mei_DoStep_H67479d7783111b50ee4f84437c325e160da02330_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c(
          block_state,
          vSI,
          vs);
        annotation(
  ...
  equation
    ...
    */
    ...
    __sampled.__tuning.freqLow =
      (if __tuning_configuration.freqLow
       then __tuning_decoder.freqLow
       else freqLow);
    __sampled.__tuning.kLPF =
      (if __tuning_configuration.kLPF
       then __tuning_decoder.kLPF
       else kLPF);
    ...
    __sampled.__tuning.wscale =
      (if __tuning_configuration.wscale
       then __tuning_decoder.wscale
       else wscale);
    ...
    when Clock() then
      ...
      */
      ...
      if not(__is_initialized) then
        ...
        __active_tuning.Kw := 2.7;
        __active_tuning.T1 := 0.32417874258802;
        __active_tuning.T2 := 0.0556202789619914;
        __active_tuning.T3 := 0.32417874258802;
        __active_tuning.T4 := 0.0556202789619914;
        __active_tuning.Tw := 0.25;
        __active_tuning.freqLow := 5.0;
        __active_tuning.kLPF := 1.00;
        __active_tuning.vSI_start := 1.0;
        __active_tuning.vsmax := 1.5;
        __active_tuning.vsmin := -1.5;
        __active_tuning.wscale := 50.0;
      end if;
      ...
      __sampled.__recalibrate := false
        ...
        or max(abs(
            __sampled.__tuning.freqLow
          - __active_tuning.freqLow)) > 0.0
        or max(abs(
            __sampled.__tuning.kLPF
          - __active_tuning.kLPF)) > 0.0
        or max(abs(
            __sampled.__tuning.vSI_start
      ...
      */
      ...
      if __cosimulation_results[__ProductionCodes.PCode_SPE_cb4a8a449b4ada864625ee5a4355578a3aaf08ed].__is_active then
        ...
        if not(realEQ(__clock_tick_time, sample(time))) then
          (
  ...
  algorithm
    interface := {
      ...
      .DymolaEmbedded.BuildUtilities.BinaryCode.BinaryStubGeneration.InterfaceComponent(
        io_type = .DymolaEmbedded.BuildUtilities.BinaryCode.BinaryStubGeneration.InterfaceComponent.IOType.Parameter,
        primitive_type = .DymolaEmbedded.BuildUtilities.BinaryCode.BinaryStubGeneration.InterfaceComponent.PrimitiveType.Real,
        type_name = "Modelica.Units.SI.Frequency",
        is_enumeration = "",
        dimensionality = fill(0, 0),
        component_name = "freqLow",
        value = "5.0",
        description = "Frequency in Hz for noise supression (low-pass filter cutoff frequency) – attenuates noise at frequencies above this value.",
        placement = ""),
      .DymolaEmbedded.BuildUtilities.BinaryCode.BinaryStubGeneration.InterfaceComponent(
        io_type = .DymolaEmbedded.BuildUtilities.BinaryCode.BinaryStubGeneration.InterfaceComponent.IOType.Parameter,
        primitive_type = .DymolaEmbedded.BuildUtilities.BinaryCode.BinaryStubGeneration.InterfaceComponent.PrimitiveType.Real,
        ...
        component_name = "kLPF",
        value = "1.00",
        description = "Gain for noise supression (low-pass filter gain) – attenuates noise at frequencies above this value.",
        placement = ""),
      .DymolaEmbedded.BuildUtilities.BinaryCode.BinaryStubGeneration.InterfaceComponent(
        io_type = .DymolaEmbedded.BuildUtilities.BinaryCode.BinaryStubGeneration.InterfaceComponent.IOType.Parameter,
        primitive_type = .DymolaEmbedded.BuildUtilities.BinaryCode.BinaryStubGeneration.InterfaceComponent.PrimitiveType.Real,
      ...
      .DymolaEmbedded.BuildUtilities.BinaryCode.BinaryStubGeneration.InterfaceComponent(
        ...
        is_enumeration = "",
        dimensionality = fill(0, 0),
        component_name = "wscale",
        value = "50.0",
        description = "Speed input scaling",
        placement = "")};
...
protected
  ...
  record __Tuning
    ...
    .OpenIPSL.Types.Time Tw
      "Wash-out time constant";
    .Modelica.Units.SI.Frequency freqLow
      "Frequency in Hz for noise supression (low-pass filter cutoff frequency) – attenuates noise at frequencies above this value.";
    Real kLPF
      "Gain for noise supression (low-pass filter gain) – attenuates noise at frequencies above this value.";
    Real vSI_start
...
end 'PSSTypeIIParam.eFMU_SiL_Support';
