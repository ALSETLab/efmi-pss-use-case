encapsulated package 'OpenIPSL_CHIL.Components.PSS.PSSTypeIISimpleHPF: static initialization'
	...
	Real 'dLHPFreplacement.T';
	Real 'dLHPFreplacement.Tw';
	...
	algorithm
		...
		succeeded := succeeded
		 and .DymolaCommands.SimulatorAPI.simulateModel(
		  problem = "'OpenIPSL_CHIL.Components.PSS.PSSTypeIISimpleHPF: static initialization'.StartupModel",
		...
		if succeeded then
			trajectories_buffer[1:60] := .DymolaCommands.Trajectories.readTrajectory(
			 ...
			 signals = {
			  ...
			  "self.'dLHPFreplacement.Tw'",
			  "self.'derivative(dLHPFreplacement.x)'",
			  "self.'dLHPFreplacement.x'",
			  "self.'imLeadLag.K'",
			...
			self.'dLHPFreplacement.K' := trajectories_buffer[15, 1];
			self.'dLHPFreplacement.Kw' := trajectories_buffer[16, 1];
			self.'dLHPFreplacement.T' := trajectories_buffer[17, 1];
			self.'dLHPFreplacement.Tw' := trajectories_buffer[18, 1];
			self.'derivative(dLHPFreplacement.x)' := trajectories_buffer[19, 1];
			self.'dLHPFreplacement.x' := trajectories_buffer[20, 1];
			...
			self.'lpf.K' := trajectories_buffer[53, 1];
			self.'lpf.T' := trajectories_buffer[54, 1];
			self.'lpf.freqHz' := trajectories_buffer[55, 1];
			self.'derivative(lpf.x)' := trajectories_buffer[56, 1];
			self.'lpf.x' := trajectories_buffer[57, 1];
			self.'scale.k' := trajectories_buffer[58, 1];
		...
		assert(succeeded, "Simulation of 'OpenIPSL_CHIL.Components.PSS.PSSTypeIISimpleHPF: static initialization'.StartupModel failed.");
...
end 'OpenIPSL_CHIL.Components.PSS.PSSTypeIISimpleHPF: static initialization';
