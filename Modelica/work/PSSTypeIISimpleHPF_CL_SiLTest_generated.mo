...
package
  ...
  */
    ...
    */
    ...
    final
      ...
      'vSI|Scenario_1|query'(each final sample_source=clkSet1.clockType == "external",
        final source(final y=experiment.pss.vSI)) "Measured: PSS input signal "
    ...
    final
      ...
      'vs|Scenario_1|query'(each final sample_source=clkSet1.clockType == "external",
        final source(final y=experiment.pss.vs)) "Measured: PSS output signal"
  ...
  model hidden_Test_SiL_Scenario_1
    "Test scenario defined by component [pss]."
  ...
  model
    ...
    "SiL test Production Code container [PCode_SPE_cb4a8a449b4ada864625ee5a4355578a3aaf08ed] in the scenario defined by component [pss]."
  ...
  model
    ...
    "SiL test Production Code container [PCode_SPE_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c] in the scenario defined by component [pss]."
  ...
  annotation (
    ...
    Documentation(info="
        ...
        <p>
        Generated by Dymola on 2026-04-20T14:04:28Z.
        </p>
...
end PSSTypeIISimpleHPF_CL_SiLTest_generated;
