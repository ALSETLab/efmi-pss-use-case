within ;
package PSSTypeIISimpleHPF_SiLTest_generated
  "Test scenarios of original experiment
     [OpenIPSL_CHIL.Components.Tests.PSS.PSSTypeIISimpleHPF.PSSTypeIISimpleHPF_Clocked]
   for eBlock model
  ...
  */
  constant String bmodel_container_directory=
      "E:/modelica-libraries/efmi-pss-use-case/Modelica/work/PSSTypeIISimpleHPF/eFMU/BModel_Dymola_1d004974f9b717eea6bd89dae3a804d101968ef8"
  ...
  algorithm
    interface := 'PSSTypeIISimpleHPF.eFMU_SiL_Support'.resolve_interface();
  ...
  model hidden_Test_ReferenceExperiment "Reference experiment with test scenarios for
    ...
    */
    ...
    final
      ...
      'vSI|Scenario_1|query'(each final sample_source=clkSet1.clockType == "external",
        final source(final y=experiment.G1.pss.vSI))
    ...
    final
      .DymolaEmbedded.BuildUtilities.BehavioralModel.ExperimentSensors.RealSensor
      'vs|Scenario_1|query'(each final sample_source=clkSet1.clockType == "external",
        final source(final y=experiment.G1.pss.vs))
    ...
    */
    ...
    annotation (
      ...
      Documentation(info="
          ...
          <a href=\"modelica://OpenIPSL_CHIL.Components.Tests.PSS.PSSTypeIISimpleHPF.PSSTypeIISimpleHPF_Clocked\">OpenIPSL_CHIL.Components.Tests.PSS.PSSTypeIISimpleHPF.PSSTypeIISimpleHPF_Clocked</a>.
          </p>
          </html>"),
  ...
  model hidden_Test_SiL_Scenario_1
    "Test scenario defined by component [G1.pss]."
  ...
  protected
    final parameter
      ...
      code_configuration=
        'PSSTypeIISimpleHPF.eFMU_SiL_Support'.resolve_code_configuration(eBlock.
        __defining_code);
  ...
  public
    ...
    'PSSTypeIISimpleHPF.eFMU_SiL_Support'.BinaryStub eBlock(final
  ...
  model
    ...
    extends hidden_Test_SiL_Scenario_1(eBlock(
        final __defining_code='PSSTypeIISimpleHPF.eFMU_SiL_Support'.ProductionCodes.PCode_SPE_cb4a8a449b4ada864625ee5a4355578a3aaf08ed,
        final __active_codes={'PSSTypeIISimpleHPF.eFMU_SiL_Support'.ProductionCodes.PCode_SPE_cb4a8a449b4ada864625ee5a4355578a3aaf08ed},
  ...
  model
    ...
    extends hidden_Test_SiL_Scenario_1(eBlock(
        final __defining_code='PSSTypeIISimpleHPF.eFMU_SiL_Support'.ProductionCodes.PCode_SPE_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c,
        final __active_codes={'PSSTypeIISimpleHPF.eFMU_SiL_Support'.ProductionCodes.PCode_SPE_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c},
        final __enable_tuning=false,
        final __enable_reinitialization=false,
        final __tuning_configuration));
  ...
  annotation (
    ...
    Documentation(info="
        ...
        configuration
        <a href=\"modelica://OpenIPSL_CHIL.Components.PSS.eFMUs.PSSTypeIISimpleHPF\">OpenIPSL_CHIL.Components.PSS.eFMUs.PSSTypeIISimpleHPF</a>.
        </p>
        <p>
        ...
        <p>
        Generated by Dymola on 2026-04-09T09:22:35Z.
        </p>
...
end PSSTypeIISimpleHPF_SiLTest_generated;
