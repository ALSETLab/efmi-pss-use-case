...
rem *****************************************************************************************************************************
rem This batch script acts as a portable, automated launcher for the Dymola simulation environment. It begins by auto-detecting
rem the Dymola executable on the host machine, prioritizing predefined default installation paths. To maintain portability across
rem different workstations, it resolves all necessary paths w.r.t. the script's own location. Finally, it launches Dymola
rem with a generic startup script that seamlessly loads all required dependencies and generated models.
rem 
...
if not exist "!DYMOLA_EXECUTABLE!" (
	set "EMESSAGE=Could not find Dymola.exe under [!DYMOLA_EXECUTABLE!] and [C:\Program Files\Dymola *\bin64\]"
	call :ERROR
)
...
start "" /high "!DYMOLA_EXECUTABLE!" -nosplash "%SCRIP_DIR%\startup-generic.mos"
