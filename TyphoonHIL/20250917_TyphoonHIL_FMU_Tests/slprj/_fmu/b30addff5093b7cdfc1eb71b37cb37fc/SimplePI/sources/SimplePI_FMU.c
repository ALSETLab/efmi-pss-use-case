...
#define MODEL_IDENTIFIER SimplePI
#define MODEL_GUID "{4976243b-afc1-4e5f-b898-1ee0f43d8734}"
...
#define FMI2_FUNCTION_PREFIX SimplePI_
...
extern void SimplePI_setupDataStruc(DATA *data, threadData_t *threadData);
#define fmu2_model_interface_setupDataStruc SimplePI_setupDataStruc
