...
model DLandHPF
  ...
  HPFfromMSL.DerivativeLagHighPass HPvariant(
    order=order,
    Kw=Kw,
  ...
  Modelica.Blocks.Interfaces.RealOutput yHPF "HPF variant output"
...
equation
  ...
  annotation (Icon(graphics={
      ...
      Rectangle(lineColor={160,160,164},
        ...
        extent={{-80,-80},{22,8}}),
      Line(origin={3.333,-8.667},   points = {{-83.333,34.667},{24.667,34.667},{42.667,-71.333}}, color={0,0,0},     smooth = Smooth.Bezier,
          thickness=1),
