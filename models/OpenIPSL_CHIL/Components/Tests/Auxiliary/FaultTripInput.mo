within OpenIPSL_CHIL.Components.Tests.Auxiliary;
model FaultTripInput "Model fault model variant with trip signal as input"
  extends Modelica.Icons.Example;
  .OpenIPSL_CHIL.Components.Auxiliary.PwLine4eFMI pwLine4eFMI(
    R=1e-3,
    X=0.1,
  ...
  .OpenIPSL_CHIL.Components.Auxiliary.PwFault4eFMI pwFault4efmi(R=0.1, X=0.5)
