...
model GenAVRIOReDesignRef
  "Power system with synchronous machine (Order VI) and AVR (Type III), with input/output interfaces for lienar analysis and control design; (GenAVRIOReDesign) generator."
  ...
  OpenIPSL.Electrical.Buses.Bus B3 annotation(
    Placement(visible = true, transformation(origin = {60, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Generator.ReDesign.GenAVRIOReDesign G1(
    P_0=1997999999.9936,
    Q_0=967924969.90658,
...
equation
  ...
  connect(G1.w, w) annotation(
    Line(points={{-69,9},{-64,9},{-64,40},{94,40},{94,0},{110,0}},              color = {0, 0, 127}));
  annotation(
    experiment(StartTime = 0, StopTime = 10, Tolerance = 1e-6, Interval = 0.0001));
end GenAVRIOReDesignRef;
