...
equation
  ...
  connect(pss.vs, G4CHIL_IOplus.vf)
    annotation (Line(points={{-47,12},{-28,12}}, color={0,0,127}));
  connect(G4CHIL_IOplus.w, w) annotation (Line(points={{22,16},{60,16},{60,0},{
          110,0}}, color={0,0,127}));
  connect(pss.vSI, G4CHIL_IOplus.w) annotation (Line(points={{-70,12},{-80,12},
          {-80,40},{60,40},{60,16},{22,16}}, color={0,0,127}));
