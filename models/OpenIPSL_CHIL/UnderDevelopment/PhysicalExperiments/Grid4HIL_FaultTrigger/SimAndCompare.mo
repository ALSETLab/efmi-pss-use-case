within OpenIPSL_CHIL.UnderDevelopment.PhysicalExperiments.Grid4HIL_FaultTrigger;
...
.DymolaCommands.SimulatorAPI.simulateModel(
  problem="OpenIPSL_CHIL.PhysicalExperiments.Grid4HIL_FaultTrigger.Fault",
  stopTime=20,
  resultFile="Fault");
.DymolaCommands.SimulatorAPI.simulateModel(
  problem="OpenIPSL_CHIL.PhysicalExperiments.Grid4HIL_FaultTrigger.Fault_Clocked",
  stopTime=20,
  resultFile="Fault_Clocked");
.DymolaCommands.SimulatorAPI.simulateModel(
  problem="OpenIPSL_CHIL.PhysicalExperiments.Grid4HIL_FaultTrigger.Fault_eFMU",
  stopTime=20,
