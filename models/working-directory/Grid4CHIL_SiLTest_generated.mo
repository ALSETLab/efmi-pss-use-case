...
package
  ...
  "Test scenarios of original experiment
     [OpenIPSL_CHIL.RTS.Tests.CHIL.Grid4CHIL_Clocked]
   for eBlock model
     [OpenIPSL_CHIL.RTS.CHIL.Grid4CHIL]."

  extends .DymolaEmbedded.Icons.eFMI_ExperimentPackage;

  final package configuration = .OpenIPSL_CHIL.RTS.CHIL.eFMUs.Grid4CHIL;
  ...
  */
  ...
  algorithm
    interface := 'Grid4CHIL.eFMU_SiL_Support'.resolve_interface();
  ...
  model hidden_Test_ReferenceExperiment "Reference experiment with test scenarios for
    ...
    .OpenIPSL_CHIL.RTS.Tests.CHIL.Grid4CHIL_Clocked experiment
    ...
    */
    ...
    final
      ...
      'fault|Scenario_1|query'(each final sample_source=clkSet1.clockType == "external",
        final source(final y=experiment.G4CHIL.fault))
    ...
    final
      ...
      'vf|Scenario_1|query'(each final sample_source=clkSet1.clockType == "external",
        final source(final y=experiment.G4CHIL.vf)) "Measured: Field voltage"
    ...
    final
      ...
      'Pgen|Scenario_1|query'(each final sample_source=clkSet1.clockType == "external",
        final source(final y=experiment.G4CHIL.Pgen))
    ...
    final
      ...
      'Qgen|Scenario_1|query'(each final sample_source=clkSet1.clockType == "external",
        final source(final y=experiment.G4CHIL.Qgen))
    ...
    final
      ...
      'v|Scenario_1|query'(each final sample_source=clkSet1.clockType == "external",
        final source(final y=experiment.G4CHIL.v))
    ...
    final
      ...
      'vf0OUT|Scenario_1|query'(each final sample_source=clkSet1.clockType == "external",
        final source(final y=experiment.G4CHIL.vf0OUT))
    ...
    final
      ...
      'w|Scenario_1|query'(each final sample_source=clkSet1.clockType == "external",
        final source(final y=experiment.G4CHIL.w)) "Measured: Speed [pu]"
  ...
  model hidden_Test_SiL_Scenario_1
    "Test scenario defined by component [G4CHIL]."
  ...
  protected
    final parameter
      ...
      code_configuration=
        'Grid4CHIL.eFMU_SiL_Support'.resolve_code_configuration(eBlock.
        __defining_code);
  ...
  public
    ...
    'Grid4CHIL.eFMU_SiL_Support'.BinaryStub eBlock(final __embedd_clock=false)
  ...
  model
    ...
    extends hidden_Test_SiL_Scenario_1(eBlock(
        final __defining_code='Grid4CHIL.eFMU_SiL_Support'.ProductionCodes.PCode_SPE_cb4a8a449b4ada864625ee5a4355578a3aaf08ed,
        final __active_codes={'Grid4CHIL.eFMU_SiL_Support'.ProductionCodes.PCode_SPE_cb4a8a449b4ada864625ee5a4355578a3aaf08ed},
  ...
  model
    ...
    extends hidden_Test_SiL_Scenario_1(eBlock(
        final __defining_code='Grid4CHIL.eFMU_SiL_Support'.ProductionCodes.PCode_SPE_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c,
        final __active_codes={'Grid4CHIL.eFMU_SiL_Support'.ProductionCodes.PCode_SPE_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c},
        final __enable_tuning=false,
        final __enable_reinitialization=false,
        final __tuning_configuration));
  ...
  annotation (
    ...
    Documentation(info="
        ...
        <a href=\"modelica://OpenIPSL_CHIL.RTS.CHIL.Grid4CHIL\">OpenIPSL_CHIL.RTS.CHIL.Grid4CHIL</a>
        (eBlock) defining one test scenario according to eFMU generation
        configuration
        <a href=\"modelica://OpenIPSL_CHIL.RTS.CHIL.eFMUs.Grid4CHIL\">OpenIPSL_CHIL.RTS.CHIL.eFMUs.Grid4CHIL</a>.
        </p>
        <p>
        ...
        <p>
        Generated by Dymola on 2026-04-20T12:01:02Z.
        </p>
...
end Grid4CHIL_SiLTest_generated;
