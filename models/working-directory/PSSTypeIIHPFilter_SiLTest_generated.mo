within ;
package
  PSSTypeIIHPFilter_SiLTest_generated
  "Test scenarios of original experiment
     [OpenIPSL_CHIL.Components.Tests.PSS.PSSTypeIIHPFilter.PSSTypeIIHPFilter_Clocked]
   for eBlock model
  ...
  */
  ...
  algorithm
    interface := 'PSSTypeIIHPFilter.eFMU_SiL_Support'.resolve_interface();
    ...
    */
    ...
    annotation (
      ...
      Documentation(info="
          ...
          <a href=\"modelica://OpenIPSL_CHIL.Components.Tests.PSS.PSSTypeIIHPFilter.PSSTypeIIHPFilter_Clocked\">OpenIPSL_CHIL.Components.Tests.PSS.PSSTypeIIHPFilter.PSSTypeIIHPFilter_Clocked</a>.
          </p>
          </html>"),
  ...
  protected
    final parameter
      ...
      code_configuration=
        'PSSTypeIIHPFilter.eFMU_SiL_Support'.resolve_code_configuration(eBlock.
        __defining_code);
  ...
  public
    ...
    'PSSTypeIIHPFilter.eFMU_SiL_Support'.BinaryStub eBlock(final __embedd_clock
        =false)
  ...
  model
    ...
    extends hidden_Test_SiL_Scenario_1(eBlock(
        final __defining_code='PSSTypeIIHPFilter.eFMU_SiL_Support'.ProductionCodes.PCode_SPE_cb4a8a449b4ada864625ee5a4355578a3aaf08ed,
        final __active_codes={'PSSTypeIIHPFilter.eFMU_SiL_Support'.ProductionCodes.PCode_SPE_cb4a8a449b4ada864625ee5a4355578a3aaf08ed},
  ...
  model
    ...
    extends hidden_Test_SiL_Scenario_1(eBlock(
        final __defining_code='PSSTypeIIHPFilter.eFMU_SiL_Support'.ProductionCodes.PCode_SPE_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c,
        final __active_codes={'PSSTypeIIHPFilter.eFMU_SiL_Support'.ProductionCodes.PCode_SPE_fba3e0dfa6c8985b41bcbe3594ee941ce98b740c},
        final __enable_tuning=false,
        final __enable_reinitialization=false,
        final __tuning_configuration));
  ...
  annotation (
    ...
    Documentation(info="
        ...
        <a href=\"modelica://OpenIPSL_CHIL.Components.PSS.PSSTypeIIHPFilter\">OpenIPSL_CHIL.Components.PSS.PSSTypeIIHPFilter</a>
        (eBlock) defining one test scenario according to eFMU generation
        configuration
        <a href=\"modelica://OpenIPSL_CHIL.Components.PSS.eFMUs.PSSTypeIIHPFilter\">OpenIPSL_CHIL.Components.PSS.eFMUs.PSSTypeIIHPFilter</a>.
        </p>
        <p>
        ...
        <p>
        Generated by Dymola on 2026-04-20T11:45:03Z.
        </p>
...
end PSSTypeIIHPFilter_SiLTest_generated;
